      ...
      foreach( arch ${GEN_TEST_ARCH})
        ...
        if( arch STREQUAL simd)
          foreach(type ${GEN_TEST_TYPES})
            ...
            ## Native only tests
            set(file_to_compile "${_TestSrcDir}/${GEN_TEST_ROOT}.${base_file}.native.${type}.cpp")
            configure_file( "${_TestCurrentDir}/native.cpp.in" "${file_to_compile}" )
            generate_test ( "" "${_TestSrcDir}/" "${GEN_TEST_ROOT}.native.unit"
                            "${GEN_TEST_ROOT}.${base_file}.native.${type}.cpp"
                          )
          endforeach()
        endif()
      endforeach()
