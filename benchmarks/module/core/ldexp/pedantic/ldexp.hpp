...
int main()
{
  ...
  run<eve::bench::types<EVE_VALUE, I_VALUE>>(EVE_NAME(eve::ldexp[eve::pedantic]) , xp, eve::ldexp[eve::pedantic], arg0, arg1);
  run<eve::bench::types<EVE_TYPE,  I_VALUE>> (EVE_NAME(eve::ldexp[eve::pedantic]) , xp, eve::ldexp[eve::pedantic], arg0, arg1);
  run<eve::bench::types<EVE_TYPE,  I_TYPE>> (EVE_NAME(eve::ldexp[eve::pedantic]) , xp, eve::ldexp[eve::pedantic], arg0, arg1);
