...
int main()
{
  ...
  run<EVE_VALUE> (EVE_NAME(eve::oneminus[eve::saturated]) , xp, eve::oneminus[eve::saturated], arg0);
  run<EVE_TYPE>  (EVE_NAME(eve::oneminus[eve::saturated]) , xp, eve::oneminus[eve::saturated], arg0);
}
