...
TTS_CASE("Check eve::logical_xor behavior on scalars")
{
  ...
  if constexpr(std::is_floating_point_v<EVE_VALUE>)
  {
    ...
    TTS_EQUAL(eve::logical_xor((i_t(0)), (EVE_TYPE(0))), eve::False<i_t>());
    TTS_EQUAL(eve::logical_xor((i_t(0)), (EVE_TYPE(1))), eve::True<i_t>());
    TTS_EQUAL(eve::logical_xor((i_t(2)), (EVE_TYPE(1))), eve::False<i_t>() );
    TTS_EQUAL(eve::logical_xor((i_t(1)), (EVE_TYPE(0))), eve::True<i_t>());
    
    TTS_EQUAL(eve::logical_xor((EVE_TYPE(0)), i_t(0)), eve::False<EVE_TYPE>());
    TTS_EQUAL(eve::logical_xor((EVE_TYPE(0)), i_t(1)), eve::True<EVE_TYPE>());
    TTS_EQUAL(eve::logical_xor((EVE_TYPE(2)), i_t(1)), eve::False<EVE_TYPE>() );
    TTS_EQUAL(eve::logical_xor((EVE_TYPE(1)), i_t(0)), eve::True<EVE_TYPE>());
  }
}
