...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(fnma[eve::pedantic]) , xp, eve::fnma[eve::pedantic], arg0, arg1, arg2);
  run<EVE_TYPE> (EVE_NAME(fnma[eve::pedantic]) , xp, eve::fnma[eve::pedantic], arg0, arg1, arg2);
}
