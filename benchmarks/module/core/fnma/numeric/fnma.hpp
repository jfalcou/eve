...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(eve::numeric_(eve::fnma)) , xp, eve::numeric_(eve::fnma), arg0, arg1, arg2);
  run<EVE_TYPE> (EVE_NAME(eve::numeric_(eve::fnma)) , xp, eve::numeric_(eve::fnma), arg0, arg1, arg2);
}
