...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(eve::numeric_(eve::fma)) , xp, eve::numeric_(eve::fma), arg0, arg1, arg2);
  run<EVE_TYPE> (EVE_NAME(eve::numeric_(eve::fma)) , xp, eve::numeric_(eve::fma), arg0, arg1, arg2);
}
