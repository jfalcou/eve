...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(eve::numeric_(eve::fms)) , xp, eve::numeric_(eve::fms), arg0, arg1, arg2);
  run<EVE_TYPE> (EVE_NAME(eve::numeric_(eve::fms)) , xp, eve::numeric_(eve::fms), arg0, arg1, arg2);
}
