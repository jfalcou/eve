...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(fms[eve::pedantic]) , xp, eve::fms[eve::pedantic], arg0, arg1, arg2);
  run<EVE_TYPE> (EVE_NAME(fms[eve::pedantic]) , xp, eve::fms[eve::pedantic], arg0, arg1, arg2);
}
