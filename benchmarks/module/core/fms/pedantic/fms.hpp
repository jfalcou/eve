...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(eve::pedantic_(eve::fms)) , xp, eve::pedantic_(eve::fms), arg0, arg1, arg2);
  run<EVE_TYPE> (EVE_NAME(eve::pedantic_(eve::fms)) , xp, eve::pedantic_(eve::fms), arg0, arg1, arg2);
}
