...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(eve::numeric_(eve::fnms)) , xp, eve::numeric_(eve::fnms), arg0, arg1, arg2);
  run<EVE_TYPE> (EVE_NAME(eve::numeric_(eve::fnms)) , xp, eve::numeric_(eve::fnms), arg0, arg1, arg2);
}
