...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(pedantic_(eve::fnms)) , xp, eve::pedantic_(eve::fnms), arg0, arg1, arg2);
  run<EVE_TYPE> (EVE_NAME(pedantic_(eve::fnms)) , xp, eve::pedantic_(eve::fnms), arg0, arg1, arg2);
}
