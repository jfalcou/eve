...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(fnms[eve::pedantic]) , xp, eve::fnms[eve::pedantic], arg0, arg1, arg2);
  run<EVE_TYPE> (EVE_NAME(fnms[eve::pedantic]) , xp, eve::fnms[eve::pedantic], arg0, arg1, arg2);
}
