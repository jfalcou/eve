...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(atan2[eve::pedantic]) , xp, eve::atan2[eve::pedantic] , arg0, arg1);
  run<EVE_TYPE> (EVE_NAME(atan2[eve::pedantic]) , xp, eve::atan2[eve::pedantic] , arg0, arg1);
