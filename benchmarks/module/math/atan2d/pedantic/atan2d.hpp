...
int main()
{
  ...
  run<EVE_VALUE>(EVE_NAME(atan2d[eve::pedantic2]) , xp, eve::atan2d[eve::pedantic2] , arg0, arg1);
  run<EVE_TYPE> (EVE_NAME(atan2d[eve::pedantic2]) , xp, eve::atan2d[eve::pedantic2] , arg0, arg1);
