...
.. code-block:: c++
   ...
   namespace eve
   {
      constexpr /* implementation defined */ is_not_greater_equal = {};
   }

Function object performing 'is not greater equal' comparison between two :ref:`Values <concept-value>`.
...
* [1] Performs element-wise 'is not greater equal' comparison between both :ref:`wides <type-wide>`.
* [2,3] Performs 'is not greater equal' comparison between the scalar and each element of the :ref:`type-wide` instance.
* [4] Performs 'is not greater equal' comparison between both scalars.
...
.. include:: ../../../../test/doc/core/is_not_greater_equal.cpp
  :literal:

Possible output:

.. include:: ../../../../test/doc/core/is_not_greater_equal.txt
  :literal:
