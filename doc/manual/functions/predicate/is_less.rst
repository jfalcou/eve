...
.. code-block:: c++
   ...
   namespace eve
   {
      constexpr /* implementation defined */ is_less = {};
   }

Function object performing 'is less' comparison between two :ref:`Values <concept-value>`.
...
* [1] Performs element-wise 'is less' comparison between both :ref:`wides <type-wide>`.
* [2,3] Performs 'is less' comparison between the scalar and each element of the :ref:`type-wide` instance.
* [4] Performs 'is less' comparison between both scalars.
...
.. include:: ../../../../test/doc/core/is_less.cpp
  :literal:

Possible output:

.. include:: ../../../../test/doc/core/is_less.txt
  :literal:
