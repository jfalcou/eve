...
.. code-block:: c++
   ...
   namespace eve
   {
      constexpr /* implementation defined */ bitwise_notand = {};
   }

Function object performing a bitwise AND between the COMPLEMENT of a :ref:`Value <concept-value>` and
...
* [1] Performs a bitwise AND between the COMPLEMENT of **v** and **w**.
* [2] Performs a bitwise AND between each elements of the COMPLEMENT of **v** and **s**.
* [3] Performs a bitwise AND between the COMPLEMENT of **s** and **t**.
...
* There is no cardinal restriction on the :ref:`concept-vectorized` operands of :ref:`function-bitwise_notand`
  as long as the number of bits between them are equals.  This implies that calls to :ref:`function-bitwise_notand`
...
.. include:: ../../../../test/doc/core/bitwise_notand.cpp
  :literal:

Possible output:

.. include:: ../../../../test/doc/core/bitwise_notand.txt
  :literal:
