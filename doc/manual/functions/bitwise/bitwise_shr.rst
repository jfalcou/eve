...
Function object performing a bitwise shift of an :ref:`IntegralValue <concept-integralvalue>`  by 
...
.. include:: ../../../../test/doc/bitwise_shr.cpp
  :literal:

Possible output:

.. include:: ../../../../test/doc/bitwise_shr.txt
  :literal:
