...
* [1] Selects bits between **w** and **x** based on the value of **v**. This computation is equivalent to ``bitwise_or(bitwise_and(w, v), eve::bitwise_andnot(x, v))``.
* [2] Selects bits between **s** and **t** based on the value of **v**. This computation is equivalent to ``bitwise_select(v, wide<T,N>(s), wide<T,N>(t))``.
* [3] Selects bits between **s** and **t** based on the value of **r**. This computation is equivalent to ``bitwise_or(bitwise_and(s, r), eve::bitwise_andnot(t, r))``.
