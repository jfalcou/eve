...
.. code-block:: c++
  :linenos:
   ...
   template<typename T> constexp2r    T         operator()( T s ) noexcept;

* [1] Computes the element-wise   base 2 exponential of the :ref:`wide <type-wide>`.
* [2] Computes the base 2  exponential of the scalar.
