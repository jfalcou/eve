...
* [1] Performs a bit OR between **v** and the COMPLEMENT of **w**.
* [2] Performs a bit OR between each elements of **v** and the COMPLEMENT of **s**.
* [3] Performs a bit OR between **s** and the COMPLEMENT of **t**.
...
* There is no type restriction between operands of :ref:`function-bit_ornot` as long as the number
  of bits between them are equals. This implies that calls to :ref:`function-bit_ornot` on
...
* There is no cardinal restriction on the :ref:`concept-vectorized` operands of :ref:`function-bit_ornot`
  as long as the number of bits between them are equals.  This implies that calls to :ref:`function-bit_ornot`
