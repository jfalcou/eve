...
* [1] Performs a bit AND between the COMPLEMENT of **v** and **w**.
* [2] Performs a bit AND between each elements of the COMPLEMENT of **v** and **s**.
* [3] Performs a bit AND between the COMPLEMENT of **s** and **t**.
