...
Function object performing a bit shift  to the left of an :ref:`IntegralValue <concept-integralvalue>`  by
...
* ``bit_shl`` is an alias of ``shl``: to the left logical and aritmetic shifts are the same.
...
.. seealso::  :ref:`bit_shl <function-bit_shl>`

*******
Example
*******

.. include:: ../../../../test/doc/core/bit_shl.cpp
  :literal:
