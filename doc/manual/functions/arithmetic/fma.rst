...
*****
    ...
    pedantic_ option ensures the fma properties and allows SIMD acceleration if available.

*******
Options
*******

    - pedantic_: ``fma[pedantic_](x,y,z)`` ensures the fma conformant properties and allows SIMD acceleration if available.
