...
* [1] Computes the element-wise the greatest integral values less or equal to the value of the :ref:`wide <type-wide>`.
...
******
  ...
  - the ``floor(a)`` is equivalent to the call ``round[down_](a)``
