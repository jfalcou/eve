...
* [1] Performs a bitwise right or left shift of each element of **v** by each element of **w**.
* [2] Performs a bitwise right or left shift of each element of **v** by **s**.
* [3] Performs a bitwise right or left shift of **s** by each element of **w**.
* [4] Performs a bitwise right or left shift of **s** by **t**.
...
.. include:: ../../../../test/doc/rshr.cpp
  :literal:

Possible output:

.. include:: ../../../../test/doc/rshr.txt
  :literal:
