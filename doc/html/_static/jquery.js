...
!function(a, b) {
  ...
  r.fn = r.prototype = {
    ...
    get : function(
        a) { return null == a ? f.call(this) : a < 0 ? this[ a + this.length ] : this[ a ] },
    ...
    map : function(
        a) { return this.pushStack(r.map(this, function(b, c) { return a.call(b, c, b) })) },
  ...
  r.extend({
    ...
    type : function(a) {
      return null == a ? a + ""
                       : "object" == typeof a || "function" == typeof a ? j[ k.call(a) ] || "object"
                                                                        : typeof a
    },
  ...
  var x = function(a) {
    var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t,
        u = "sizzle" + 1 * new Date, v = a.document, w = 0, x = 0, y = ha(), z = ha(), A = ha(),
        B = function(a, b) { return a === b && (l = !0), 0 }, C = {}.hasOwnProperty, D = [],
        E = D.pop, F = D.push, G = D.push, H = D.slice,
        I =
            function(a, b) {
    ...
    function oa(a)
    {
      return function(b) {
        return "form" in b ? b.parentNode && b.disabled === !1
                                 ? "label" in b
                                       ? "label" in b.parentNode ? b.parentNode.disabled === a
                                                                 : b.disabled === a
    ...
    d = ga.selectors = {
                ...
                while(m = ++n && m && m[ p ] || (t = n = 0) || o.pop())
                  if(1 === m.nodeType && ++t && m === b)
                  {
                    ...
                    break
                      ...
                      t === !1)
                while(m = ++n && m && m[ p ] || (t = n = 0) || o.pop())
                  if((h ? m.nodeName.toLowerCase() === r : 1 === m.nodeType) && ++t &&
                     (s && (l      = m[ u ] || (m[ u ] = {}),
                            k      = l[ m.uniqueID ] || (l[ m.uniqueID ] = {}),
                            k[ a ] = [ w, t ]),
                      m === b))
      ...
      pseudos : {
        ...
        selected : function(
            a) { return a.parentNode && a.parentNode.selectedIndex, a.selected === !0 },
        empty : function(a) {
    ...
    return h = ga.compile =
      ...
      return f
           ...
           i = ga.select =
             ...
             if(c = c || [], 1 === n.length)
             {
               if(i = n[ 0 ] = n[ 0 ].slice(0),
                  i.length > 2 && "ID" === (j = i[ 0 ]).type && 9 === b.nodeType && p &&
                      d.relative[ i[ 1 ].type ])
               {
           ...
           c.sortStable = u.split("").sort(B).join("") === u, c.detectDuplicates = !!l, m(),
           c.sortDetached = ja(function(
               a) { return 1 & a.compareDocumentPosition(n.createElement("fieldset")) }),
           ja(function(a) {
  ...
  r.filter = function(a, b, c) {
    ...
    is : function(
        a) { return !!E(this, "string" == typeof a && A.test(a) ? r(a) : a || [], !1).length }
  });
  var F, G = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, H = r.fn.init = function(a, b, c) {
    ...
    {
      if(e = "<" === a[ 0 ] && ">" === a[ a.length - 1 ] && a.length >= 3 ? [ null, a, null ]
                                                                          : G.exec(a),
         !e || !e[ 1 ] && b)
  ...
  r.fn.extend({
    ...
    addBack : function(
        a) { return this.add(null == a ? this.prevObject : this.prevObject.filter(a)) }
  });
  function K(a, b)
  {
  ...
  var R      = r.Deferred();
  r.fn.ready = function(
      a) { return R.then(a)[ "catch" ](function(a) { r.readyException(a) }), this },
  r.extend({
    isReady : !1,
    readyWait : 1,
    ready : function(a) {
    ...
    if("object" === r.type(c))
    {
      ...
      for(h in c) T(a, b, h, c[ h ], !0, f, g)
                             ...
                             j && (g ? (b.call(a, d), b = null)
                                     : (j = b, b = function(a, b, c) { return j.call(r(a), c) })),
                             b))
  ...
  V.uid = 1, V.prototype = {
    ...
    remove : function(a, b) {
      ...
      if(void 0 !== d)
      {
        if(void 0 !== b)
        {
          Array.isArray(b) ? b = b.map(r.camelCase)
  ...
  {
    var e, f = 1, g = 20,
           h = d ? function() { return d.cur() } : function() { return r.css(a, b, "") }, i = h(),
  ...
  function ia(a, b)
  {
    for(var c, d, e = [], f = 0, g = a.length; f < g; f++)
      d = a[ f ], d.style && (c = d.style.display,
  ...
  {
    for(var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, o = a.length; n < o;
        n++)
      if(f = a[ n ], f || 0 === f)
        if("object" === r.type(f))
        ...
        else if(pa.test(f))
        {
          ...
          h = (ka.exec(f) || [ "", "" ])[ 1 ].toLowerCase(), i = ma[ h ] || ma._default,
  ...
  r.event = {
    ...
    add : function(a, b, c, d, e) {
      ...
      if(q)
      {
        ...
        while(j--)
          h = ua.exec(b[ j ]) || [], n = p = h[ 1 ], o = (h[ 2 ] || "").split(".").sort(),
      ...
      if(q && (i = q.events))
      {
        ...
        while(j--)
          if(h = ua.exec(b[ j ]) || [], n = p = h[ 1 ], o = (h[ 2 ] || "").split(".").sort(), n)
          {
            ...
            g = f = m.length;
            while(f--)
              k = m[ f ], !e && p !== k.origType || c && c.guid !== k.guid ||
  ...
  r.Event.prototype = {
    ...
    stopImmediatePropagation : function() {
      ...
      a && !this.isSimulated && a.stopImmediatePropagation(), this.stopPropagation()
    }
  },
  r.each({
    altKey : !0,
  ...
  function Ja(a, b, c, d)
  {
             ...
             f || d))
    {
      for(h = r.map(na(e, "script"), Fa), i = h.length; l < m; l++)
        j = e, l !== n && (j = r.clone(j, !0, !0), i && r.merge(h, na(j, "script"))),
        c.call(a[ l ], j, l);
      if(i)
  ...
  !function() {
    function b()
    {
      if(i)
      {
        ...
        i.style.marginRight = "50%", f = "4px" === b.marginRight, ra.removeChild(h), i = null
      }
    }
  ...
  r.extend({
    ...
    css : function(a, b, c, d) {
      ...
      return i || (b = Xa(h)),
             g = r.cssHooks[ b ] || r.cssHooks[ h ], g && "get" in g && (e = g.get(a, !0, c)),
             void 0 === e && (e = Oa(a, b, d)), "normal" === e && b in Ta && (e = Ta[ b ]),
  ...
  function eb()
  {
    bb && (d.hidden === !1 && a.requestAnimationFrame ? a.requestAnimationFrame(eb)
  ...
  function hb(a, b, c)
  {
    for(var d, e = (kb.tweeners[ b ] || []).concat(kb.tweeners[ "*" ]), f = 0, g = e.length; f < g;
        f++)
  ...
  function ib(a, b, c)
  {
    ...
    c.queue ||
        (g = r._queueHooks(a, "fx"),
         null == g.unqueued &&
             (g.unqueued = 0, h = g.empty.fire, g.empty.fire = function() { g.unqueued || h() }),
         g.unqueued++,
         m.always(function() {
    ...
    if(i = !r.isEmptyObject(b), i || !r.isEmptyObject(n))
    {
      l && 1 === a.nodeType &&
          ...
          i = !1;
      for(d in n)
        i || (q ? "hidden" in q && (p = q.hidden) : q = W.access(a, "fxshow", {display : j}),
              f && (q.hidden = !p),
              p && ia([ a ], !0),
              m.done(function() {
  ...
  {
    var d, e,
        f = 0, g = kb.prefilters.length, h = r.Deferred().always(function() { delete i.elem }),
        i =
            function() {
          if(e) return !1;
          for(var b = ab || fb(),
    ...
    for(jb(k, j.opts.specialEasing); f < g; f++)
      if(d = kb.prefilters[ f ].call(j, a, k, j.opts))
        return r.isFunction(d.stop) &&
               ...
               d;
    return r.map(k, hb, j), r.isFunction(j.opts.start) && j.opts.start.call(a, j),
  ...
  r.fx.timer = function(a) { r.timers.push(a), r.fx.start() }, r.fx.interval = 13,
  r.fx.start = function() { bb || (bb = !0, eb()) }, r.fx.stop = function() { bb = null },
  r.fx.speeds = {slow : 600, fast : 200, _default : 400}, r.fn.delay = function(b, c) {
    ...
    a = d.createElement("input"), a.value = "t", a.type = "radio", o.radioValue = "t" === a.value
  }();
  ...
  r.fn.extend({
    ...
    removeAttr : function(a) { return this.each(function() { r.removeAttr(this, a) }) }
      ...
      lb = {
        set : function(a, b, c) { return b === !1 ? r.removeAttr(a, c) : a.setAttribute(c, c), c }
      },
  ...
  r.fn.extend({
    ...
    toggleClass : function(a, b) {
      ...
      return "boolean" == typeof b && "string" === c
                 ...
                 : r.isFunction(a)
                       ? this.each(function(
                             c) { r(this).toggleClass(a.call(this, c, qb(this), b), b) })
                       : this.each(function() {
                           var b, d, e, f;
                           if("string" === c)
                           {
        ...
        r.valHooks[ this ] = {
          set : function(a, b) {
            if(Array.isArray(b)) return a.checked = r.inArray(r(a).val(), b) > -1
                         ...
                         o.checkOn ||
                             (r.valHooks[ this ].get = function(
                                  a) { return null === a.getAttribute("value") ? "on" : a.value })
      });
  ...
  r.extend(r.event, {
    trigger : function(b, c, e, f) {
      ...
      if(h = i = e = e || d,
         3 !== e.nodeType && 8 !== e.nodeType && !sb.test(p + r.event.triggered) &&
             (p.indexOf(".") > -1 && (q = p.split("."), p = q.shift(), q.sort()),
              ...
              b.namespace = q.join("."),
              b.rnamespace =
                  b.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null,
              b.result = void 0,
              b.target || (b.target = e),
              ...
              f || !n.trigger || n.trigger.apply(e, c) !== !1))
      {
        ...
        return b.type = p,
               f || b.isDefaultPrevented() || n._default && n._default.apply(o.pop(), c) !== !1 ||
                   !U(e) ||
    ...
    simulate : function(a, b, c) {
      ...
      r.each(
          ...
          function(a, b) {
            r.fn[ b ] = function(
                a, c) { return arguments.length > 0 ? this.on(b, null, a, c) : this.trigger(b) }
          }),
  ...
  r.param = function(a, b) {
    ...
    serializeArray : function() {
      return this
          ...
          .filter(function() {
            var a = this.type;
            return this.name && !r(this).is(":disabled") && zb.test(this.nodeName) && !yb.test(a) &&
  ...
  r.extend({
    ...
    ajax : function(b, c) {
      ...
      o.hasContent ? o.data && o.processData &&
    ...
    getScript : function(a, b) { return r.get(a, void 0, b, "script") }
             ...
             function(a, b) {
               r[ b ] = function(a, c, d, e) {
                 return r.isFunction(c) && (e = e || d, d = c, c = void 0),
                        r.ajax(r.extend({url : a, type : b, dataType : e, data : c, success : d},
                                        r.isPlainObject(a) && a))
               }
             }),
      r._evalUrl =
      ...
      r.fn.extend({
        ...
        wrapInner : function(a) {
          return r.isFunction(a) ? this.each(function(b) { r(this).wrapInner(a.call(this, b)) })
                                 : this.each(function() {
      ...
      r.expr.pseudos.visible = function(
          a) { return !!(a.offsetWidth || a.offsetHeight || a.getClientRects().length) },
          ...
          c =
            ...
            return function() {
              c && (c = d = h.onload = h.onerror = h.onabort = h.onreadystatechange = null,
                    "abort" === a
                        ? h.abort()
                        : "error" === a ? "number" != typeof h.status ? f(0, "error")
  ...
  r.ajaxPrefilter(
      "script",
      function(a) { void 0 === a.cache && (a.cache = !1), a.crossDomain && (a.type = "GET") }),
  ...
  r.ajaxSetup({
    ...
    jsonpCallback : function() {
            ...
            if(h || "jsonp" === b.dataTypes[ 0 ])
              return e = b.jsonpCallback =
                     ...
                     b.converters[ "script json" ] =
                         function() { return g || r.error(e + " was not called"), g[ 0 ] },
      ...
      r.expr.pseudos.animated = function(
          a) { return r.grep(r.timers, function(b) { return a === b.elem }).length },
      r.offset = {
               ...
               r.each({padding : "inner" + a, content : b, "" : "outer" + a}, function(c, d) {
                 r.fn[ d ] = function(e, f) {
                   ...
                   return T(this, function(b, c, e) {
                     var f;
                     return r.isWindow(b) ? 0 === d.indexOf("outer")
                                                ? b[ "inner" + a ]
                                                : b.document.documentElement[ "client" + a ]
                                          : 9 === b.nodeType ? (f = b.documentElement,
