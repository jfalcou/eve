...
.. code-block:: c++
   ...
   namespace eve
   {
      constexpr /* implementation defined */ is_greater = {};
   }

Function object performing 'is greater' comparison between two :ref:`Values <concept-value>`.
...
* [1] Performs element-wise 'is greater' comparison between both :ref:`wides <type-wide>`.
* [2,3] Performs 'is greater' comparison between the scalar and each element of the :ref:`type-wide` instance.
* [4] Performs 'is greater' comparison between both scalars.
