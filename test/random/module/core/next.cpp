...
TTS_CASE_TPL("Random check for eve::next", eve::test::simd::all_types)
<typename T>(tts::type<T>)
{
  ...
  EVE_ULP_RANGE_CHECK( T, eve::uniform_prng<e_t>(vmin, vmax),  std_pedantic_next, eve::next[eve::pedantic] );
