...
TTS_CASE_TPL("Random check for eve::inc", eve::test::simd::all_types)
<typename T>(tts::type<T>)
{
  ...
  EVE_ULP_RANGE_CHECK( T, eve::uniform_prng<e_t>(vmin, vmax),  std_saturated_inc, eve::inc[eve::saturated] );
};
