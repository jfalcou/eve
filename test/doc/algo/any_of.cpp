...
int main()
{
  ...
  std::cout << " -> eve::algo::any_of(r1, eve::is_gez)  = "<< std::boolalpha << eve::algo::any_of(r1, eve::is_ltz)<< '\n';
  std::cout << " -> eve::algo::any_of(vr1, eve::is_gez) = "<< std::boolalpha << eve::algo::any_of(vr1, eve::is_ltz)<< '\n';
  std::cout << " -> eve::algo::any_of(r2, eve::is_ltz)  = "<< std::boolalpha << eve::algo::any_of(r2, eve::is_ltz)<< '\n';
  std::cout << " -> eve::algo::any_of(vr2, eve::is_ltz) = "<< std::boolalpha << eve::algo::any_of(vr2, eve::is_ltz)<< '\n';
