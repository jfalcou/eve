...
int main() {
  ...
  }
  {
    ...
    eve::alignas<eve::wid<float>> std::array<float, N> data1{5.0f, 10.0f, 15.0f, 20.0f, 25.0f, 30.0f, 35.0f, 40.0f};
    eve::alignas<eve::wid<float>> std::array<float, N> data2{-1.0f, 4.0f, 9.0f, 16.0, 25.0f, -36.0f, 49.0f, 64.0f};
    eve::alignas<eve::wid<float>> std::array<float, N> result_scalar ;
    eve::alignas<eve::wid<float>> std::array<float, N> result_simd;
