...
int main()
{
  ...
  eve::wide wi  = {0, 1, 2, 3, 4, 5, 6, 7};
  eve::wide x(2.0);

  std::cout << "<- wf = " << wf << "\n";
  std::cout << "<- wi = " << wi << "\n";

  std::cout << "-> hermite(wi, wf)                = " << eve::hermite(wi, wf) << "\n";
  std::cout << "-> hermite[ignore_last(2)](wi, wf)= " << eve::hermite[eve::ignore_last(2)](wi, wf) << "\n";
  std::cout << "-> hermite[wi != 4](wi, wf)       = " << eve::hermite[wi != 4](wi, wf) << "\n\n";
