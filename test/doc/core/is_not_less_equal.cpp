...
consteval auto constexpr_is_not_less_equal(auto a, auto b) { return eve::is_not_less_equal(a, b); }
...
int main()
{
  ...
  std::cout << "-> constexpr_is_not_less_equal(1.0f,2.0f) = " << constexpr_is_not_less_equal(1.0f,2.0f) << std::endl;
