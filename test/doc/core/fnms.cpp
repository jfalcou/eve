...
int main()
{
  ...
  std::cout << "---- simd" << '\n'
            ...
            << " <- pi                                 = " << pi << '\n'
            << " <- qi                                 = " << qi << '\n'
            << " -> pedantic_(fnms)(oi, pi, qi)        = " << eve::pedantic_(eve::fnms)(oi, pi, qi) << '\n'
            << " -> numeric_(fnms)(oi, pi, qi)         = " << eve::numeric_(eve::fnms)(oi, pi, qi) << '\n'
  ...
  std::cout << "---- scalar" << std::setprecision(10) << '\n'
            << " <- vm                                = " << vm << '\n'
            << " -> pedantic_(fnms)(vm, 2.0f, vm)     = " << eve::pedantic_(eve::fnms)(vm, 2.0f, -vm) << '\n'
            << " -> numeric_(fnms)(vm, 2.0f, vm)      = " << eve::numeric_(eve::fnms)(vm, 2.0f, -vm) << '\n'
            << " -> fnms(vm, 2.0f, vm)                = " << eve::fnms(vm, 2.0f, -vm) << '\n'
            << " <- esm1                              = " << esm1 << '\n'
            << " <- esp1                              = " << esp1 << '\n'
            << " -> pedantic_(fnms)(esp1, esm1, 1.0f) = " << eve::pedantic_(eve::fnms)(esp1, esm1,1.0f) << '\n'
            << " -> numeric_(fnms)(esp1, esm1, 1.0f)  = " << eve::numeric_(eve::fnms)(esp1, esm1, 1.0f) << '\n'
