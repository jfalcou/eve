...
int main()
{
  ...
  std::cout << "---- simd" << '\n'
            << "<- pi                  = " << pi << '\n'
            << "-> byte_swap(pi, _0) = " << eve::byte_swap(pi, _0) << '\n'
            << "-> byte_swap(pi, _1) = " << eve::byte_swap(pi, _1) << '\n'
            << "-> byte_swap(pi, _2) = " << eve::byte_swap(pi, _2) << '\n'
            << "-> byte_swap(pi, _4) = " << eve::byte_swap(pi, _4) << '\n';
  ...
  std::cout << "---- scalar" << '\n'
            << "<- xf                = " << std::hex << "0x" << xf << '\n'
            << "-> byte_swap(xf, _1) = " << std::hex << "0x00" << eve::byte_swap(xf,_1) << '\n';
  return 0;
}
