...
int main()
{
  ...
  std::cout << "---- simd" << '\n'
            << "<- pi              = " << pi << '\n'
            << "-> bit_set(pi, _1) = " << eve::bit_set(pi, _1) << '\n'
            << "-> bit_set(pi, 1u) = " << eve::bit_set(pi, 1u) << '\n'
            << "-> bit_set(pi, _2) = " << eve::bit_set(pi, _2) << '\n'
            << "-> bit_set(pi, _3) = " << eve::bit_set(pi, _3) << '\n'
            << "-> bit_set(pi, _4) = " << eve::bit_set(pi, _4) << '\n'
            << "-> bit_set(pi, _8) = " << eve::bit_set(pi, _8) << '\n'
            << "-> bit_set(pi, _17)= " << eve::bit_set(pi, _17) << '\n';
  ...
  std::cout << "---- scalar" << '\n'
            << "<- xf               = " << +xf << '\n'
            << "-> bit_set(xf, _2) = " << +eve::bit_set(xf, _2) << '\n';
  return 0;
}
