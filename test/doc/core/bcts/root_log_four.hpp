...
namespace eve
{
  ...
  //! #### Example
  //!
  //! @godbolt{doc/core/root_log_four.cpp}
  //!
  //! @}
  //================================================================================================
  ...
  namespace detail
  {
    ...
    EVE_FORCEINLINE auto root_log_four_(EVE_SUPPORTS(cpu_), eve::as<T> const & ) noexcept
    {
      ...
      if constexpr(std::is_same_v<t_t, float>)       return 0x1.2d6abep+0;
      else if constexpr(std::is_same_v<t_t, double>) return 0x1.2d6abe44afc43p+0;
    }
    ...
    requires(is_one_of<D>(types<upward_type, downward_type> {}))
    {
      ...
      {
        if constexpr(std::is_same_v<t_t, float>)  return 0x1.2d6acp+0;
        else if constexpr(std::is_same_v<t_t, double>) return 0x1.2d6abe44afc44p+0;
      }
