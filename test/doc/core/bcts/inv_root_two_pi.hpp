...
namespace eve
{
  ...
  //! #### Example
  //!
  //! @godbolt{doc/core/inv_root_two_pi.cpp}
  //!
  //! @}
  //================================================================================================
  ...
  namespace detail
  {
    ...
    EVE_FORCEINLINE auto inv_root_two_pi_(EVE_SUPPORTS(cpu_), eve::as<T> const & ) noexcept
    {
      ...
      if constexpr(std::is_same_v<t_t, float>)       return 0x1.988454p-2;
      else if constexpr(std::is_same_v<t_t, double>) return 0x1.9884533d43651p-2;
    }
    ...
    requires(is_one_of<D>(types<upward_type, downward_type> {}))
    {
      ...
      {
        if constexpr(std::is_same_v<t_t, float>)  return 0x1.988452p-2;
        else if constexpr(std::is_same_v<t_t, double>) return 0x1.9884533d4365p-2;
      }
    }
  }
}
