...
namespace eve
{
  ...
  //! #### Example
  //!
  //! @godbolt{doc/core/exp_minus_half.cpp}
  //!
  //! @}
  //================================================================================================
  ...
  namespace detail
  {
    ...
    EVE_FORCEINLINE auto exp_minus_half_(EVE_SUPPORTS(cpu_), eve::as<T> const & ) noexcept
    {
      ...
      if constexpr(std::is_same_v<t_t, float>)       return 0x1.368b3p-1;
      else if constexpr(std::is_same_v<t_t, double>) return 0x1.368b2fc6f960ap-1;
    }
    ...
    requires(is_one_of<D>(types<upward_type, downward_type> {}))
    {
      ...
      {
        if constexpr(std::is_same_v<t_t, float>)  return 0x1.368b2ep-1;
        else if constexpr(std::is_same_v<t_t, double>) return 0x1.368b2fc6f9609p-1;
      }
    }
  }
}
