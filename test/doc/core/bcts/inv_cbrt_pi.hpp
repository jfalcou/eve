...
namespace eve
{
  ...
  //! #### Example
  //!
  //! @godbolt{doc/core/inv_cbrt_pi.cpp}
  //!
  //! @}
  //================================================================================================
  ...
  namespace detail
  {
    ...
    EVE_FORCEINLINE auto inv_cbrt_pi_(EVE_SUPPORTS(cpu_), eve::as<T> const & ) noexcept
    {
      ...
      if constexpr(std::is_same_v<t_t, float>)       return 0x1.5d95ep-1;
      else if constexpr(std::is_same_v<t_t, double>) return 0x1.5d95df6bd2aeep-1;
    }
    ...
    requires(is_one_of<D>(types<upward_type, downward_type> {}))
    {
      ...
      {
        if constexpr(std::is_same_v<t_t, float>)  return 0x1.5d95dep-1;
        else if constexpr(std::is_same_v<t_t, double>) return 0x1.5d95df6bd2aedp-1;
      }
    }
  }
}
