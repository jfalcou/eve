...
using int_16 = eve::as_<std::int16_t>;
using int_64 = eve::as_<std::int64_t>;
...
int main()
{
  ...
  std::cout << "---- simd" << '\n'
            ...
            << "-> saturated_(convert)(pf, int_16())  = " << eve::saturated_(eve::convert)(pf, int_16()) << '\n'
            << "-> convert(pf, int_16()) =            = " << eve::convert(pf, int_16()) << '\n'
            << "<- pi                                 = " << pi << '\n'
            << "-> convert(pi, as<double>())          = " << eve::convert(pi, eve::as<double>()) << '\n';
  ...
  std::cout << "---- scalar" << '\n'
            ...
            << "<- xi                               = " << xi << '\n'
            << "-> convert(xi, as<double>())        = " << eve::convert(xi, eve::as<double>()) << '\n';
  return 0;
}
