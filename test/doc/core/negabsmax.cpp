...
consteval auto constexpr_negabsmax(auto a, auto b) { return eve::negabsmax(a, b); }
...
int main()
{
  ...
  std::cout << "-> constexpr_negabsmax(1.0f,2.0f) = " << constexpr_negabsmax(1.0f,2.0f) << std::endl;
