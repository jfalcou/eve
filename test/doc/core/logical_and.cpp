...
consteval auto constexpr_logical_and(auto a, auto b) { return eve::logical_and(a, b); }
...
int main()
{
  ...
  std::cout << "-> constexpr_logical_and(xf > 1, yf < 2) = " << constexpr_logical_and(xf > 1, yf < 2) << std::endl;
