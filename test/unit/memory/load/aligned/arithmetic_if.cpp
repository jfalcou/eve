...
//==================================================================================================
auto aligned_tests = []<typename T>( auto& runtime, bool verbose, auto const&, T )
{
  ...
  auto ptr          = eve::as_aligned<algt  >(&data[idx]);
  auto const_ptr    = eve::as_aligned<algt  >((v_t const*)(ptr));
...
EVE_TEST_BED( "Check conditional load to wides from aligned pointer"
...
//==================================================================================================
auto realigned_tests = []<typename T> (auto& runtime, bool verbose, auto const&
                                      , T
                                      )
{
  using v_t = eve::element_type_t<T>;
