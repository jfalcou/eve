...
TTS_CASE("Check validation of the scalar_value concept for actual scalar types" )
{
  using eve::logical;
...
TTS_CASE("Check validation of the scalar_value concept for non-scalar types" )
{
  using eve::logical;
  using eve::fixed;
  using eve::wide;
