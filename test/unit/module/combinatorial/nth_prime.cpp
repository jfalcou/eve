...
<typename T>(tts::type<T>)
{
  ...
  {
    using r_t = eve::as_wide_as_t<float, T>;
    TTS_EQUAL(eve::nth_prime(T(1000), eve::as<float>()), r_t(7927));
    TTS_EQUAL(eve::nth_prime(T(9000), eve::as<float>()), r_t(93187));
  }
  ...
  {
    using r_t = eve::as_wide_as_t<double, T>;
    TTS_EQUAL(eve::nth_prime(T(1000), eve::as<double>()), r_t(7927));
    TTS_EQUAL(eve::nth_prime(T(9000), eve::as<double>()), r_t(93187));
  }
};
