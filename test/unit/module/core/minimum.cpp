...
TTS_CASE_TPL("Check eve::minimum return type (scalar)", eve::test::scalar::all_types_wf16)
<typename T>(tts::type<T>)
{
  arithmetic_reduction_scalar_type_test(eve::minimum, eve::as<T>{});
};

TTS_CASE_TPL("Check eve::minimum return type (wide)", eve::test::simd::all_types_wf16)
<typename T>(tts::type<T>)
{
