...
<typename T>(tts::type<T>)
{
  ...
  if constexpr( eve::floating_value<T> )
  {
    ...
    TTS_EXPR_IS(eve::is_less_equal[eve::almost2 = v_t()](T(), v_t()), logical<T>);
    TTS_EXPR_IS(eve::is_less_equal[eve::almost2 = v_t()](v_t(), T()), logical<T>);
    using ui_t = eve::as_integer_t<v_t, unsigned>;
    TTS_EXPR_IS(eve::is_less_equal[eve::almost2 = ui_t()](T(), T()), logical<T>);
    TTS_EXPR_IS(eve::is_less_equal[eve::almost2 = ui_t()](T(), v_t()), logical<T>);
    TTS_EXPR_IS(eve::is_less_equal[eve::almost2 = ui_t()](v_t(), T()), logical<T>);
  }
};
...
<typename T>(tts::type<T> const&)
{
  ...
  TTS_EQUAL(eve::is_less_equal[eve::almost2](T(1), T(1)), eve::true_(eve::as<T>()));
  TTS_EQUAL(eve::is_less_equal[eve::almost2](T(1), v_t(1)), eve::true_(eve::as<T>()));
  ...
  TTS_EQUAL(eve::is_less_equal[eve::almost2 = ui_t(3)](T(1), T(1)), eve::true_(eve::as<T>()));
  TTS_EQUAL(eve::is_less_equal[eve::almost2 = ui_t(3)](T(1), v_t(1)), eve::true_(eve::as<T>()));
  TTS_EQUAL(eve::is_less_equal[eve::almost2 = ui_t(3)](T(3), T(1)), eve::false_(eve::as<T>()));
  TTS_EQUAL(eve::is_less_equal[eve::almost2 = ui_t(3)](T(3), v_t(1)), eve::false_(eve::as<T>()));

  if constexpr( eve::platform::supports_denormals )
  {
    auto md = eve::mindenormal(eve::as<v_t>());

    TTS_EQUAL(eve::is_less_equal[eve::almost2 = ui_t(3)](v_t(md), T(0)), eve::true_(eve::as<T>()));
    TTS_EQUAL(eve::is_less_equal[eve::almost2 = ui_t(3)](v_t(2 * md), T(0)),
              eve::true_(eve::as<T>()));
    TTS_EQUAL(eve::is_less_equal[eve::almost2 = ui_t(3)](v_t(3 * md), T(0)),
              eve::true_(eve::as<T>()));
    TTS_EQUAL(eve::is_less_equal[eve::almost2 = ui_t(3)](v_t(4 * md), T(0)),
              eve::false_(eve::as<T>()));
    TTS_EQUAL(eve::is_less_equal[eve::almost2 = ui_t(3)](v_t(1), v_t(1)), eve::true_(eve::as<v_t>()));
  }
};
