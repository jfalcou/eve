...
<typename T>(tts::type<T>)
{
  ...
  if constexpr( eve::floating_value<T> )
  {
    ...
    TTS_EXPR_IS(eve::is_less_equal[eve::almost2](T(), T(), ui_t()), logical<T>);
    TTS_EXPR_IS(eve::is_less_equal[eve::almost2](T(), v_t(), ui_t()), logical<T>);
    TTS_EXPR_IS(eve::is_less_equal[eve::almost2](v_t(), T(), ui_t()), logical<T>);
  }
};
