...
// Types tests
//==================================================================================================
TTS_CASE_TPL("Check return types of dec", eve::test::simd::all_types_wf16)
...
TTS_CASE_TPL("Check corner-cases behavior of dec(wide) and dec[mask](wide)", eve::test::simd::all_types_wf16)
