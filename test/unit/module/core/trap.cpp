  ...
  <typename T>(T const& a0, T const& a1, T const& a2, T const& a3)
{
  ...
  TTS_ULP_EQUAL(trapz(kumi::tuple{a0, a1, a2, a3}), eve::trapz(y), 2);
};


//==================================================================================================
// Tests for masked trapz
//==================================================================================================
TTS_CASE_WITH("Check behavior of eve::masked(eve::trapz)(eve::wide)",
              eve::test::simd::ieee_reals,
              tts::generate(tts::randoms(-100, 100),
                            tts::randoms(-100, 100),
                            tts::logicals(0, 3)))
  <typename T, typename M>(T const& a0,
                           ...
                           M const& mask)
{
  TTS_IEEE_EQUAL(eve::trapz[mask](a0, a1, a0, a1),
                 eve::if_else(mask, eve::trapz(a0, a1, a0, a1), a0));
};
...
<typename T>(T const& a0, T const& a1,  T const&a2, T const& a3)
{
  ...
  if constexpr(sizeof(eve::element_type_t<T>) < 8)
    TTS_ULP_EQUAL(trapz[kahan](a0, a1, a2, a3), eve::downgrade(trapz[widen](a0, a1, a2, a3)), 0.5);
