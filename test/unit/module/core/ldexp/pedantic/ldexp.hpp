...
TTS_CASE_TPL("Check pedantic ldexp return type", EVE_TYPE)
{
...
TTS_CASE_TPL("Check eve::pedantic_(eve::ldexp) two parameters behavior", EVE_TYPE)
{
  using i_t = eve::detail::as_integer_t<T, signed>;
  using si_t = eve::detail::as_integer_t<v_t, signed>;
  ...
  TTS_EQUAL(eve::pedantic_(eve::ldexp)(T{0.0}, i_t(0)), T(0));
  TTS_EQUAL(eve::pedantic_(eve::ldexp)(T{-0.0}, i_t(0)), T(0));
