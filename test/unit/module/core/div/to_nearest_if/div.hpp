...
{
  TTS_EXPR_IS( (eve::to_nearest(eve::div[ EVE_TYPE()              ])(EVE_TYPE(), EVE_TYPE())), EVE_TYPE);
  TTS_EXPR_IS( (eve::to_nearest(eve::div[ eve::logical<EVE_TYPE>()])(EVE_TYPE(), EVE_TYPE())), EVE_TYPE);
  TTS_EXPR_IS( (eve::to_nearest(eve::div[ true                    ])(EVE_TYPE(), EVE_TYPE())), EVE_TYPE);
}
