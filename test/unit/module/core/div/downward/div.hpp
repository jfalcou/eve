...
TTS_CASE("Check div return type")
{
  ...
  TTS_EXPR_IS(eve::div(Type(), Value() , eve::downward_), (Type));
  TTS_EXPR_IS(eve::div(Value(), Type() , eve::downward_), (Type));
}
...
TTS_CASE("Check eve::div behavior")
{
  ...
  TTS_EQUAL(eve::div(Value{12}, Type{4}, eve::downward_), Type{3});
  TTS_EQUAL(eve::div(Value{1} , Type{2}, eve::downward_), Type(0));
  TTS_EQUAL(eve::div(Value{4} , Type{3}, eve::downward_), Type(1));

  TTS_EQUAL(eve::div(Type{12}, Value{4}, eve::downward_), Type{3});
  TTS_EQUAL(eve::div(Type{1} , Value{2}, eve::downward_), Type(0));
  TTS_EQUAL(eve::div(Type{4} , Value{3}, eve::downward_), Type(1));
}
