...
{
  TTS_EXPR_IS( (eve::upward(eve::div[ EVE_TYPE()              ])(EVE_TYPE(), EVE_TYPE())), EVE_TYPE);
  TTS_EXPR_IS( (eve::upward(eve::div[ eve::logical<EVE_TYPE>()])(EVE_TYPE(), EVE_TYPE())), EVE_TYPE);
  TTS_EXPR_IS( (eve::upward(eve::div[ true                    ])(EVE_TYPE(), EVE_TYPE())), EVE_TYPE);
}
