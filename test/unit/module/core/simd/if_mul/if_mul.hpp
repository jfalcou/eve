            ...
            )
{
  ...
  wide<Type,T>  ref([](int i, int ) { return eve::mul[Type((i%2)*i)](Type(i%2+1),Type(i%3)); });

  TTS_EQUAL(ref , eve::mul[cond]( rhs1, rhs2));          //w w w
  TTS_EQUAL(ref , eve::mul[is_nez(cond)]( rhs1, rhs2));  //lw w w
}
            ...
            )
{
  ...
  wide<Type,T>    lhs([](int i, int ) { return i%3; })
    , refss([](int i, int ) { return eve::mul[ Type(i%3)]( Type(7), Type(8)); })
