             ...
             fixed<64>)
{
  ...
  l_t ref([](auto i, auto c) { return eve::is_not_equal(Type(i), i % 2 ? Type(i) : Nan<Type>()); });

  TTS_EQUAL(ref, eve::is_not_equal(v0, v1));
  TTS_EQUAL(ref, eve::is_not_equal(v1, v0));
