...
{
  using eve::wide;
  wide<Type, T> lhs([](auto i, auto c) { return c - i; }), rhs1([](auto i, auto) { return i + 1; }),
      rhs2([](auto i, auto) { return 2 * i + 1; }), ref([](auto i, auto c) {
        return eve::bitwise_select(Type(c - i), Type(i + 1), Type(2 * i + 1));
      });
             ...
             fixed<64>)
{
  ...
  wide<Type, T> lhs([](auto i, auto c) { return i % 3; }),
      rhs([](auto i, auto c) { return 2 * i + 1; }), ref1([](auto i, auto c) {
        return eve::bitwise_select(Type(i % 3), Type(2 * i + 1), Type(8));
      }),
      ref2([](auto i, auto c) {
        return eve::bitwise_select(Type(i % 3), Type(8), Type(2 * i + 1));
      });
