            ...
            )
{
  ...
  logical<wide<Type, T>>  ref([](auto i, auto c) { return eve::is_not_less(Type(c - i), Type(i%2 ? i : c-i)); });
             ...
             )
{
  ...
  logical< wide<Type, T> >  refl([](auto i, auto) { return eve::is_not_less(Type(i), Type(2)); });
  logical< wide<Type, T> >  refr([](auto i, auto) { return eve::is_not_less(Type(2), Type(i)); });

  TTS_EQUAL(refl, eve::is_not_less(lhs, Type(2)));
  TTS_EQUAL(refr, eve::is_not_less(Type(2), lhs));
}
