              ...
              fixed<64>)
{
  ...
  logical<wide<Type, T>> ref4([](auto i, auto) { return eve::logical_ornot(Type(0), Type(i)); });

  TTS_EQUAL(ref1, eve::logical_ornot(lhs, Type(2)));
  TTS_EQUAL(ref2, eve::logical_ornot(Type(2), lhs));
  TTS_EQUAL(ref3, eve::logical_ornot(lhs, Type(0)));
  TTS_EQUAL(ref4, eve::logical_ornot(Type(0), lhs));
}
