            ...
            )
{
  ...
  TTS_EXPR_IS(eve::div(t_t(1), t_t(1), eve::upward_) , t_t);

  if constexpr(std::is_integral_v<Type>)
  {
    if constexpr(std::is_signed_v<Type>)
    {
      TTS_EQUAL(eve::div(eve::Mone<t_t>(),   eve::Mone<t_t>(), eve::upward_), eve::One<t_t>());
      TTS_EQUAL(eve::div(eve::One<t_t>(),    eve::One<t_t>() , eve::upward_), eve::One<t_t>());
      TTS_EQUAL(eve::div(eve::Valmax<t_t>(), eve::Mone<t_t>(), eve::upward_), eve::Valmin<t_t>()+eve::One<t_t>());
      TTS_EQUAL(eve::div(eve::Valmax<t_t>(), eve::One<t_t>() , eve::upward_), eve::Valmax<t_t>());
      TTS_EQUAL(eve::div(eve::Valmin<t_t>(), eve::Mone<t_t>(), eve::upward_), eve::Valmax<t_t>());
      TTS_EQUAL(eve::div(eve::Zero<t_t>(),   eve::Zero<t_t>(), eve::upward_), eve::Zero<t_t>());
      TTS_EQUAL(eve::div(eve::Mone<t_t>(),   eve::Zero<t_t>(), eve::upward_), eve::Valmin<t_t>());
      TTS_EQUAL(eve::div(eve::Valmin<t_t>(), eve::Zero<t_t>(), eve::upward_), eve::Valmin<t_t>());
