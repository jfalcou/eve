            ...
            )
{
  ...
  logical<wide<Type, T>>  ref([](auto i, auto c) { return eve::is_not_greater(Type(c - i), Type(i%2 ? i : c-i)); });
  ...
  if constexpr(std::is_floating_point_v<Type>)
  {
    ...
    logical<wide<Type, T>>  ref1([](auto i, auto c) { return eve::is_not_greater(Type(i%3)/Type(i%2),Type(i%2)/Type(i%3) ); });
             ...
             )
{
  ...
  if constexpr(std::is_floating_point_v<Type>)
  {
    logical< wide<Type, T> >  refln([](auto i, auto) { return eve::is_not_greater(eve::Nan<Type>(), Type(i)); });
    logical< wide<Type, T> >  refrn([](auto i, auto) { return eve::is_not_greater(Type(i), eve::Nan<Type>()); }); 
