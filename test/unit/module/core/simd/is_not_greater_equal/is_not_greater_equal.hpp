             ...
             fixed<64>)
{
  ...
  TTS_SETUP("A correctly initialized wide")
  {
    ...
    wide<eve::logical<Type>, T> ref(
        [](int i, int c) { return eve::is_not_greater_equal(Type(c - i), Type(i % 2 ? i : c - i)); });
    TTS_SECTION("supports eve::is_not_greater_equal") { TTS_EQUAL(ref, eve::is_not_greater_equal(lhs, rhs)); }
             ...
             fixed<64>)
{
  ...
  TTS_SETUP("A correctly initialized wide")
  {
    ...
    wide<eve::logical<Type>, T> ref1(
        [](int i, int c) { return eve::is_not_greater_equal(Type(c - i), Type(1)); });
    wide<eve::logical<Type>, T> ref2(
        [](int i, int c) { return eve::is_not_greater_equal(Type(1), Type(c - i)); });
    TTS_SECTION("supports eve::is_not_greater_equal1") { TTS_EQUAL(ref1, eve::is_not_greater_equal(lhs, Type(1))); }
    TTS_SECTION("supports eve::is_not_greater_equal2") { TTS_EQUAL(ref2, eve::is_not_greater_equal(Type(1), lhs)); }
