             ...
             fixed<64>)
{
  ...
  logical<wide<Type, T>> ref([](auto i, auto c) {
    return eve::is_not_greater_equal(Type(c - i), Type(i % 2 ? i : c - i));
  });
             ...
             fixed<64>)
{
  ...
  logical<wide<Type, T>> refl(
      [](auto i, auto) { return eve::is_not_greater_equal(Type(i), Type(2)); });
  logical<wide<Type, T>> refr(
      [](auto i, auto) { return eve::is_not_greater_equal(Type(2), Type(i)); });
