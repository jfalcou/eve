...
TTS_CASE_TPL("Check is_greater behavior on homogeneous logical<wide>",
             fixed<1>,
             fixed<2>,
             fixed<4>,
             fixed<8>,
...
TTS_CASE_TPL("Check is_greater behavior on logical<wide> and scalar",
             fixed<1>,
             fixed<2>,
             fixed<4>,
             fixed<8>,
             ...
             )
{
  ...
  TTS_EQUAL(refl, eve::is_greater(lhs, logical<Type>(true)));
  TTS_EQUAL(refr, eve::is_greater(logical<Type>(true), lhs));
  TTS_EQUAL(refl, eve::is_greater(lhs, true));
  TTS_EQUAL(refr, eve::is_greater(true, lhs));
