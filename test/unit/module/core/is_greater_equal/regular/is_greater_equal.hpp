...
TTS_CASE_TPL("Check eve::is_greater_equal behavior", EVE_TYPE)
{
  ...
  if constexpr(eve::platform::supports_nans && eve::floating_value<T>)
  {
    TTS_EQUAL(eve::is_greater_equal(T(1)          , eve::nan(eve::as<T>()) ), eve::False<T>());
    TTS_EQUAL(eve::is_greater_equal(eve::nan(eve::as<T>()) , T(1)          ), eve::False<T>());
  }
  ...
  TTS_EQUAL(eve::is_greater_equal(T(1)  , T(3)  ), eve::False<T>());
  TTS_EQUAL(eve::is_greater_equal(T(1)  , v_t(3)), eve::False<T>());
  TTS_EQUAL(eve::is_greater_equal(v_t(1), T(3)  ), eve::False<T>());
}
