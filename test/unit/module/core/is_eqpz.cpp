...
<typename T, typename M>(T const& a0, M const& t)
{
  ...
  TTS_EQUAL(eve::is_eqpz(a0), map([](auto e) -> eve::logical<v_t> { return eve::is_positive(e) && e == 0; }, a0));
  TTS_EQUAL(eve::is_eqpz(eve::mzero(eve::as(a0))), eve::false_(eve::as(a0)));
  TTS_EQUAL(eve::is_eqpz(eve::zero(eve::as(a0))), eve::true_(eve::as(a0)));
