  ...
  <typename T>(tts::type<T>)
{
  ...
  TTS_EQUAL(eve::ilogb(eve::inf(eve::as<T>())), eve::valmax(eve::as<i_t>()));
  TTS_EQUAL(eve::ilogb(eve::inf(eve::as<v_t>())), eve::valmax(eve::as<vi_t>()));
  TTS_EQUAL(eve::ilogb(eve::minf(eve::as<T>())), eve::valmax(eve::as<i_t>()));
  TTS_EQUAL(eve::ilogb(eve::minf(eve::as<v_t>())), eve::valmax(eve::as<vi_t>()));
  TTS_EQUAL(eve::ilogb(eve::nan(eve::as<T>())), eve::valmax(eve::as<i_t>()));
  TTS_EQUAL(eve::ilogb(eve::nan(eve::as<v_t>())), eve::valmax(eve::as<vi_t>()));
