...
TTS_CASE("Check eve::bit_ornot return type")
{
  ...
  TTS_EXPR_IS((eve::bit_ornot[ EVE_TYPE() ](EVE_TYPE(), EVE_TYPE()))  , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ EVE_TYPE() ](EVE_TYPE(), EVE_VALUE())) , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ EVE_TYPE() ](EVE_TYPE(), ui_t()))  , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ EVE_TYPE() ](EVE_TYPE(), vi_t()))  , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ EVE_TYPE() ](ui_t(), EVE_TYPE()))  , ui_t  );
              
  TTS_EXPR_IS((eve::bit_ornot[ eve::logical<EVE_TYPE>() ](EVE_TYPE(), EVE_TYPE()))  , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ eve::logical<EVE_TYPE>() ](EVE_TYPE(), EVE_VALUE())) , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ eve::logical<EVE_TYPE>() ](EVE_TYPE(), ui_t()))  , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ eve::logical<EVE_TYPE>() ](EVE_TYPE(), vi_t()))  , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ eve::logical<EVE_TYPE>() ](ui_t(), EVE_TYPE()))  , ui_t  );
              
  TTS_EXPR_IS((eve::bit_ornot[ true  ](EVE_TYPE(), EVE_TYPE()))  , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ true  ](EVE_TYPE(), EVE_VALUE())) , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ true  ](EVE_TYPE(), ui_t()))  , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ true  ](EVE_TYPE(), vi_t()))  , (EVE_TYPE));
  TTS_EXPR_IS((eve::bit_ornot[ true  ](ui_t(), EVE_TYPE()))  , ui_t  );
}
