...
TTS_CASE_TPL("Check eve::is_less behavior", EVE_TYPE)
{
  ...
  {
    TTS_EQUAL(eve::is_less(T(1)         , eve::nan(eve::as<T>()) ), eve::False(eve::as<T>()));
    TTS_EQUAL(eve::is_less(eve::nan(eve::as<T>()), T(1)          ), eve::False(eve::as<T>()));
  }

  TTS_EQUAL(eve::is_less(T(1)   , T(1)  ), eve::False(eve::as<T>()));
  TTS_EQUAL(eve::is_less(T(1)   , v_t(1)), eve::False(eve::as<T>()));
  TTS_EQUAL(eve::is_less(v_t(1) , T(1)  ), eve::False(eve::as<T>()));
  TTS_EQUAL(eve::is_less(T(3)   , T(1)  ), eve::False(eve::as<T>()));
  TTS_EQUAL(eve::is_less(T(3)   , v_t(1)), eve::False(eve::as<T>()));
  TTS_EQUAL(eve::is_less(v_t(3) , T(1)  ), eve::False(eve::as<T>()));
...
TTS_CASE_TPL("Check eve::operator< behavior", EVE_TYPE)
{
  ...
  TTS_EQUAL( (v_t(3) < T(1)   ) , eve::False(eve::as<T>()));
