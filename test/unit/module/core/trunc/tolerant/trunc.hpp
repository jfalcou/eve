...
TTS_CASE_TPL("Check eve::tolerant(eve::trunc) behavior", EVE_TYPE)
{
  if constexpr(eve::floating_value<T>)
  {
    ...
    TTS_EQUAL(eve::tolerant(eve::trunc)(eve::prev(T(45), 2), 3), T(45));
    TTS_EQUAL(eve::tolerant(eve::trunc)(eve::prev(T(45), 3), 3), T(45));
    TTS_EQUAL(eve::tolerant(eve::trunc)(eve::prev(T(45), 4), 3), T(44));
  }
}
