...
TTS_CASE("Check eve::rshl behavior")
{
  ...
  {
    TTS_EQUAL(eve::rshl(eve::allbits(eve::as<EVE_TYPE>()),  1), EVE_TYPE(-2)             );
    TTS_EQUAL(eve::rshl(eve::allbits(eve::as<EVE_TYPE>()), -1), eve::allbits(eve::as<EVE_TYPE>()) );
  }
  else
  {
    TTS_EQUAL(eve::rshl(eve::allbits(eve::as<EVE_TYPE>()),  1), eve::allbits(eve::as<EVE_TYPE>()) - 1 );
    TTS_EQUAL(eve::rshl(eve::allbits(eve::as<EVE_TYPE>()), -1), eve::allbits(eve::as<EVE_TYPE>())/2   );
  }
}
