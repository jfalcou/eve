...
TTS_CASE_TPL("Check eve::stirling behavior", EVE_TYPE)
{
  ...
  {
    TTS_ULP_EQUAL(eve::stirling(eve::Inf<T>()  ) , eve::Inf<T>(), 0.5);
    TTS_ULP_EQUAL(eve::stirling(eve::Minf<T>() ) , eve::Nan<T>(), 0.5);
    TTS_ULP_EQUAL(eve::stirling(eve::Mone<T>() ) , eve::Nan<T>(), 0.5);
    TTS_ULP_EQUAL(eve::stirling(eve::Nan<T>()  ) , eve::Nan<T>(), 0.5);
  }
