...
// Types tests
//==================================================================================================
TTS_CASE_TPL("Check return types of eve::bit_or(scalar)", eve::test::scalar::all_types)
<typename T>(tts::type<T>)
{
  bit_test_scalar_return_type<T>(eve::bit_or);
};

TTS_CASE_TPL("Check return types of eve::bit_or(simd)", eve::test::simd::all_types)
<typename T>(tts::type<T>)
{
