...
TTS_CASE("Check eve::bit_notand return type")
{
  ...
  TTS_EXPR_IS(eve::bit_notand(Type(), Type()) , (Type));
  TTS_EXPR_IS(eve::bit_notand(Type(), Value()), (Type));
  TTS_EXPR_IS(eve::bit_notand(Type(), ui_t()) , (Type));
  TTS_EXPR_IS(eve::bit_notand(Type(), vi_t()) , (Type));
  TTS_EXPR_IS(eve::bit_notand(ui_t(), Type()) , ui_t  );
}
