...
TTS_CASE_TPL("Check behavior of eve::logical_andnot(invalid)", tts::cartesian_square<eve::test::scalar::all_types>)
<typename T, typename U>(tts::type<kumi::tuple<T, U>>)
{
  logical_test_compile_reject<T, U>(eve::logical_andnot);
};
