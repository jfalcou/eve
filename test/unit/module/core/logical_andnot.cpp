...
//== Types tests
//==================================================================================================
TTS_CASE_TPL( "Check return types of eve::logical_andnot(simd)"
...
<typename M, typename T>(M const& l0, M const& l1, T const & a0)
{
  ...
  TTS_EQUAL(eve::logical_andnot(l0, l1), map([](auto e, auto f) -> l_t { return  e && !f; }, l0, l1));
  TTS_EQUAL(eve::logical_andnot(l0, l1.get(0)), map([&](auto e) -> l_t { return  e && !l1.get(0); }, l0));
  TTS_EQUAL(eve::logical_andnot(l0.get(0), l1), map([&](auto f) -> l_t { return  l0.get(0) && !f; }, l1));
  using v_t = eve::element_type_t<T>;
