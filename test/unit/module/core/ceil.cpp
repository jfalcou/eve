...
<typename T>(tts::type<T>)
{
  ...
  TTS_EQUAL(eve::ceil[eve::tolerant](T(-1)), T(-1));
  TTS_EQUAL(eve::ceil[eve::tolerant](T(-2)), T(-2));
  TTS_EQUAL(eve::ceil[eve::tolerant](T(0)), T(0));
  TTS_EQUAL(eve::ceil[eve::tolerant](T(1)), T(1));
  TTS_EQUAL(eve::ceil[eve::tolerant](T(2)), T(2));

  TTS_EQUAL(eve::ceil[eve::tolerant](T(-1.3)), T(-1));
  TTS_EQUAL(eve::ceil[eve::tolerant](T(-1.5)), T(-1));
  TTS_EQUAL(eve::ceil[eve::tolerant](T(-1.6)), T(-1));
  TTS_EQUAL(eve::ceil[eve::tolerant](T(1.3)), T(2));
  TTS_EQUAL(eve::ceil[eve::tolerant](T(1.5)), T(2));
  TTS_EQUAL(eve::ceil[eve::tolerant](T(1.6)), T(2));
  TTS_EQUAL(eve::ceil[eve::tolerant](eve::eps(eve::as<T>())), T(0));
  TTS_EQUAL(eve::ceil[eve::tolerant](2 * eve::eps(eve::as<T>())), T(0));
  TTS_EQUAL(eve::ceil[eve::tolerant](3 * eve::eps(eve::as<T>())), T(0));
  TTS_EQUAL(eve::ceil[eve::tolerant](4 * eve::eps(eve::as<T>())), T(1));
};
