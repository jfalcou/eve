...
TTS_CASE( "Check eve::bit_shr behavior")
{
  ...
  {
    TTS_EQUAL(eve::bit_shr(eve::valmax(eve::as<EVE_TYPE>()),(sizeof(EVE_VALUE)*8-1)), EVE_TYPE(1) );
    TTS_EQUAL(eve::bit_shr(eve::valmax(eve::as<EVE_TYPE>()),(sizeof(EVE_VALUE)*8-2)), EVE_TYPE(3) );
  }
}
