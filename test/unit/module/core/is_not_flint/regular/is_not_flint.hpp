...
{
  TTS_EQUAL(eve::is_not_flint(T(1)), eve::False(eve::as<T>()) );
  TTS_EQUAL(eve::is_not_flint(T(2)), eve::False(eve::as<T>()) );

  if constexpr(eve::floating_value<T>)
  {
    TTS_EQUAL(eve::is_not_flint(eve::inf(eve::as<T>())), eve::True<T>() );
