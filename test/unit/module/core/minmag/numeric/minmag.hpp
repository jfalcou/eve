...
TTS_CASE("Check eve::numeric(eve::minmag) return type")
{
  TTS_EXPR_IS(eve::numeric(eve::minmag)( EVE_TYPE(0)  , EVE_TYPE(0)  ) , EVE_TYPE);
  TTS_EXPR_IS(eve::numeric(eve::minmag)( EVE_VALUE(0) , EVE_TYPE(0)  ) , EVE_TYPE);
  TTS_EXPR_IS(eve::numeric(eve::minmag)( EVE_TYPE(0)  , EVE_VALUE(0) ) , EVE_TYPE);
}
