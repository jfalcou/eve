...
TTS_CASE("Check eve::bitwise_and return type")
{
  ...
  TTS_EXPR_IS(eve::bitwise_and(Type(), vi_t())  , (Type));
...
TTS_CASE( "Check eve::bitwise_and behavior")
{
  ...
  {
    TTS_EQUAL(eve::bitwise_and(tu,tu),tu);
    TTS_EQUAL(eve::bitwise_and(tu,td),tz);
    TTS_EQUAL(eve::bitwise_and(td,tu),tz);
    TTS_EQUAL(eve::bitwise_and(td,td),td);
  }

  TTS_SUBCASE("wide<T> x T case")
  {
    TTS_EQUAL(eve::bitwise_and(tu,vu),tu);
    TTS_EQUAL(eve::bitwise_and(tu,vd),tz);
    TTS_EQUAL(eve::bitwise_and(td,vu),tz);
    TTS_EQUAL(eve::bitwise_and(td,vd),td);
  }

  TTS_SUBCASE("wide<T> x wide<U> case")
  {
    TTS_EQUAL(eve::bitwise_and(tu,uu),tu);
    TTS_EQUAL(eve::bitwise_and(tu,ud),tz);
    TTS_EQUAL(eve::bitwise_and(td,uu),tz);
    TTS_EQUAL(eve::bitwise_and(td,ud),td);
  }

  TTS_SUBCASE("wide<T> x U case")
  {
    TTS_EQUAL(eve::bitwise_and(tu,su),tu);
    TTS_EQUAL(eve::bitwise_and(tu,sd),tz);
    TTS_EQUAL(eve::bitwise_and(td,su),tz);
    TTS_EQUAL(eve::bitwise_and(td,sd),td);
  }
}
