...
//    {
//      TTS_EXPECT(eve::all(eve::is_nan(eve::next[eve::pedantic](cases.nan))));
...
//     TTS_EXPECT(eve::all(eve::is_nan(eve::next[eve::pedantic](cases.nan))));
//////////     TTS_IEEE_EQUAL(next[pedantic](cases.minf), eve::valmin(eve::as(cases.minf))); //cases.valmin);
//     TTS_EXPECT(eve::all(eve::is_nan(next[pedantic](cases.inf))));
