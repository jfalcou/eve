...
TTS_CASE_TPL("Check eve::is_equal behavior", EVE_TYPE)
{
  ...
  {
    TTS_EQUAL(eve::is_equal(eve::nan(eve::as<T>()), eve::nan(eve::as<T>()))   , eve::False(eve::as<T>()));
    TTS_EQUAL(eve::is_equal(eve::nan(eve::as<T>()), T(4))            , eve::False(eve::as<T>()));
  }

  TTS_EQUAL(eve::is_equal(T(1)            ,   T(1) )          , eve::True<T>() );
  TTS_EQUAL(eve::is_equal(T(1)            , v_t(1))           , eve::True<T>() );
  TTS_EQUAL(eve::is_equal(T(3)            ,   T(1) )          , eve::False(eve::as<T>()));
  TTS_EQUAL(eve::is_equal(T(3)            , v_t(1))           , eve::False(eve::as<T>()));
  TTS_EQUAL(eve::is_equal(eve::True<T>()  , eve::True<T>())   , eve::True<T>() );
  TTS_EQUAL(eve::is_equal(eve::True<T>()  , eve::False(eve::as<T>()))  , eve::False(eve::as<T>()));
  TTS_EQUAL(eve::is_equal(eve::True<T>()  , eve::True<v_t>()) , eve::True<T>() );
  TTS_EQUAL(eve::is_equal(eve::True<T>()  , eve::False(eve::as<v_t>())), eve::False(eve::as<T>()));
  TTS_EQUAL(eve::is_equal(eve::True<v_t>(), eve::True<T>())   , eve::True<T>() );
  TTS_EQUAL(eve::is_equal(eve::True<v_t>(), eve::False(eve::as<T>()))  , eve::False(eve::as<T>()));
}
...
TTS_CASE_TPL("Check eve::operator== behavior", EVE_TYPE)
{
  ...
  TTS_EQUAL( T(3)           == T(1)           , eve::False(eve::as<T>()));
  TTS_EQUAL( T(3)           == v_t(1)         , eve::False(eve::as<T>()));
