...
TTS_CASE_TPL("Check eve::almost(eve::is_equal) return type", EVE_TYPE)
{
  ...
  if constexpr(eve::floating_value<T>)
  {
    ...
    TTS_EXPR_IS( eve::almost(eve::is_equal)(  T()         ,   T(), unsigned()  ) , logical<T>);
    TTS_EXPR_IS( eve::almost(eve::is_equal)(  T()         , v_t(), unsigned()  ) , logical<T>);
    TTS_EXPR_IS( eve::almost(eve::is_equal)(v_t()         ,   T(), unsigned()  ) , logical<T>);
    TTS_EXPR_IS( eve::almost(eve::is_equal)(  T()         ,   T(), T()    ) , logical<T>);
    TTS_EXPR_IS( eve::almost(eve::is_equal)(  T()         , v_t(), T()    ) , logical<T>);
    TTS_EXPR_IS( eve::almost(eve::is_equal)(v_t()         ,   T(), T()    ) , logical<T>);
    using ui_t = eve::detail::as_integer_t<T, unsigned>;
    TTS_EXPR_IS( eve::almost(eve::is_equal)(  T()         ,   T(), ui_t() ) , logical<T>);
    TTS_EXPR_IS( eve::almost(eve::is_equal)(  T()         , v_t(), ui_t() ) , logical<T>);
    TTS_EXPR_IS( eve::almost(eve::is_equal)(v_t()         ,   T(), ui_t() ) , logical<T>);
  }
}

TTS_CASE_TPL("Check eve::almost(eve::is_equal) behavior", EVE_TYPE)
{
  using v_t = eve::element_type_t<T>;
  using eve::logical;
  ...
  {
    TTS_EQUAL(eve::almost(eve::is_equal)(T(1)                  , T(1)                  )   , eve::true_(eve::as<T>()) );
    TTS_EQUAL(eve::almost(eve::is_equal)(T(1)                  , v_t(1)                )   , eve::true_(eve::as<T>()) );
    TTS_EQUAL(eve::almost(eve::is_equal)(T(3)                  , T(1)                  )   , eve::false_(eve::as<T>()));
    TTS_EQUAL(eve::almost(eve::is_equal)(T(3)                  , v_t(1)                )   , eve::false_(eve::as<T>()));
    using eve::as;
