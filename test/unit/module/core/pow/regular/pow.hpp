...
// TTS_CASE("Check eve::pow behavior")
// {
//  // specific values tests
//   #ifndef BOOST_SIMD_NO_INVALIDS
//   TTS_ULP_EQUAL(pow(eve::Inf<Type>(),3), eve::Inf<Type>(), 0);
//   TTS_ULP_EQUAL(pow(eve::Minf<Type>(),3), eve::Minf<Type>(), 0);
//   TTS_ULP_EQUAL(pow(eve::Nan<Type>(),3), eve::Nan<Type>(), 0);
//   #endif

//   TTS_ULP_EQUAL(pow(eve::Two<Type>(),-3), (eve::Ratio<Type, 1, 8>()),  0);
//  }


TTS_CASE_TPL("pow conformity",  TTS_IEEE_TYPES)
{
