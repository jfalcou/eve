...
<typename T>(tts::type<T>)
{
  ...
  TTS_EQUAL(eve::is_not_equal[eve::definitely2 =  eve::eps(as<v_t>())](T(1 + eve::eps(as<T>())), T(1)), eve::false_(as<T>()));
  TTS_EQUAL(eve::is_not_equal[eve::definitely2 =  eve::eps(as<v_t>())](T(1 + 2 * eve::eps(as<T>())), T(1)), eve::true_(as<T>()));
  TTS_EQUAL(eve::is_not_equal[eve::definitely2 =  eve::eps(as<v_t>())](T(1 + eve::eps(as<T>())), v_t(1)), eve::false_(as<T>()));
  TTS_EQUAL(eve::is_not_equal[eve::definitely2 =  eve::eps(as<v_t>())](T(3), T(1)), eve::true_(as<T>()));
  TTS_EQUAL(eve::is_not_equal[eve::definitely2 =  eve::eps(as<v_t>())](T(3), v_t(1)), eve::true_(as<T>()));
