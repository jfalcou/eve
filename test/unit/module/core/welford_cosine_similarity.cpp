...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(eve::welford_cosine_similarity(v3_t(),  v3_t()),  v_t);
};
...
<typename T>(tts::type<T>)
{
  ...
  TTS_ULP_EQUAL(eve::welford_cosine_similarity(a, b), v_t(-0.9923595707022745), 0.5);
...
//   TTS_ULP_EQUAL(eve::welford_cosine_similarity(wa, wb), cwu, 0.5);
//   f4_t cw{-0.9923595707022745, 1, 1, -0.9923595707022745};
//   TTS_ULP_EQUAL(eve::welford_cosine_similarity(a, wb), cw, 0.5);
//   f4_t cw3{-0.9923595707022745, -0.9923595707022745, 1.0, 1.0};
//   TTS_ULP_EQUAL(eve::welford_cosine_similarity(wa, b), cw3, 0.5);
