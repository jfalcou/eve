...
TTS_CASE("Check eve::medium_(eve::cos) behavior")
{
  ...
  TTS_ULP_EQUAL(eve::medium_(eve::cos)(Type(1)), Type(std_cos(1.0)), 0.5);
  TTS_ULP_EQUAL(eve::medium_(eve::cos)(Type(-1)),Type(std_cos(-1.0)), 0.5);
  TTS_IEEE_EQUAL(eve::medium_(eve::cos)(Type(0)), (Type(1)));
  TTS_IEEE_EQUAL(eve::medium_(eve::cos)(eve::Mzero<Type>()), (Type(1)));
  TTS_ULP_EQUAL((eve::medium_(eve::cos)(eve::Pio_4<Type>())), (Type(std_cos(eve::Pio_4<Value>()))), 0.5);
  TTS_ULP_EQUAL((eve::medium_(eve::cos)(-eve::Pio_4<Type>())),(Type(std_cos(-eve::Pio_4<Value>()))), 0.5);
  TTS_ULP_EQUAL((eve::medium_(eve::cos)(Type(100.0))), Type(std_cos(Value(100.0))), 0.5);
  TTS_ULP_EQUAL((eve::medium_(eve::cos)(Type(-100.0))),Type(std_cos(Value(-100.0))), 0.5);
  TTS_ULP_EQUAL((eve::medium_(eve::cos)(Type(100000.0))), Type(std_cos(Value(100000.0))), 0.5);
  TTS_ULP_EQUAL((eve::medium_(eve::cos)(Type(-100000.0))),Type(std_cos(Value(-100000.0))), 0.5);
}
