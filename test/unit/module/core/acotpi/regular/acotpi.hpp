...
TTS_CASE("Check eve::acotpi return type") { TTS_EXPR_IS(eve::acotpi(EVE_TYPE(0)), (EVE_TYPE)); }
...
TTS_CASE("Check eve::acotpi behavior")
{
  ...
  TTS_ULP_EQUAL(eve::acotpi(inv_smallest), eve::radinpi(eve::Smallestposval<EVE_TYPE>()), 0.5);
}
