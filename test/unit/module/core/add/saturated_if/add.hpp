...
{
  TTS_EXPR_IS( (eve::saturated(eve::add[ EVE_TYPE()              ])(EVE_TYPE(), EVE_TYPE())), EVE_TYPE);
  TTS_EXPR_IS( (eve::saturated(eve::add[ eve::logical<EVE_TYPE>()])(EVE_TYPE(), EVE_TYPE())), EVE_TYPE);
  TTS_EXPR_IS( (eve::saturated(eve::add[ true                ])(EVE_TYPE(), EVE_TYPE())), EVE_TYPE);
}
