...
TTS_CASE("Check eve::acotd return type") { TTS_EXPR_IS(eve::acotd(EVE_TYPE(0)), (EVE_TYPE)); }
...
TTS_CASE("Check eve::acotd behavior")
{
  ...
  TTS_ULP_EQUAL(eve::acotd(inv_smallest), eve::radindeg(eve::Smallestposval<EVE_TYPE>()), 0.5);
}
