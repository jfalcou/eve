...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(eve::cumsum(T(), T(), T(), T()), (kumi::tuple<T, T, T, T>));
  TTS_EXPR_IS(eve::cumsum(v_t(), v_t(), v_t(), v_t()), (kumi::tuple<v_t, v_t, v_t, v_t>));
  TTS_EXPR_IS(eve::cumsum(v_t(), T()  , v_t(), v_t()), (kumi::tuple<T, T, T, T>));
};
