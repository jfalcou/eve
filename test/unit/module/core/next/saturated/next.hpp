...
TTS_CASE_TPL("Check eve::saturated_(eve::next) one parameter behavior", EVE_TYPE)
{
  ...
  else
  {
    ...
    TTS_EQUAL(eve::saturated_(eve::next)(T(-1))               , T(-1)+eve::Eps<T>()/2 );
    TTS_EQUAL(eve::saturated_(eve::next)(T( 1))               , T( 1)+eve::Eps<T>()   );
...
TTS_CASE_TPL("Check eve::saturated_(eve::next) two parameters behavior", EVE_TYPE)
{
  ...
  else
  {
    ...
    TTS_EQUAL(eve::saturated_(eve::next)(  T(-1),  i_t(2)), T(-1)+eve::Eps<T>()   );
    TTS_EQUAL(eve::saturated_(eve::next)(  T( 1),  i_t(2)), T( 1)+eve::Eps<T>()*2 );
    TTS_EQUAL(eve::saturated_(eve::next)(  T(-1), si_t(2)), T(-1)+eve::Eps<T>()   );
    TTS_EQUAL(eve::saturated_(eve::next)(  T( 1), si_t(2)), T( 1)+eve::Eps<T>()*2 );
    TTS_EQUAL(eve::saturated_(eve::next)(v_t(-1),  i_t(2)), T(-1)+eve::Eps<T>()   );
    TTS_EQUAL(eve::saturated_(eve::next)(v_t( 1),  i_t(2)), T( 1)+eve::Eps<T>()*2 );
  }
}
