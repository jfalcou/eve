...
TTS_CASE("Check pedantic next return type")
{
  ...
  TTS_EXPR_IS(eve::pedantic(eve::next)(EVE_TYPE()         ), EVE_TYPE);
  TTS_EXPR_IS(eve::pedantic(eve::next)(EVE_TYPE(), i_t()  ), EVE_TYPE);
  TTS_EXPR_IS(eve::pedantic(eve::next)(EVE_TYPE(), u_t()  ), EVE_TYPE);
  TTS_EXPR_IS(eve::pedantic(eve::next)(EVE_TYPE(), si_t() ), EVE_TYPE);
  TTS_EXPR_IS(eve::pedantic(eve::next)(EVE_TYPE(), su_t() ), EVE_TYPE);
}
