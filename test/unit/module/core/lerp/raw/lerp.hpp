...
{
  TTS_EXPR_IS(eve::raw_(eve::lerp)(T(), T(), T()), T);
}

TTS_CASE_TPL("Check eve::raw_(eve::lerp) behavior", EVE_TYPE)
{
  using v_t = eve::element_type_t<T>;

  TTS_ULP_EQUAL(eve::raw_(eve::lerp)(T(12.73), T(27.6666), T(1)), T(27.6666), 0);
