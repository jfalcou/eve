...
TTS_CASE("Check eve::(eve::lerp) behavior")
{
  ...
  TTS_ULP_EQUAL(eve::lerp(EVE_TYPE(12.73), EVE_TYPE(27.6666), EVE_TYPE(0.5)), eve::average(EVE_TYPE(12.73), EVE_TYPE(27.6666)) , 0 );

  auto e0 = eve::lerp(EVE_VALUE(1), EVE_VALUE(2), eve::prev(1 - 10 * eve::eps(eve::as<EVE_VALUE>())));
