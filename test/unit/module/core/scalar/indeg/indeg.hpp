...
TTS_CASE("Check indeg return type")
{
...
TTS_CASE("Check eve::indeg behavior")
{
  ...
  TTS_ULP_EQUAL(eve::indeg(eve::Inf<Type>()), eve::Inf<Type>(), 0.5);
  TTS_ULP_EQUAL(eve::indeg(eve::Minf<Type>()), eve::Minf<Type>(), 0.5);
  TTS_ULP_EQUAL(eve::indeg(eve::Nan<Type>()), eve::Nan<Type>(), 0.5);
#endif
  ...
  TTS_ULP_EQUAL(eve::indeg(eve::Pio_2<Type>()), Type(90), 0.5);
  TTS_ULP_EQUAL(eve::indeg(eve::Pio_4<Type>()), Type(45), 0.5);
  TTS_ULP_EQUAL(eve::indeg(eve::Zero<Type>()), eve::Zero<Type>(), 0.5);
}
