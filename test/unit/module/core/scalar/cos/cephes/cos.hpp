...
{
  TTS_EXPR_IS(eve::cephes_(eve::cos)(Type(0)),  Type);
}

TTS_CASE("Check eve::cephes_(eve::cos) behavior")
{

#ifndef EVE_NO_INVALIDS 
  TTS_ULP_EQUAL(eve::cephes_(eve::cos)(eve::Inf<Type>()), eve::Nan<Type>(), 0.5);
  TTS_ULP_EQUAL(eve::cephes_(eve::cos)(eve::Minf<Type>()), eve::Nan<Type>(), 0.5);
  TTS_ULP_EQUAL(eve::cephes_(eve::cos)(eve::Nan<Type>()), eve::Nan<Type>(), 0.5);
#endif
  TTS_ULP_EQUAL(eve::cephes_(eve::cos)(2*eve::Pi<Type>()), eve::One<Type>(), 0.5);
  TTS_ULP_EQUAL(eve::cephes_(eve::cos)(-2*eve::Pi<Type>()), eve::One<Type>(), 0.5);
  ...
  TTS_ULP_EQUAL(eve::cephes_(eve::cos)(eve::Pi<Type>()), eve::Mone<Type>(), 0.5);
  TTS_ULP_EQUAL(eve::cephes_(eve::cos)(-eve::Pi<Type>()), eve::Mone<Type>(), 0.5);   
  TTS_ULP_EQUAL(eve::cephes_(eve::cos)(eve::Pio_2<Type>()), eve::Zero<Type>(), 0.5);
  TTS_ULP_EQUAL(eve::cephes_(eve::cos)(eve::Pio_4<Type>()), eve::Sqrt_2o_2<Type>(), 0.5);
