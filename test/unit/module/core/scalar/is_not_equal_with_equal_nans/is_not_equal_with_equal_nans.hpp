...
TTS_CASE("Check eve::numeric_(eve::is_not_equal) return type")
{
  ...
  TTS_EXPR_IS(eve::numeric_(eve::is_not_equal)(logical<Type>(), logical<Type>()),
              eve::as_logical_t<Type>);
  TTS_EXPR_IS(eve::numeric_(eve::is_not_equal)(Type(), logical<Type>()), eve::as_logical_t<Type>);
}

TTS_CASE("Check eve::numeric_(eve::is_not_equal)_with_equal_nans behavior")
{
  using eve::logical;
  ...
  TTS_EQUAL(eve::numeric_(eve::is_not_equal)(eve::Nan<Type>(), eve::Nan<Type>()),
            eve::False<Type>());
  TTS_EQUAL(eve::numeric_(eve::is_not_equal)(eve::Nan<Type>(), Type(4)), eve::True<Type>());
  TTS_EQUAL(eve::numeric_(eve::is_not_equal)(Type(7), eve::Nan<Type>()), eve::True<Type>());
  ...
  TTS_EQUAL(eve::numeric_(eve::is_not_equal)(eve::True<Type>(), eve::True<Type>()),
            eve::False<Type>());
  TTS_EQUAL(eve::numeric_(eve::is_not_equal)(eve::True<Type>(), eve::False<Type>()),
            eve::True<Type>());
