...
{
  TTS_EXPR_IS(eve::logical_andnot(Type(), Type()) ,  eve::as_logical_t<Type>);
  using l_t = eve::as_logical_t<Type>; 
  TTS_EXPR_IS(eve::logical_andnot(l_t(), l_t()) ,  eve::as_logical_t<Type>);   
}


TTS_CASE("Check eve::logical_andnot behavior")
{
