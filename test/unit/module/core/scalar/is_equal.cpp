...
TTS_CASE("Check is_equal return type")
{
  TTS_EXPR_IS(eve::is_equal(0.f, 0.f),  eve::logical<float>);
  TTS_EXPR_IS(eve::is_equal(0., 0.),  eve::logical< double>);

  TTS_EXPR_IS(eve::is_equal(std::int8_t(), std::int8_t()),     eve::logical< std::int8_t>);
  TTS_EXPR_IS(eve::is_equal(std::int16_t(), std::int16_t()),   eve::logical< std::int16_t>);
  TTS_EXPR_IS(eve::is_equal(std::int32_t(), std::int32_t()),   eve::logical< std::int32_t>);
  TTS_EXPR_IS(eve::is_equal(std::int64_t(), std::int64_t()),   eve::logical< std::int64_t>);

  TTS_EXPR_IS(eve::is_equal(std::uint8_t(), std::uint8_t()),   eve::logical< std::uint8_t>);
  TTS_EXPR_IS(eve::is_equal(std::uint16_t(), std::uint16_t()), eve::logical< std::uint16_t>);
  TTS_EXPR_IS(eve::is_equal(std::uint32_t(), std::uint32_t()), eve::logical< std::uint32_t>);
  TTS_EXPR_IS(eve::is_equal(std::uint64_t(), std::uint64_t()), eve::logical< std::uint64_t>);
}
...
TTS_CASE("Check is_equal behavior")
{
  ...
  TTS_EQUAL(eve::is_equal(std::uint32_t(1), std::uint32_t(1)), true);
  ...
  TTS_EQUAL(eve::is_equal(std::int32_t(1), std::int32_t(1)), true);
