...
TTS_CASE("Check eve::atanpi behavior")
{
...
#endif
  TTS_ULP_EQUAL(eve::atanpi(eve::Half<Type>()), Type(0.147583617650433), 5);
  TTS_ULP_EQUAL(eve::atanpi(eve::Mhalf<Type>()), Type(-0.147583617650433), 5);
  TTS_ULP_EQUAL(eve::atanpi(eve::Mone<Type>()), Type(-0.25), 0.5);
  TTS_ULP_EQUAL(eve::atanpi(eve::One<Type>()), Type(0.25), 0.5);
  TTS_ULP_EQUAL(eve::atanpi(eve::Zero<Type>()),Type(0), 0); 
}
