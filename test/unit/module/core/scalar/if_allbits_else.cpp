...
TTS_CASE( "Check if_else_allbitsrn type" )
{
  auto z = eve::allbits_; 
...
TTS_CASE( "Check if_else_allbitsvior" )
{
  auto z = eve::allbits_; 
  ...
  TTS_EQUAL ( eve::if_else( 1, z, 2), eve::Allbits<int>()); 
  TTS_EQUAL ( eve::if_else( 1.0, z, 2),  eve::Allbits<int>()); 
  TTS_EQUAL ( eve::if_else( true, z, 2),  eve::Allbits<int>()); 
  TTS_EQUAL ( eve::if_else( eve::True<eve::logical<float>>(), z, 2), eve::Allbits<int>());
}
