...
TTS_CASE("Check bitwise_cast return type")
{
  ...
  TTS_EXPR_IS(eve::bitwise_cast(float(), eve::as_<it_t>() ), it_t);
  TTS_EXPR_IS(eve::bitwise_cast(float(), eve::as_<ut_t>() ), ut_t);
  TTS_EXPR_IS(eve::bitwise_cast(float(), eve::as_<float>()), float);
}
