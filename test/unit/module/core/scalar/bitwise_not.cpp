...
{
  TTS_EQUAL(eve::bitwise_not(std::uint8_t(0b01000011)), std::uint8_t(0b10111100));

  TTS_EQUAL(eve::bitwise_not(std::uint16_t(0b1100001101000011)), std::uint16_t(0b0011110010111100));
