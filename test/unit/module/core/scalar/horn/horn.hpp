...
TTS_CASE("Check eve::horn behavior")
{
  ...
  {
    TTS_EQUAL((horn<Type, 0x3FF0000000000000, 0x00000000, 0x3FF0000000000000>(Type(1))), Type(2));
    TTS_EQUAL((horn<Type, 0x4000000000000000, 0x00000000, 0x3FF0000000000000>(Type(2))), Type(6));  
  }
