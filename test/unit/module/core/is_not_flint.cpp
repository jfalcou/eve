...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(eve::is_not_flint[eve::pedantic](T()), logical<T>);
  TTS_EXPR_IS(eve::is_not_flint[eve::pedantic](v_t()), logical<v_t>);
};

//==================================================================================================
// Tests for eve::is_not_flint
//==================================================================================================
constexpr auto mf2 = tts::constant([](auto const& tgt) { return eve::maxflint(tgt) * 4; });
