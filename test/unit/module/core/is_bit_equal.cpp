...
//== Types tests
//==================================================================================================
TTS_CASE_TPL("Check return types of eve::is_bit_equal(simd)", eve::test::simd::all_types_wf16)
...
TTS_CASE_WITH(
    ...
    tts::ramp(0), tts::reverse_ramp(4, 2), tts::logicals(0, 3), tts::logicals(1, 2))
...
//==================================================================================================
TTS_CASE_TPL("Check behavior of eve::is_bit_equal(simd)", eve::test::simd::ieee_reals_wf16)
