...
<typename T>(T const& a0)
{
  ...
  if constexpr( eve::floating_value<T> )
  {
    if constexpr( eve::platform::supports_invalids )
    {
      ...
      TTS_ULP_EQUAL(eve::epsilon[eve::lower](eve::minf(eve::as<T>())), eve::inf(eve::as<T>()), 0);
      TTS_ULP_EQUAL(eve::epsilon[eve::lower](eve::inf(eve::as<T>())), eve::inf(eve::as<T>()), 0);
      TTS_ULP_EQUAL(eve::epsilon[eve::lower](eve::nan(eve::as<T>())), eve::nan(eve::as<T>()), 0);
    }
    ...
    TTS_ULP_EQUAL(eve::epsilon(a0),
                  ...
                  2);
    TTS_ULP_EQUAL(eve::epsilon[eve::lower](T(1)), eve::eps(as<T>())/2, 0.5);
    TTS_ULP_EQUAL(eve::epsilon[eve::lower](T(0)), eve::mindenormal(as<T>()), 0.5);
    TTS_ULP_EQUAL(eve::epsilon[eve::lower](T(10)), 8 * eve::eps(as<T>()), 0.5);
    TTS_ULP_EQUAL(eve::epsilon[eve::lower](T(5)), 4 * eve::eps(as<T>()), 0.5);
    TTS_ULP_EQUAL(eve::epsilon[eve::lower](T(2)), eve::eps(as<T>()), 0.5);
    TTS_ULP_EQUAL(eve::epsilon[eve::lower](T(1.5)), eve::eps(as<T>()), 0.5);
  }
  else
  {
