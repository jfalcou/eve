...
TTS_CASE_TPL("Check eve::big_(eve::secd) behavior", EVE_TYPE)
{
  ...
  TTS_ULP_EQUAL(eve::big_(eve::secd)( T(  1)  ) , T(ref_secd(1.0))        , 3);
  TTS_ULP_EQUAL(eve::big_(eve::secd)(-T(  1)  ) , T(ref_secd(-1.0))       , 3);
  TTS_ULP_EQUAL(eve::big_(eve::secd)( T( 45.0)) , T(ref_secd(v_t(45.0)))  , 3);
  TTS_ULP_EQUAL(eve::big_(eve::secd)(-T( 45.0)) , T(ref_secd(-v_t(45.0))) , 3);
  TTS_ULP_EQUAL(eve::big_(eve::secd)( T(500.0)) , T(ref_secd(500.0))      , 3);
  TTS_ULP_EQUAL(eve::big_(eve::secd)(-T(500.0)) , T(ref_secd(-500.0))     , 3);
}
