...
{
  TTS_EXPR_IS(eve::restricted_(eve::sin)(T(0)), T);
}
...
TTS_CASE_TPL("Check eve::eve::restricted_(eve::sin) behavior", EVE_TYPE)
{
  ...
  TTS_ULP_EQUAL((eve::restricted_(eve::sin)(eve::Pio_4<T>())), (T(std::sin(eve::Pio_4<v_t>()))), 0.5);
  TTS_ULP_EQUAL((eve::restricted_(eve::sin)(-eve::Pio_4<T>())),(T(std::sin(-eve::Pio_4<v_t>()))), 0.5);
  TTS_ULP_EQUAL((eve::restricted_(eve::sin)(eve::Pio_4<T>()/2)), (T(std::sin(eve::Pio_4<v_t>()/2))), 0.5);
  TTS_ULP_EQUAL((eve::restricted_(eve::sin)(-eve::Pio_4<T>()/2)),(T(std::sin(-eve::Pio_4<v_t>()/2))), 0.5);
}
