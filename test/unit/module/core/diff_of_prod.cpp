  ...
  <typename T>(T const& a0, T const& a1, T const& a2, T const& a3)
{
  ...
  TTS_EXPECT(eve::all((diff_of_prod[upper](a0, a1, a2, a3) >= ref) ||  eve::is_not_finite(ref)));
  TTS_EXPECT(eve::all((diff_of_prod[lower](a0, a1, a2, a3) <= ref) ||  eve::is_not_finite(ref)));
  TTS_EXPECT(eve::all((diff_of_prod[upper][strict](a0, a1, a2, a3) > ref) ||  eve::is_not_finite(ref)));
  TTS_EXPECT(eve::all((diff_of_prod[lower][strict](a0, a1, a2, a3) < ref) ||  eve::is_not_finite(ref)));
};
