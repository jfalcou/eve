...
{
  TTS_EXPR_IS(eve::negatenz(Type(), Type()), (Type));
}
...
TTS_CASE(" negatenz behaviour")
{
  if constexpr(std::is_floating_point_v<Value>)
  {
    ...
    {
      TTS_EQUAL(eve::negatenz(eve::Inf<Type>(), eve::Inf<Type>()), eve::Inf<Type>());
  ...
  else if constexpr(std::is_signed_v<Value>)
  {
    ...
    TTS_EQUAL(eve::negatenz(eve::Mone<Type>(), eve::One<Type>()), eve::Mone<Type>());
  }
