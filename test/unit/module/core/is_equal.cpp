...
<typename T>(tts::type<T>)
{
  ...
  if constexpr( eve::floating_value<T> )
  {
    ...
    TTS_EXPR_IS(eve::is_equal[eve::tolerant](T(), T()), logical<T>);
    TTS_EXPR_IS(eve::is_equal[eve::tolerant](v_t(), v_t()), logical<v_t>);
    TTS_EXPR_IS(eve::is_equal[eve::tolerant](T(), v_t()), logical<T>);
    TTS_EXPR_IS(eve::is_equal[eve::tolerant](v_t(), T()), logical<T>);
  }
};
...
<typename T, typename M>(T const& a0, T const& a1, M const& l0, M const& )
{
...
<typename T>(tts::type<T> const& tgt)
{
  ...
  TTS_EQUAL(eve::is_equal[eve::tolerance =  eve::eps(as<T>())](T(1 + eve::eps(as<T>())), T(1)), eve::true_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance =  eve::eps(as<T>())](T(1 + 2 * eve::eps(as<T>())), T(1)), eve::false_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance =  eve::eps(as<T>())](T(1 + eve::eps(as<T>())), v_t(1)), eve::true_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance =  eve::eps(as<T>())](T(3), T(1)), eve::false_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance =  eve::eps(as<T>())](T(3), v_t(1)), eve::false_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance = ui_t(3)](T(1), T(1)), eve::true_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance = ui_t(3)](T(1), v_t(1)), eve::true_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance = ui_t(3)](T(3), T(1)), eve::false_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance = ui_t(3)](T(3), v_t(1)), eve::false_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance = ui_t(3)](eve::next(T(0)), T(0)), eve::true_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance = ui_t(3)](eve::next(T(0), 3), T(0)), eve::true_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance = ui_t(3)](eve::next(T(0), 4), T(0)), eve::false_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance = ui_t(3)](v_t(1), v_t(1)), eve::true_(eve::as<v_t>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance = ui_t(3)](v_t(3), T(1)), eve::false_(eve::as<T>()));
  TTS_EQUAL(eve::is_equal[eve::tolerance = ui_t(3)](v_t(3), v_t(1)), eve::false_(eve::as<v_t>()));
};
