...
TTS_CASE("Check eve::acospi return type") { TTS_EXPR_IS(eve::acospi(EVE_TYPE(0)), (EVE_TYPE)); }
...
TTS_CASE("Check eve::acospi behavior")
{
  ...
  TTS_ULP_EQUAL(eve::acospi(EVE_TYPE(8.414715528e-01)),
                EVE_TYPE(radinpi(std::acos(EVE_VALUE(8.414715528e-01)))),
                1);
  TTS_ULP_EQUAL(eve::acospi(EVE_TYPE(9.689134359e-01)),
                EVE_TYPE(radinpi(std::acos(EVE_VALUE(9.689134359e-01)))),
                1);
  TTS_ULP_EQUAL(eve::acospi(EVE_TYPE(9.922192097e-01)),
                EVE_TYPE(radinpi(std::acos(EVE_VALUE(9.922192097e-01)))),
                1);
  TTS_ULP_EQUAL(eve::acospi(EVE_TYPE(9.995127916e-01)),
                EVE_TYPE(radinpi(std::acos(EVE_VALUE(9.995127916e-01)))),
                1);
  TTS_ULP_EQUAL(eve::acospi(EVE_TYPE(9.998779893e-01)),
                EVE_TYPE(radinpi(std::acos(EVE_VALUE(9.998779893e-01)))),
                1);
  TTS_ULP_EQUAL(eve::acospi(EVE_TYPE(9.999695420e-01)),
                EVE_TYPE(radinpi(std::acos(EVE_VALUE(9.999695420e-01)))),
                1);
  TTS_ULP_EQUAL(eve::acospi(EVE_TYPE(9.999927878e-01)),
                EVE_TYPE(radinpi(std::acos(EVE_VALUE(9.999927878e-01)))),
                1);
  TTS_ULP_EQUAL(eve::acospi(EVE_TYPE(9.999984503e-01)),
                EVE_TYPE(radinpi(std::acos(EVE_VALUE(9.999984503e-01)))),
                1);
  TTS_ULP_EQUAL(eve::acospi(EVE_TYPE(9.999996424e-01)),
                EVE_TYPE(radinpi(std::acos(EVE_VALUE(9.999996424e-01)))),
                1);
  TTS_ULP_EQUAL(eve::acospi(EVE_TYPE(9.999999404e-01)),
