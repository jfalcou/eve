...
TTS_CASE_TPL("Check eve::if_else(., ., one_) behavior ", EVE_TYPE)
{
  ...
  TTS_IEEE_EQUAL(eve::if_else(eve::True<T>() , t, eve::one_), t);
  ...
  TTS_IEEE_EQUAL(eve::if_else(eve::False<T>(), t, eve::one_), f);
  ...
  TTS_IEEE_EQUAL(eve::if_else(eve::True<T>() , eve::one_, t), f);
  ...
  TTS_IEEE_EQUAL(eve::if_else(eve::False<T>(), eve::one_, t), t);
}
