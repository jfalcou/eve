...
TTS_CASE_TPL("Check eve::big_(eve::tand) behavior", EVE_TYPE)
{
  ...
  TTS_ULP_EQUAL(eve::big_(eve::tand)( T(  1)) , T(ref_tand(1.0))        , 3 );
  TTS_ULP_EQUAL(eve::big_(eve::tand)(-T(  1)) , T(ref_tand(-1.0))       , 3 );
  TTS_ULP_EQUAL(eve::big_(eve::tand)( T( 45)) , T(ref_tand(v_t(45.0)))  , 3 );
  TTS_ULP_EQUAL(eve::big_(eve::tand)(-T( 45)) , T(ref_tand(-v_t(45.0))) , 3 );
  TTS_ULP_EQUAL(eve::big_(eve::tand)( T(500)) , T(ref_tand(500.0))      , 6 );
  TTS_ULP_EQUAL(eve::big_(eve::tand)(-T(500)) , T(ref_tand(-500.0))     , 6 );
}
