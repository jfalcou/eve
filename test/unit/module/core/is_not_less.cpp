...
//== Types tests
//==================================================================================================
TTS_CASE_TPL("Check return types of eve::is_not_less(simd)", eve::test::simd::all_types_wf16)
...
//==================================================================================================
TTS_CASE_TPL("Check behavior of eve::is_not_less(simd)", eve::test::simd::ieee_reals_wf16)
<typename T>(tts::type<T>)
{
  using eve::as;
  using eve::logical;
