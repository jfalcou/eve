...
TTS_CASE_TPL("Check eve::numeric_(eve::fms) return type", EVE_TYPE)
{
  using v_t = eve::element_type_t<T>;

  TTS_EXPR_IS(eve::numeric_(eve::fms)(T()   , T()   , T()   ) , T);
  TTS_EXPR_IS(eve::numeric_(eve::fms)(T()   , T()   , v_t() ) , T);
  TTS_EXPR_IS(eve::numeric_(eve::fms)(T()   , v_t() , T()   ) , T);
  TTS_EXPR_IS(eve::numeric_(eve::fms)(T()   , v_t() , v_t() ) , T);
  TTS_EXPR_IS(eve::numeric_(eve::fms)(v_t() , T()   , T()   ) , T);
  TTS_EXPR_IS(eve::numeric_(eve::fms)(v_t() , T()   , v_t() ) , T);
  TTS_EXPR_IS(eve::numeric_(eve::fms)(v_t() , v_t() , T()   ) , T);
}
