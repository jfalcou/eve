...
// Types tests
//==================================================================================================
TTS_CASE_TPL( "Check return types of bit_notor"
...
<typename T>( T const& a0, T const& a1, T const& a2,  T const& a3)
{
  ...
  TTS_EQUAL( bit_notor[test](a0, a1, a2),  eve::if_else(test, eve::bit_notor(a0, eve::bit_or(a1, a2)), a0));
};
...
<typename T>( T const& a0, T const& a1, T const& a2,  T const& a3)
{
  ...
  TTS_IEEE_EQUAL( bit_notor[test](a0, a1, a2),  eve::if_else(test, eve::bit_notor(a0, eve::bit_or(a1, a2)), a0));
};
