...
TTS_CASE_TPL("Check eve::numeric_(eve::is_not_equal) return type", EVE_TYPE)
{
  ...
  TTS_EXPR_IS(eve::numeric_(eve::is_not_equal)(T()          , T()          ), (logical<T>));
  TTS_EXPR_IS(eve::numeric_(eve::is_not_equal)(T()          , v_t()         ), (logical<T>));
  TTS_EXPR_IS(eve::numeric_(eve::is_not_equal)(v_t()         , T()          ), (logical<T>));
  TTS_EXPR_IS(eve::numeric_(eve::is_not_equal)(logical<T>() , logical<T>() ), (logical<T>));
  TTS_EXPR_IS(eve::numeric_(eve::is_not_equal)(logical<T>() , logical<v_t>()), (logical<T>));
  TTS_EXPR_IS(eve::numeric_(eve::is_not_equal)(logical<v_t>(), logical<T>() ), (logical<T>));
}
