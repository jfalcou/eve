...
TTS_CASE("Check pedantic_(eve::acos) behavior")
{
  using eve::pedantic_;
  using eve::all;
  ...
  {
    TTS_ULP_EQUAL(pedantic_(eve::acos)(eve::Nan<Type>()) , eve::Nan<Type>(), 0.5 );
    TTS_ULP_EQUAL(pedantic_(eve::acos)(Type(2))          , eve::Nan<Type>(), 0   );
    TTS_ULP_EQUAL(pedantic_(eve::acos)(Type(-2))         , eve::Nan<Type>(), 0   );
  }

  TTS_ULP_EQUAL(pedantic_(eve::acos)(Type( 0.5)) , eve::Pi<Type>()/3   , 0.5 );
  TTS_ULP_EQUAL(pedantic_(eve::acos)(Type(-0.5)) , 2*eve::Pi<Type>()/3 , 0.5 );
  TTS_ULP_EQUAL(pedantic_(eve::acos)(Type(-1. )) , eve::Pi<Type>()     , 0   );
  TTS_ULP_EQUAL(pedantic_(eve::acos)(Type( 1. )) , Type(0)             , 0   );
  TTS_ULP_EQUAL(pedantic_(eve::acos)(Type( 0. )) , eve::Pio_2<Type>()  , 0   );
