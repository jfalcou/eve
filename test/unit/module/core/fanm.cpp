...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_IEEE_EQUAL(fanm[eve::pedantic2](-eve::one(eve::as<T>()), a0, a1),
...
//   auto r1 = fanm[eve::promote](a0, a1, fa);
...
//   auto r2 = fanm[eve::promote](a0, da, a1);
...
//   auto r3 = fanm[eve::promote](ia, a0, a1);
...
//   auto r4 = fanm[eve::promote](ia, da, a1);
...
<typename T>(T const& a0, T const& a1, T const& a2)
{
  ...
  TTS_IEEE_EQUAL(fanm[eve::pedantic2](a0, a1, a2), fnma[eve::pedantic2](a1, a2, a0));
};
