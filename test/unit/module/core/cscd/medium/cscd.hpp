...
TTS_CASE_TPL("Check eve::medium_(eve::cscd) behavior", EVE_TYPE)
{
  ...
  TTS_ULP_EQUAL(eve::medium_(eve::cscd)( T(1)  ) , T(ref_cscd(1.0))        , 3);
  TTS_ULP_EQUAL(eve::medium_(eve::cscd)(-T(1)  ) , T(ref_cscd(-1.0))       , 3);
  TTS_ULP_EQUAL(eve::medium_(eve::cscd)( T(45) ) , T(ref_cscd(v_t(45.0)))  , 3);
  TTS_ULP_EQUAL(eve::medium_(eve::cscd)(-T(45) ) , T(ref_cscd(-v_t(45.0))) , 3);
  TTS_ULP_EQUAL(eve::medium_(eve::cscd)( T(500)) , T(ref_cscd(500.0))      , 3);
  TTS_ULP_EQUAL(eve::medium_(eve::cscd)(-T(500)) , T(ref_cscd(-500.0))     , 3);
}
