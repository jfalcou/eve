...
TTS_CASE("Check is_not_finite return type") { TTS_EXPR_IS(eve::is_not_finite(Type(0)), eve::as_logical_t<Type>); }
...
TTS_CASE("Check eve::is_not_finite behavior")
{
  ...
  if constexpr(std::is_floating_point_v<Type> && eve::platform::supports_nans)
  {
