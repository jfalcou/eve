...
//== Types tests
//==================================================================================================
TTS_CASE_TPL( "Check return types of eve::is_not_greater(simd)"
...
<typename T, typename M>(T const& a0, T const& a1, M const & t)
{
  ...
  TTS_EQUAL(eve::is_not_greater(a0, a1), map([](auto e, auto f) -> eve::logical<v_t> { return e <= f; }, a0, a1));
  TTS_EQUAL(eve::is_not_greater(a0, a0), map([](auto e, auto f) -> eve::logical<v_t> { return e <= f; }, a0, a0));
  TTS_EQUAL(eve::is_not_greater(a0, v_t(1)), map([](auto e) -> eve::logical<v_t> { return e <= v_t(1); }, a0));
  TTS_EQUAL(eve::is_not_greater[t](a0, a1), eve::if_else(t, eve::is_not_greater(a0, a1), eve::false_(eve::as(a0))));
};
