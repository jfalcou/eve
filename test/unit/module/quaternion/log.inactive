  ...
  <typename T>(T const& a0, T const& a1 )
{
  ...
  for(auto e : a0)
  {
    TTS_ULP_EQUAL(eve::domain::complex(eve::log)(e), eve::log(eve::complex<e_t>(e, e_t(0))), 0.5);
    TTS_ULP_EQUAL(eve::domain::complex(eve::log)(e), eve::domain::complex(eve::log)(eve::complex<e_t>(e, e_t(0))), 0.5);
    for(auto f : a1)
    {
