...
TTS_CASE_WITH("Check behavior of beta on wide",
              ...
              tts::randoms(0.0, 10.0), tts::randoms(0.0, 10.0))
<typename T>([[maybe_unused]] T const& a0, [[maybe_unused]] T const& a1)
{
  ...
  TTS_ULP_EQUAL(beta(T(2.0), T(3.0)), T(std::beta(elt_t(2.0), elt_t(3.0))), 1.5);
  TTS_ULP_EQUAL(beta(T(2.5), T(3.7)), T(std::beta(elt_t(2.5), elt_t(3.7))), 1.5);
...
//==================================================================================================
TTS_CASE_WITH("Check behavior of eve::beta[cx](eve::wide)",
              eve::test::simd::ieee_reals,
