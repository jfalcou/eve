...
TTS_CASE_TPL("Check eve::is_less_equal return type", EVE_TYPE)
{
  using v_t = eve::element_type_t<T>;

  TTS_EXPR_IS(eve::is_less_equal(  T() ,   T()), eve::logical<T>);
  TTS_EXPR_IS(eve::is_less_equal(  T() , v_t()), eve::logical<T>);
  TTS_EXPR_IS(eve::is_less_equal(v_t() ,   T()), eve::logical<T>);
}
