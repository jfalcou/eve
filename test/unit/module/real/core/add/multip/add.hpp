...
TTS_CASE_TPL("Check eve::add return type", EVE_TYPE)
{
  ...
  TTS_EXPR_IS(eve::add(T(), T(), T(), T()), T);
  TTS_EXPR_IS(eve::add(v_t(), T(), T(), T()), T);
  TTS_EXPR_IS(eve::add(T(), v_t(), T()), T);
  TTS_EXPR_IS(eve::add(T(), T(), v_t(), v_t() ), T);
  TTS_EXPR_IS(eve::add(T(), T(), v_t(), v_t(), T()), T);
  TTS_EXPR_IS(eve::add(v_t(), T(), T(), v_t(), v_t(), T()), T);
}
...
TTS_CASE_TPL("Check eve::add behavior", EVE_TYPE)
{
  ...
  TTS_EQUAL(eve::add(T{1}, T{1}, T{1}), T(3));
  TTS_EQUAL(eve::add(T{2}, T{2}, T{4}), T(8));

  TTS_EQUAL(eve::add(v_t{0}, T{0}, T{0}), T(0));
  TTS_EQUAL(eve::add(v_t{1}, T{1}, T{4}), T(6));
  TTS_EQUAL(eve::add(v_t{2}, T{2}, T{1}), T(5));
