...
<typename aT>(aT const& )
{
  ...
  TTS_EQUAL(eve::definitely(eve::is_not_equal)(T(1+eve::eps(as<T>())), T(1), eve::eps(as<T>())), eve::false_(as<T>()) );
  TTS_EQUAL(eve::definitely(eve::is_not_equal)(T(1+2*eve::eps(as<T>())), T(1), eve::eps(as<T>())), eve::true_(as<T>()) );
  TTS_EQUAL(eve::definitely(eve::is_not_equal)(T(1+eve::eps(as<T>())), v_t(1), eve::eps(as<T>())), eve::false_(as<T>()) );
  TTS_EQUAL(eve::definitely(eve::is_not_equal)(T(3), T(1), eve::eps(as<T>())), eve::true_(as<T>()));
  TTS_EQUAL(eve::definitely(eve::is_not_equal)(T(3), v_t(1), eve::eps(as<T>())), eve::true_(as<T>()));
