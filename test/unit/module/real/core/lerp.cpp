...
<typename T>(  T const& a0, T const& a1, T const& a2)
{
  ...
  using eve::detail::map;
  using v_t = eve::element_type_t<T>;
  TTS_ULP_EQUAL(eve::raw(lerp) ((a0), (a1), (a2)), map([&](auto e , auto f, auto g) -> v_t { return std::lerp(e, f, g); }, a0, a1, a2), 4);
  TTS_ULP_EQUAL(lerp ((a0), (a1), (a2)), map([&](auto e , auto f, auto g) -> v_t { return std::lerp(e, f, g); }, a0, a1, a2), 4);
