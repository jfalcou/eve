...
**/
//==================================================================================================
#include <eve/function/fuzzy/is_greater.hpp>
...
TTS_CASE_TPL("Check eve::definitely(eve::is_greater) return type", EVE_TYPE)
{
  ...
  if constexpr(eve::floating_value<T>)
  {
    ...
    TTS_EXPR_IS( eve::definitely(eve::is_greater)(  T()         ,   T(), unsigned()  ) , logical<T>);
    TTS_EXPR_IS( eve::definitely(eve::is_greater)(  T()         , v_t(), unsigned()  ) , logical<T>);
    TTS_EXPR_IS( eve::definitely(eve::is_greater)(v_t()         ,   T(), unsigned()  ) , logical<T>);
    TTS_EXPR_IS( eve::definitely(eve::is_greater)(  T()         ,   T(), T()    ) , logical<T>);
    TTS_EXPR_IS( eve::definitely(eve::is_greater)(  T()         , v_t(), T()    ) , logical<T>);
    TTS_EXPR_IS( eve::definitely(eve::is_greater)(v_t()         ,   T(), T()    ) , logical<T>);
    using ui_t = eve::as_integer_t<T, unsigned>;
    TTS_EXPR_IS( eve::definitely(eve::is_greater)(  T()         ,   T(), ui_t() ) , logical<T>);
    TTS_EXPR_IS( eve::definitely(eve::is_greater)(  T()         , v_t(), ui_t() ) , logical<T>);
    TTS_EXPR_IS( eve::definitely(eve::is_greater)(v_t()         ,   T(), ui_t() ) , logical<T>);
  }
  else
  {
...
TTS_CASE_TPL("Check eve::definitely(eve::is_greater) behavior", EVE_TYPE)
{
  using v_t = eve::element_type_t<T>;
  using eve::logical;
