  ...
  <typename T>(T, T )
{
  ...
  if constexpr( eve::platform::supports_invalids )
  {
    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(0.5), eve::minf(eve::as<v_t>())), eve::nan(eve::as<v_t>()), 0);
    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(2.5), eve::inf(eve::as<v_t>())), v_t(0), 0);
    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(3.5), eve::nan(eve::as<v_t>())), eve::nan(eve::as<v_t>()), 0);
  }
  //scalar large x
//   TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(3.5), v_t(1500)), std__cyl_bessel_yn(v_t(3.5), v_t(1500)), 2.0);
//   TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(2.5), v_t( 500)),  std__cyl_bessel_yn(v_t(2.5), v_t( 500)), 2.0);
  //scalar forward
//   TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(2.5), v_t(10)), std__cyl_bessel_yn(v_t(2.5), v_t(10))  , 5.0);
//   TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(3.5), v_t(5)),  std__cyl_bessel_yn(v_t(3.5), v_t(5))   , 2.0);
  //scalar serie
  TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(2.5), v_t(0.1)), std__cyl_bessel_yn(v_t(2.5), v_t(0.1))  , 2.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(3.5), v_t(0.2)),  std__cyl_bessel_yn(v_t(3.5), v_t(0.2))   , 2.0);
  //scalar besseljy
  TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(10.5), v_t(8)), std__cyl_bessel_yn(v_t(10.5), v_t(8))  , 2.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(10.5), v_t(8)),  std__cyl_bessel_yn(v_t(10.5), v_t(8))   , 2.0);

//  if constexpr( eve::platform::supports_invalids )
//   {
//     TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(0.5), eve::minf(eve::as<T>())), eve::nan(eve::as<T>()), 0);
//     TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(2.5), eve::inf(eve::as<T>())), T(0), 0);
//     TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(3.5), eve::nan(eve::as<T>())), eve::nan(eve::as<T>()), 0);
//   }
//   //scalar large x
//    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(3.5), T(1500)),  T(std__cyl_bessel_yn(v_t(3.5), v_t(1500))),  2.0);
//    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(2.5), T(500)),   T(std__cyl_bessel_yn(v_t(2.5), v_t(500))),   2.0);
//    // reflection to do
//    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(-3.5), T(1500)), eve::nan(eve::as<T>()), 2.0);
//    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(-2.5), T(500)),  eve::nan(eve::as<T>()),  2.0);
//   //scalar forward
//    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(2.5), T(10)),    T(std__cyl_bessel_yn(v_t(2.5), v_t(10)))   , 5.0);
//    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(3.5), T(5)),     T(std__cyl_bessel_yn(v_t(3.5), v_t(5)))    , 2.0);
//   //scalar serie
//    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(2.5), T(0.1)),   T(std__cyl_bessel_yn(v_t(2.5), v_t(0.1)))  , 2.0);
//    TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(3.5), T(0.2)),   T(std__cyl_bessel_yn(v_t(3.5), v_t(0.2)))  , 2.5);
//   //scalar besseljy
//     TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(10.5), T(8)),   T(std__cyl_bessel_yn(v_t(10.5), v_t(8)))   , 2.0);
//     TTS_ULP_EQUAL(eve__cyl_bessel_yn(v_t(10.5), T(8)),   T(std__cyl_bessel_yn(v_t(10.5), v_t(8)))   , 2.0);
...
//   TTS_ULP_EQUAL(eve__cyl_bessel_yn(T(-3.5), T(1500)), eve::nan(eve::as<T>()), 2.0);
//   TTS_ULP_EQUAL(eve__cyl_bessel_yn(T(-2.5), T(500)),  eve::nan(eve::as<T>()),  2.0);
//   // forward
//   TTS_ULP_EQUAL(eve__cyl_bessel_yn(T(2.5), T(10)),    T(std__cyl_bessel_yn(v_t(2.5), v_t(10)))   , 5.0);
//   TTS_ULP_EQUAL(eve__cyl_bessel_yn(T(3.5), T(5)),     T(std__cyl_bessel_yn(v_t(3.5), v_t(5)))    , 2.0);
//   // serie
