...
//   TTS_RELATIVE_EQUAL(eve__cyl_bessel_jn(n, a0),   map(std__cyl_bessel_jn, n, a0)   , 0.0015);
  ...
  TTS_RELATIVE_EQUAL(map(eve__cyl_bessel_jn, v_t(2), -a0),   map(std__cyl_bessel_jn, v_t(2), -a0)   , 0.0015);
};
...
//   auto nn = eve::trunc(n);
//   TTS_RELATIVE_EQUAL(eve__diff_bessel_jn(nn, a0),   map(std__diff_bessel_jn, nn, a0), 1.0e-3);
