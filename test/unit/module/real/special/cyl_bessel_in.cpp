...
//     TTS_ULP_EQUAL(eve__cyl_bessel_in(T(2), eve::inf(eve::as<T>())), eve::inf(eve::as<v_t>()), 0);
...
//   }
//   // large x
//   TTS_ULP_EQUAL(eve__cyl_bessel_in(T(3.5), T(1500)),  T(std__cyl_bessel_in(v_t(3.5), v_t(1500))),  5.0);
//   TTS_ULP_EQUAL(eve__cyl_bessel_in(T(2.5), T(500)),   T(std__cyl_bessel_in(v_t(2.5), v_t(500))),   5.0);
//   // forward
...
//   // serie
//   TTS_ULP_EQUAL(eve__cyl_bessel_in(T(2.5), T(0.1)),   T(std__cyl_bessel_in(v_t(2.5), v_t(0.1)))  , 5.0);
//   TTS_ULP_EQUAL(eve__cyl_bessel_in(T(3.5), T(0.2)),   T(std__cyl_bessel_in(v_t(3.5), v_t(0.2)))  , 2.5);
//   // besseljy
//   TTS_ULP_EQUAL(eve__cyl_bessel_in(T(10.5), T(8)),   T(std__cyl_bessel_in(v_t(10.5), v_t(8)))   , 5.0);
//   TTS_ULP_EQUAL(eve__cyl_bessel_in(T(10.5), T(8)),   T(std__cyl_bessel_in(v_t(10.5), v_t(8)))   , 5.0);
