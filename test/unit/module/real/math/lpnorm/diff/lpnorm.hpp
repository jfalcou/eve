...
TTS_CASE_TPL("Check eve::diff(eve::lpnorm) behavior", EVE_TYPE)
{
  ...
  if constexpr(eve::floating_value<T>)
  {
    ...
    TTS_ULP_EQUAL(eve::diff_1st(eve::lpnorm)(3, T{4},T{3}), T(7.908468475209518e-01), 2.5);
    TTS_ULP_EQUAL(eve::diff_2nd(eve::lpnorm)(3, T{4},T{3}), T(4.448513517305356e-01), 2.5);
    TTS_ULP_EQUAL(eve::diff_3rd(eve::lpnorm)(3, T{2},T{2},T{4}), T(8.617738760127537e-01), 2.5);
    TTS_ULP_EQUAL(eve::diff_nth<4>(eve::lpnorm)(3, T{1},T{2},T{3},T{4}), T(7.426542133780447e-01), 2.5);
    TTS_ULP_EQUAL(eve::pedantic(eve::diff_1st)(eve::lpnorm)(3, T{4},T{3}), T(7.908468475209518e-01), 2.5);
    TTS_ULP_EQUAL(eve::pedantic(eve::diff_2nd)(eve::lpnorm)(3, T{4},T{3}), T(4.448513517305356e-01), 2.5);
    TTS_ULP_EQUAL(eve::pedantic(eve::diff_3rd)(eve::lpnorm)(3, T{2},T{2},T{4}), T(8.617738760127537e-01), 2.5);
    TTS_ULP_EQUAL(eve::pedantic(eve::diff_nth<4>)(eve::lpnorm)(3, T{1},T{2},T{3},T{4}), T(7.426542133780447e-01), 2.5);
  }
}
