...
// TS_CASE_TPL("Check lpnorm return type", EVE_TYPE)
// {
...
//   TTS_ULP_EQUAL(eve::lpnorm(3,  T(-1), T(-1), eve::sqrt_2(eve::as<T>()) ) , T(3)                , 0.5);
//   TTS_ULP_EQUAL(eve::lpnorm(3,  T( 1), T( 1), eve::sqrt_2(eve::as<T>()) ) , T(3)                , 0.5);
...
TTS_CASE_TPL("Check lpnorm return type", EVE_TYPE)
{
  ...
  TTS_EXPR_IS(eve::lpnorm(3,     T(0),   T(0)), T);
  TTS_EXPR_IS(eve::lpnorm(3,   v_t(0),   T(0)), T);
  TTS_EXPR_IS(eve::lpnorm(3,     T(0), v_t(0)), T);

  TTS_EXPR_IS(eve::lpnorm(3,     T(0),   T(0),   T(0)), T);
  TTS_EXPR_IS(eve::lpnorm(3,     T(0),   T(0), v_t(0)), T);
  TTS_EXPR_IS(eve::lpnorm(3,     T(0), v_t(0),   T(0)), T);
  TTS_EXPR_IS(eve::lpnorm(3,     T(0), v_t(0), v_t(0)), T);
  TTS_EXPR_IS(eve::lpnorm(3,   v_t(0),   T(0),   T(0)), T);
  TTS_EXPR_IS(eve::lpnorm(3,   v_t(0),   T(0), v_t(0)), T);
  TTS_EXPR_IS(eve::lpnorm(3,   v_t(0), v_t(0),   T(0)), T);
}
...
TTS_CASE_TPL("Check eve::lpnorm behavior", EVE_TYPE)
{
  ...
  if constexpr(eve::platform::supports_invalids)
  {
    TTS_IEEE_EQUAL(eve::lpnorm(3,  eve::nan(eve::as<T>()), eve::inf(eve::as<T>())), eve::nan(eve::as<T>()));
    TTS_IEEE_EQUAL(eve::lpnorm(3,  eve::inf(eve::as<T>()), eve::nan(eve::as<T>())), eve::nan(eve::as<T>()));
  }

  TTS_IEEE_EQUAL(eve::lpnorm(3,  eve::valmax(eve::as<T>()) , T(0)            ) , eve::inf(eve::as<T>()));
  TTS_IEEE_EQUAL(eve::lpnorm(3,  T(0)             , eve::valmax(eve::as<T>())) , eve::inf(eve::as<T>()));

  TTS_ULP_EQUAL(eve::lpnorm(3,  T(-1), T(-1))                      , eve::sqrt_2(eve::as<T>()), 0.5);
  TTS_ULP_EQUAL(eve::lpnorm(3,  T( 1), T( 1))                      , eve::sqrt_2(eve::as<T>()), 0.5);
  TTS_ULP_EQUAL(eve::lpnorm(3,  T( 0), T( 0))                      , T(0)            , 0.5);
  TTS_ULP_EQUAL(eve::lpnorm(3,  eve::sqrt_2(eve::as<T>()), eve::sqrt_2(eve::as<T>())), T(3)            , 0.5);
}
...
TTS_CASE_TPL("Check 3 params eve::lpnorm behavior", EVE_TYPE)
{
  ...
  TTS_ULP_EQUAL(eve::lpnorm(3,  T( 1), T( 1), eve::sqrt_2(eve::as<T>()) ) , T(3)                , 0.5);
  TTS_ULP_EQUAL(eve::lpnorm(3,  T( 0), T( 0), T( 0)            ) , T(0)                , 0.5);
  TTS_ULP_EQUAL(eve::lpnorm(3,  T( 1), T( 1), T( 1)            ) , T(std::sqrt(v_t(3))), 0.5);
}
