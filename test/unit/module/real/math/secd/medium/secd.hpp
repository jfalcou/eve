...
TTS_CASE_TPL("Check eve::medium(eve::secd) return type", EVE_TYPE)
{
  TTS_EXPR_IS(eve::medium(eve::secd)(T()), T);
}

TTS_CASE_TPL("Check eve::medium(eve::secd) behavior", EVE_TYPE)
{
