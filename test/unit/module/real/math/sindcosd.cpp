...
auto mmed   = []<typename T>(eve::as<T> const & ){  return T(-500); };
auto med    = []<typename T>(eve::as<T> const & ){  return T( 500); };
...
<typename T>(T const& , T const& , T const& a2, T const& )
{
  using eve::detail::map;
  using eve::sindcosd;
  using eve::diff;
  using v_t = eve::element_type_t<T>;
//  auto refc = [](auto e) -> v_t { return eve::medium(eve::cosd)(e); };
  auto refs = [](auto e) -> v_t { return eve::medium(eve::sind)(e); };
//   {
