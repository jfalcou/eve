...
{
  auto gsl_lnr = [](auto n, auto x){
   gsl_sf_result res;
   double sgn;
   gsl_sf_lnpoch_sgn_e(x, n, &res, &sgn);
   return res.val;
  };
//   TTS_ULP_EQUAL(eve::lrising_factorial(T( 20),   T(2.0)) , T(gsl_lnr( 20.,  2.)), 20);
//   TTS_ULP_EQUAL(eve::lrising_factorial(10, T(0.1)) , T(gsl_sf_lnpoch(0.1, 10.0)), 20);
//   TTS_ULP_EQUAL(eve::lrising_factorial(5,  T(0.1)) , T(gsl_sf_lnpoch(0.1, 5.0)) , 20);
//   TTS_ULP_EQUAL(eve::lrising_factorial(0,  T(0.1)) , T(gsl_sf_lnpoch(0.1, 0.0)) , 20);
