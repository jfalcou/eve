...
<typename T, typename M>(T const& a0, T const& a1, T const& a2, M const& mask)
{
  ...
  TTS_EQUAL(der(eve::fsm[mask](vda0, a1, a2)), diff_1st(eve::fsm[mask])(a0, a1, a2));
  TTS_EQUAL(val(eve::fsm[mask](a0, vda1, a2)), eve::fsm[mask](a0, a1, a2));
  TTS_EQUAL(der(eve::fsm[mask](a0, vda1, a2)), diff_2nd(eve::fsm[mask])(a0, a1, a2));
  TTS_EQUAL(val(eve::fsm[mask](a0, a1, vda2)), eve::fsm[mask](a0, a1, a2));
  TTS_EQUAL(der(eve::fsm[mask](a0, a1, vda2)), diff_3rd(eve::fsm[mask])(a0, a1, a2));
};
