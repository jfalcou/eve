...
<typename T, typename M>(T const& a0, T const& a1, T const& a2, M const& mask)
{
  ...
  TTS_EQUAL(der(eve::fsnm[mask](vda0, a1, a2))  , eve::if_else(mask, diff_1st(eve::fsnm)(a0, a1, a2), eve::one));
  TTS_EQUAL(der(eve::fsnm[mask](a0, vda1, a2))  , eve::if_else(mask, diff_2nd(eve::fsnm)(a0, a1, a2), eve::zero));
  TTS_EQUAL(der(eve::fsnm[mask](a0, a1, vda2))  , eve::if_else(mask, diff_3rd(eve::fsnm)(a0, a1, a2), eve::zero));
};
