...
//     auto z2 = z;
//     auto p0z =  p0(z);
//     auto zz = eve::sparse_polyval(p0, z);
//     eve::inplace(eve::sparse_polyval)(p0, z1);
//     auto m2z = eve::sparse_polyval(m2, z);
//     eve::inplace(eve::sparse_polyval)(m2, z2);
//     for(int i=0; i < 10 ; ++i){
