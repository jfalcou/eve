...
//== Types tests
//==================================================================================================
TTS_CASE_TPL("Check return types of tchebeval on wide", eve::test::simd::ieee_reals
...
<typename T>(T const& a0)
{
  ...
  auto             bcl1 = [c1](auto x) -> v_t
  { return boost::math::chebyshev_clenshaw_recurrence(c1.data(), c1.size(), x); };
  auto bcl2 = [c2](auto x) -> v_t
  { return boost::math::chebyshev_clenshaw_recurrence(c2.data(), c2.size(), x); };
  auto bcl3 = [c3](auto x) -> v_t
  {
    return boost::math::detail::unchecked_chebyshev_clenshaw_recurrence(
        c3.data(), c3.size(), v_t(-1), v_t(1), v_t(x));
  };
