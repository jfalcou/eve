  ...
  <typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL(eve::coth(eve::inf(eve::as<doublereal_t>())), eve::one(eve::as<doublereal_t>()), 0.5);
  TTS_ULP_EQUAL(eve::coth(eve::minf(eve::as<doublereal_t>())), eve::mone(eve::as<doublereal_t>()), 0.5);
  TTS_ULP_EQUAL(eve::coth(eve::zero(eve::as<doublereal_t>())), eve::inf(eve::as<doublereal_t>()), 0.5);
  TTS_ULP_EQUAL(eve::coth(eve::mzero(eve::as<doublereal_t>())), eve::minf(eve::as<doublereal_t>()), 0.5);
  TTS_ULP_EQUAL(eve::coth(eve::nan(eve::as<doublereal_t>())), eve::nan(eve::as<doublereal_t>()), 0.5);
};
