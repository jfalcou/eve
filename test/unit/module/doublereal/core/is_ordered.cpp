...
TTS_CASE_WITH( "Check behavior of is_ordered on scalar"
     ...
     if constexpr(sizeof(e_t) == 4)
      {
        ...
        TTS_EQUAL ( eve::is_ordered(z1, z2), (eve::is_not_nan(z1) && eve::is_not_nan(z2)));
      }
    }
  }
};

TTS_CASE_WITH( "Check behavior of is_ordered on wide"
