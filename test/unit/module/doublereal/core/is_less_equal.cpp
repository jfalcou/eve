...
TTS_CASE_WITH( "Check behavior of is_less_equal on scalar"
  ...
  <typename T>(T const& a0, T const& a1 )
{
  ...
  for(auto e : a0)
  {
    for(auto f : a1)
    {
      ...
      TTS_EQUAL ( eve::is_less_equal(z1, z2), (z1 <= z2));
      TTS_EQUAL ( eve::is_less_equal(z1, e), z1 <= doublereal_t(e));
      TTS_EQUAL ( eve::is_less_equal(f, z1), doublereal_t(f) <= z1);
...
TTS_CASE_WITH( "Check behavior of is_less_equal on wide"
  ...
  <typename T>(T const& a0, T const& a1 )
{
  ...
  TTS_EQUAL ( eve::is_less_equal(z1, z2), (z1 <= z2));
  TTS_EQUAL ( eve::is_less_equal(z1, a1), (z1 <= make_doublereal(a1, eve::as(z1))));
  TTS_EQUAL ( eve::is_less_equal(z1, 1.0), z1 <= make_doublereal(1.0, eve::as(z1)));
