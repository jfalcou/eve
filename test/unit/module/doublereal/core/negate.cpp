...
TTS_CASE_WITH( "Check behavior of negate on scalar"
  ...
  <typename T>(T const& a0, T const& a1, T const & a2, T const & a3)
{
  ...
  auto amz = decltype(z1)(eve::detail::map(eve::negate, z1, z2));
  TTS_EQUAL ( eve::negate(z1, z2), amz);
};
