...
// Types tests
//==================================================================================================
TTS_CASE_TPL("Check return types of asind", eve::test::simd::ieee_reals_wf16)
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(
    eve::asind(a0), tts::map([](auto e) -> v_t { return static_cast<v_t>(eve::radindeg(std_asin(e))); }, a0), 2);
};
