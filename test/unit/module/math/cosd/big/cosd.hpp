...
TTS_CASE_TPL("Check eve::big_(eve::cosd) behavior",EVE_TYPE)
{
  ...
  {
    TTS_IEEE_EQUAL(eve::big_(eve::cosd)(eve::nan(eve::as<T>()))  , eve::nan(eve::as<T>()) );
    TTS_IEEE_EQUAL(eve::big_(eve::cosd)(eve::inf(eve::as<T>()))  , eve::nan(eve::as<T>()) );
    TTS_IEEE_EQUAL(eve::big_(eve::cosd)(eve::minf(eve::as<T>())) , eve::nan(eve::as<T>()) );
  }
