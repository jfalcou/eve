...
TTS_CASE_TPL("Check eve::restricted_(eve::cospi) behavior", EVE_TYPE)
{
  if constexpr(eve::floating_value<T> )
  {
    if constexpr( eve::platform::supports_invalids )
    {
      ...
      TTS_IEEE_EQUAL(eve::restricted_(eve::cospi)(eve::Inf<T>()) , eve::nan(eve::as<T>()) );
  ...
  {
    TTS_EQUAL(eve::restricted_(eve::cospi)(T( 1)) , T(-1));
    TTS_EQUAL(eve::restricted_(eve::cospi)(T(-1)) , T(-1));
    TTS_EQUAL(eve::restricted_(eve::cospi)(T( 2)) , T( 1));
    TTS_EQUAL(eve::restricted_(eve::cospi)(T(-2)) , T( 1));
  }
}
