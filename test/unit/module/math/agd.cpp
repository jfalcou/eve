...
// agd  tests
//==================================================================================================
constexpr auto maxi = ::tts::constant([]<typename T>(eve::as<T> const& tgt) { return eve::pio_2(tgt); });
constexpr auto mini = ::tts::constant([]<typename T>(eve::as<T> const& tgt) { return -eve::pio_2(tgt); });
