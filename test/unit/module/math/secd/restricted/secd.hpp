...
TTS_CASE_TPL("Check eve::restricted_(eve::secd) behavior", EVE_TYPE)
{
  ...
  {
    TTS_IEEE_EQUAL(eve::restricted_(eve::secd)(eve::nan(eve::as<T>()))  , eve::nan(eve::as<T>()) );
    TTS_IEEE_EQUAL(eve::restricted_(eve::secd)(eve::inf(eve::as<T>()))  , eve::nan(eve::as<T>()) );
    TTS_IEEE_EQUAL(eve::restricted_(eve::secd)(eve::minf(eve::as<T>())) , eve::nan(eve::as<T>()) );
  }

  TTS_IEEE_EQUAL(eve::restricted_(eve::secd)( T( 0) ) , T(1));
  TTS_IEEE_EQUAL(eve::restricted_(eve::secd)( T(-0.)) , T(1));
  TTS_IEEE_EQUAL(eve::restricted_(eve::secd)( T(90) ) , eve::nan(eve::as<T>()));
  TTS_IEEE_EQUAL(eve::restricted_(eve::secd)(-T(90) ) , eve::nan(eve::as<T>()));
