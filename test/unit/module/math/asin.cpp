...
// Types tests
//==================================================================================================
TTS_CASE_TPL("Check return types of asin", eve::test::simd::ieee_reals_wf16)
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(eve::asin(a0), tts::map([](auto e) -> v_t { return static_cast<v_t>(std_asin(e)); }, a0), 2);
};
