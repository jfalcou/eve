...
// Types tests
//==================================================================================================
TTS_CASE_TPL("Check return types of acotd", eve::test::simd::ieee_reals_wf16)
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(
    eve::acotd(a0), tts::map([](auto e) -> v_t { return static_cast<v_t>(eve::radindeg(std_atan(1/e))); }, a0), 2);
};
