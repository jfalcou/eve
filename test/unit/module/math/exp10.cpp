...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL(eve::exp10(a0), tts::map([l10](auto e) -> v_t { return std_exp(l10 * e); }, a0), 380) << "a0 " << a0 << '\n';

  TTS_ULP_EQUAL(eve::exp10[eve::pedantic](a0),
                tts::map([l10](auto e) -> v_t { return std_exp(l10 * e); }, a0),
                380);
  TTS_ULP_EQUAL(eve::exp10[eve::pedantic](a1),
                tts::map([l10](auto e) -> v_t { return std_exp(l10 * e); }, a1),
                2);
};
