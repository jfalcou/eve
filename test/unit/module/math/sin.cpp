...
<typename T>(T const& a0, T const& a1, T const& a2, T const& a3, T const& a4)
{
  ...
  TTS_ULP_EQUAL(sin[eve::half_circle2](a0), map(ref, a0), 2);
  TTS_ULP_EQUAL(sin[eve::half_circle2](a1), map(ref, a1), 2);
  TTS_ULP_EQUAL(sin[eve::full_circle2](a0), map(ref, a0), 2);
  TTS_ULP_EQUAL(sin[eve::full_circle2](a1), map(ref, a1), 2);
  TTS_ULP_EQUAL(sin[eve::full_circle2](a2), map(ref, a2), 2);
