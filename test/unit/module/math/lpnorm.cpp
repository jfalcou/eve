...
<typename T>(tts::type<T>)
{
  ...
  {
    TTS_IEEE_EQUAL(eve::pedantic(eve::lpnorm)(3, eve::nan(eve::as<T>()), eve::inf(eve::as<T>())),
                   eve::inf(eve::as<T>()));
    TTS_IEEE_EQUAL(eve::pedantic(eve::lpnorm)(3, eve::inf(eve::as<T>()), eve::nan(eve::as<T>())),
                   eve::inf(eve::as<T>()));
    TTS_IEEE_EQUAL(eve::pedantic(eve::lpnorm)(3, eve::nan(eve::as<v_t>()), eve::inf(eve::as<T>())),
                   eve::inf(eve::as<T>()));
    TTS_IEEE_EQUAL(eve::pedantic(eve::lpnorm)(3, eve::inf(eve::as<v_t>()), eve::nan(eve::as<T>())),
                   eve::inf(eve::as<T>()));
    TTS_IEEE_EQUAL(eve::pedantic(eve::lpnorm)(3, eve::nan(eve::as<T>()), eve::inf(eve::as<v_t>())),
                   eve::inf(eve::as<T>()));
    TTS_IEEE_EQUAL(eve::pedantic(eve::lpnorm)(3, eve::inf(eve::as<T>()), eve::nan(eve::as<v_t>())),
                   eve::inf(eve::as<T>()));
  }
  ...
  if constexpr( eve::platform::supports_invalids )
  {
    TTS_ULP_EQUAL(eve::pedantic(eve::lpnorm)(
