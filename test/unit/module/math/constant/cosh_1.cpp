...
//==================================================================================================
// simd Tests for masked cosh_1
//==================================================================================================
TTS_CASE_WITH("Check behavior of cosh_1[mask] on :wide)",
...
<typename T, typename M>(T const& a0, 
                         M const& mask)
{
  TTS_IEEE_EQUAL(eve::cosh_1[mask](eve::as(a0)), eve::if_else(mask, eve::cosh_1(eve::as(a0)), eve::zero));
};
