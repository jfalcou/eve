...
<typename T>(tts::type<T>)
{
  ...
  {
    TTS_EXPECT(eve::inv_2pi[eve::lower](eve::as<T>()) <= 0.5l/3.141592653589793238462643l);
    TTS_EXPECT(eve::inv_2pi[eve::upper](eve::as<T>()) >= 0.5l/3.141592653589793238462643l); 
  }
...
{
  using eve::as;
  TTS_EXPECT(eve::all(eve::test::is_near(eve::inv_2pi[eve::lower](as<T>()), eve::inv_2pi[eve::upper](as<T>()))));
};
