...
<typename T>(tts::type<T>)
{
  ...
  {
    TTS_EXPECT(eve::pi2o_16[eve::lower](eve::as<T>()) <= 3.141592653589793238462643l*3.141592653589793238462643l/16);
    TTS_EXPECT(eve::pi2o_16[eve::upper](eve::as<T>()) >= 3.141592653589793238462643l*3.141592653589793238462643l/16);
  }
...
{
  using eve::as;
  TTS_EXPECT(eve::all(eve::test::is_near(eve::pi2o_16[eve::lower](as<T>()), eve::pi2o_16[eve::upper](as<T>()))));
};
