...
<typename T>(tts::type<T>)
{
  ...
  {
    TTS_EXPECT(eve::zeta_2[eve::lower](eve::as<T>()) <= 3.141592653589793238462643l*3.141592653589793238462643l/6);
    TTS_EXPECT(eve::zeta_2[eve::upper](eve::as<T>()) >= 3.141592653589793238462643l*3.141592653589793238462643l/6); 
  }
...
{
  using eve::as;
  TTS_EXPECT(eve::all(eve::test::is_near(eve::zeta_2[eve::lower](as<T>()), eve::zeta_2[eve::upper](as<T>()))));
};
