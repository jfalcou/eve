...
<typename T>(tts::type<T>)
{
  ...
  {
    TTS_EXPECT(eve::pi3[eve::lower](eve::as<T>()) <= 3.141592653589793238462643l*3.141592653589793238462643l*3.141592653589793238462643l);
    TTS_EXPECT(eve::pi3[eve::upper](eve::as<T>()) >= 3.141592653589793238462643l*3.141592653589793238462643l*3.141592653589793238462643l);
  }
...
{
  using eve::as;
  TTS_EXPECT(eve::all(eve::test::is_near(eve::pi3[eve::lower](as<T>()), eve::pi3[eve::upper](as<T>()))));
};
