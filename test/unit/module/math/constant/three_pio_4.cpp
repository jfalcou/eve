...
<typename T>(tts::type<T>)
{
  ...
  {
    TTS_EXPECT(eve::three_pio_4[eve::lower](eve::as<T>()) <= 3.0*3.141592653589793238462643l/4);
    TTS_EXPECT(eve::three_pio_4[eve::upper](eve::as<T>()) >= 3.0*3.141592653589793238462643l/4); 
  }
...
{
  using eve::as;
  TTS_EXPECT(eve::all(eve::test::is_near(eve::three_pio_4[eve::lower](as<T>()), eve::three_pio_4[eve::upper](as<T>()))));
};
