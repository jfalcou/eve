...
<typename T>(T const& a0)
{
  ...
  TTS_IEEE_EQUAL(eve::hypot[eve::pedantic](cases.nan, a0), cases.nan);
  TTS_IEEE_EQUAL(eve::hypot[eve::pedantic](cases.minf, a0), cases.inf);
  TTS_IEEE_EQUAL(eve::hypot[eve::pedantic](cases.nan, cases.minf), cases.inf);
  TTS_IEEE_EQUAL(eve::hypot[eve::pedantic](cases.inf, cases.nan), cases.inf);
  TTS_IEEE_EQUAL(eve::hypot[eve::pedantic](cases.nan, cases.zero), cases.nan);
  TTS_IEEE_EQUAL(eve::hypot[eve::pedantic](cases.zero,cases.nan ), cases.nan);  
#endif
};
