...
TTS_CASE_TPL("Check eve::pedantic_(eve::exp10) behavior", EVE_TYPE)
{
  ...
  if constexpr(eve::floating_value<T>)
  {
    ...
    if constexpr( eve::platform::supports_invalids )
    {
      ...
      TTS_IEEE_EQUAL(eve::pedantic_(eve::exp10)(eve::minf(eve::as<T>())), (T( 0 )) );
    }
    ...
    {
      TTS_ULP_EQUAL (eve::pedantic_(eve::exp10)(eve::minlog10(eve::as<T>())), T(std::exp(elt_t(std::log(10.0))*eve::minlog10(eve::as<elt_t>()))), 256);
      TTS_ULP_EQUAL (eve::pedantic_(eve::exp10)(eve::prev(eve::minlog10(eve::as<T>()))), T(std::exp(elt_t(std::log(10.0))*eve::prev(eve::minlog10(eve::as<elt_t>())))), 256);
    }
    TTS_ULP_EQUAL (eve::pedantic_(eve::exp10)(eve::minlog10denormal(eve::as<T>())), T(0), 0);
    TTS_ULP_EQUAL (eve::pedantic_(eve::exp10)(eve::prev(eve::minlog10denormal(eve::as<T>()))), T(0), 0);
  }
}
