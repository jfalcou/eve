...
TTS_CASE_TPL("Check eve::big_(eve::cos) return type", EVE_TYPE)
{
  TTS_EXPR_IS(eve::big_(eve::cos)(T(0)), T);
}
...
TTS_CASE_TPL("Check eve::big_(eve::cos) behavior", EVE_TYPE)
{
  ...
  {
    TTS_IEEE_EQUAL(eve::big_(eve::cos)(eve::nan(eve::as<T>())) , (eve::nan(eve::as<T>())) );
    TTS_IEEE_EQUAL(eve::big_(eve::cos)(eve::inf(eve::as<T>())) , (eve::nan(eve::as<T>())) );
    TTS_IEEE_EQUAL(eve::big_(eve::cos)(eve::minf(eve::as<T>())), (eve::nan(eve::as<T>())) );
  }
  ...
  TTS_ULP_EQUAL(eve::big_(eve::cos)(-T(1)           )         , T(std_cos(-1.0))                  , 0.5);
  TTS_ULP_EQUAL(eve::big_(eve::cos)( eve::pio_4(eve::as<T>()))         , T(std_cos( eve::pio_4(eve::as<v_t>())))    , 0.5);
  TTS_ULP_EQUAL(eve::big_(eve::cos)(-eve::pio_4(eve::as<T>()))         , T(std_cos(-eve::pio_4(eve::as<v_t>())))    , 0.5);
