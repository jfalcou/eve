...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL(
    eve::atanpi(a0), tts::map([](auto e) -> v_t { return static_cast<v_t>(eve::radinpi(std_atan(e))); }, a0), 2);
  TTS_ULP_EQUAL(
    eve::atanpi(a1), tts::map([](auto e) -> v_t { return static_cast<v_t>(eve::radinpi(std_atan(e))); }, a1), 2);
};
