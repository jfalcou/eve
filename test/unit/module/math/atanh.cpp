...
// Types tests
//==================================================================================================
TTS_CASE_TPL("Check return types of atanh", eve::test::simd::ieee_reals_wf16)
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(eve::atanh(a0), tts::map([](auto e) -> v_t { return static_cast<v_t>(std_atanh(e)); }, a0), 2);
};
