...
// Types tests
//==================================================================================================
TTS_CASE_TPL("Check return types of asinpi", eve::test::simd::ieee_reals_wf16)
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(
    eve::asinpi(a0), tts::map([](auto e) -> v_t { return static_cast<v_t>(eve::radinpi(std_asin(e))); }, a0), 2);
};
