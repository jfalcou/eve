...
TTS_CASE("Check eve::atan2pi behavior")
{
  ...
  if constexpr( eve::platform::supports_infinites )
  {
    ...
    TTS_ULP_EQUAL(eve::atan2pi(minf, minf      ),  eve::nan(eve::as<EVE_TYPE>()) , 0.5);
    TTS_ULP_EQUAL(eve::atan2pi(inf , minf      ),  eve::nan(eve::as<EVE_TYPE>()) , 0.5);
    TTS_ULP_EQUAL(eve::atan2pi(minf, inf       ),  eve::nan(eve::as<EVE_TYPE>()) , 0.5);
    TTS_ULP_EQUAL(eve::atan2pi(inf , inf       ),  eve::nan(eve::as<EVE_TYPE>()) , 0.5);
    TTS_ULP_EQUAL(eve::atan2pi(inf , (EVE_TYPE(1.))),  (EVE_TYPE(0.5)), 0.5);
    TTS_ULP_EQUAL(eve::atan2pi(minf, (EVE_TYPE(1.))), (EVE_TYPE(-0.5)) , 0.5);
  }
  ...
  {
    TTS_ULP_EQUAL(eve::atan2pi(eve::nan(eve::as<EVE_TYPE>()), eve::nan(eve::as<EVE_TYPE>())) , eve::nan(eve::as<EVE_TYPE>()), 0.5);
    TTS_ULP_EQUAL(eve::atan2pi(eve::nan(eve::as<EVE_TYPE>()), (EVE_TYPE(0.)))       , eve::nan(eve::as<EVE_TYPE>()), 0.5);
    TTS_ULP_EQUAL(eve::atan2pi((EVE_TYPE(0.))      , eve::nan(eve::as<EVE_TYPE>())) , eve::nan(eve::as<EVE_TYPE>()), 0.5);
  }
  ...
  TTS_ULP_EQUAL(eve::atan2pi((EVE_TYPE(0.))  , (EVE_TYPE(0.))  ) ,  eve::nan(eve::as<EVE_TYPE>()), 0.5);
  TTS_ULP_EQUAL(eve::atan2pi(mzero       , (EVE_TYPE(0.))  ) ,  eve::nan(eve::as<EVE_TYPE>()), 0.5);
  TTS_ULP_EQUAL(eve::atan2pi(mzero       , mzero       ) ,  eve::nan(eve::as<EVE_TYPE>()), 0.5);
  TTS_ULP_EQUAL(eve::atan2pi((EVE_TYPE(0.))  , mzero       ) ,  eve::nan(eve::as<EVE_TYPE>()), 0.5);
}
