...
TTS_CASE_TPL("Check eve::medium_(eve::cscpi) behavior", EVE_TYPE)
{
  ...
  {
    TTS_IEEE_EQUAL(eve::medium_(eve::cscpi)(eve::Nan<T>()) , eve::Nan<T>() );
    TTS_IEEE_EQUAL(eve::medium_(eve::cscpi)(eve::Inf<T>()) , eve::Nan<T>() );
    TTS_IEEE_EQUAL(eve::medium_(eve::cscpi)(eve::Minf<T>()), eve::Nan<T>() );
  }

  TTS_IEEE_EQUAL(eve::medium_(eve::cscpi)(T(0))  , eve::Inf<T>() );
  TTS_IEEE_EQUAL(eve::medium_(eve::cscpi)(T(-0.)), eve::Minf<T>());

  TTS_ULP_EQUAL(eve::medium_(eve::cscpi)(-T(100000000.0) ) , eve::Nan<T>()   , 0.5);
  TTS_ULP_EQUAL(eve::medium_(eve::cscpi)(-T(100000.0)    ) , eve::Nan<T>()   , 0.5);
  TTS_ULP_EQUAL(eve::medium_(eve::cscpi)(-T(100000.5)    ) , T(-1)           , 0.5);
  TTS_ULP_EQUAL(eve::medium_(eve::cscpi)( T(1)           ) , eve::Nan<T>()   , 0.5);
  TTS_ULP_EQUAL(eve::medium_(eve::cscpi)(-T(1)           ) , eve::Nan<T>()   , 0.5);
