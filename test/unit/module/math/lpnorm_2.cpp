...
<typename T>(T const& a0, T const& a1, T const& a2, T const& a3, T const& a4, T const& a5)
{
  ...
  TTS_ULP_EQUAL(eve::diff_2nd(eve::lpnorm)(2, a0, a1), eve::diff_1st(eve::hypot)(a0, a1), 2);
  TTS_ULP_EQUAL(eve::diff_2nd(eve::lpnorm)(2, a2, a3), eve::diff_1st(eve::hypot)(a2, a3), 2);
  TTS_ULP_EQUAL(eve::diff_3rd(eve::lpnorm)(2, a0, a1), eve::diff_2nd(eve::hypot)(a0, a1), 2);
  TTS_ULP_EQUAL(eve::diff_3rd(eve::lpnorm)(2, a2, a3), eve::diff_2nd(eve::hypot)(a2, a3), 2);
