...
<typename T>(T const& a0, T const& a1, T const& a2)
{
  ...
  auto std__cyl_bessel_k1 = [](auto x) -> v_t { return NAMESPACE::cyl_bessel_k(v_t(1), x); };
...
{
  TTS_IEEE_EQUAL(eve::cyl_bessel_k1[mask](a0),
            eve::if_else(mask, eve::cyl_bessel_k1(a0), a0));
};
