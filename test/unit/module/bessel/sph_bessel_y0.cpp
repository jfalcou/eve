...
// EVE_TEST( "Check behavior of sph_bessel_y0 on wide with negative non integral order"
//         , eve::test::simd::ieee_reals
...
//   auto std__diff_bessel_y0 =  [](auto x)->v_t { return boost::math::sph_bessel_i_prime(double(0), double(x)); };
