            ...
            )
{
  ...
  {
    TTS_ULP_EQUAL(eve::cyl_bessel_j1(eve::minf(eve::as<v_t>())), eve::zero(eve::as<v_t>()), 0);
    TTS_ULP_EQUAL(eve::cyl_bessel_j1(eve::inf (eve::as<v_t>())), eve::zero(eve::as<v_t>()), 0);
    TTS_ULP_EQUAL(eve::cyl_bessel_j1(eve::nan (eve::as<v_t>())), eve::nan(eve::as<v_t>()), 0);
    TTS_ULP_EQUAL(eve::cyl_bessel_j1(eve::minf(eve::as<T>()))  , eve::zero(eve::as<T>()), 0);
    TTS_ULP_EQUAL(eve::cyl_bessel_j1(eve::inf (eve::as<T>()))  , eve::zero(eve::as<T>()), 0);
    TTS_ULP_EQUAL(eve::cyl_bessel_j1(eve::nan (eve::as<T>()))  , eve::nan(eve::as<T>()), 0);
  }
...
{
  TTS_IEEE_EQUAL(eve::cyl_bessel_j1[mask](a0), eve::if_else(mask, eve::cyl_bessel_j1(a0), a0));
};
