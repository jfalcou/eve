...
<typename T>(T n, T a0)
{
  ...
  // scalar serie
  TTS_ULP_EQUAL(
      eve::cyl_bessel_jn(v_t(2.5), v_t(0.1)), std_cyl_bessel_jn(v_t(2.5), v_t(0.1)), 20000.0);
  TTS_ULP_EQUAL(
      eve::cyl_bessel_jn(v_t(3.5), v_t(0.2)), std_cyl_bessel_jn(v_t(3.5), v_t(0.2)), 20000.0);
  // scalar besseljy
  ...
  // large x
  TTS_ULP_EQUAL(
      eve::cyl_bessel_jn(T(3.5), T(1000)), T(std_cyl_bessel_jn(v_t(3.5), v_t(1000))), 20000.0);
