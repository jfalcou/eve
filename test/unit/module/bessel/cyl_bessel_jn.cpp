...
<typename T>(T n, T a0)
{
  ...
  { return boost::math::cyl_bessel_j(double(n), double(x)); };
...
<typename T>(T n, T a0)
{
  ...
  {
    TTS_ULP_EQUAL(
        eve__cyl_bessel_jn(v_t(0.5), eve::minf(eve::as<v_t>())), eve::nan(eve::as<v_t>()), 0);
    TTS_ULP_EQUAL(eve__cyl_bessel_jn(v_t(2.5), eve::inf(eve::as<v_t>())), v_t(0), 0);
    TTS_ULP_EQUAL(
        eve__cyl_bessel_jn(v_t(3.5), eve::nan(eve::as<v_t>())), eve::nan(eve::as<v_t>()), 0);
  }
  // scalar large x
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(3.5), v_t(1000)), std__cyl_bessel_jn(v_t(3.5), v_t(1000)), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(2.5), v_t(500)), std__cyl_bessel_jn(v_t(2.5), v_t(500)), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(-3.5), v_t(1000)), std__cyl_bessel_jn(v_t(-3.5), v_t(1000)), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(-2.5), v_t(500)), std__cyl_bessel_jn(v_t(-2.5), v_t(500)), 2.0);
  ...
  // scalar serie
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(2.5), v_t(0.1)), std__cyl_bessel_jn(v_t(2.5), v_t(0.1)), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(3.5), v_t(0.2)), std__cyl_bessel_jn(v_t(3.5), v_t(0.2)), 3.0);
  // scalar besseljy
  ...
  // scalar large x
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(3.5), T(1000)), T(std__cyl_bessel_jn(v_t(3.5), v_t(1000))), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(2.5), T(500)), T(std__cyl_bessel_jn(v_t(2.5), v_t(500))), 2.0);
  // scalar forward
  ...
  // scalar serie
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(2.5), T(0.1)), T(std__cyl_bessel_jn(v_t(2.5), v_t(0.1))), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(3.5), T(0.2)), T(std__cyl_bessel_jn(v_t(3.5), v_t(0.2))), 2.5);
  // scalar besseljy
  ...
  // large x
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(T(3.5), T(1000)), T(std__cyl_bessel_jn(v_t(3.5), v_t(1000))), 2.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_jn(T(2.5), T(500)), T(std__cyl_bessel_jn(v_t(2.5), v_t(500))), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(T(-3.5), T(1000)), T(std__cyl_bessel_jn(v_t(-3.5), v_t(1000))), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(T(-2.5), T(500)), T(std__cyl_bessel_jn(v_t(-2.5), v_t(500))), 2.0);
  // forward
  ...
  // scalar forward
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(-2.5), v_t(10)), std__cyl_bessel_jn(v_t(-2.5), v_t(10)), 6.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_jn(v_t(-3.5), v_t(5)), std__cyl_bessel_jn(v_t(-3.5), v_t(5)), 35.0);
  // scalar serie
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(-2.5), v_t(0.1)), std__cyl_bessel_jn(v_t(-2.5), v_t(0.1)), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(-3.5), v_t(0.2)), std__cyl_bessel_jn(v_t(-3.5), v_t(0.2)), 2.0);
  // scalar besseljy
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(-10.5), v_t(8)), std__cyl_bessel_jn(v_t(-10.5), v_t(8)), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(v_t(-10.5), v_t(8)), std__cyl_bessel_jn(v_t(-10.5), v_t(8)), 2.0);
  ...
  // serie
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(T(-2.5), T(0.1)), T(std__cyl_bessel_jn(v_t(-2.5), v_t(0.1))), 2.0);
  TTS_ULP_EQUAL(
      eve__cyl_bessel_jn(T(-3.5), T(0.2)), T(std__cyl_bessel_jn(v_t(-3.5), v_t(0.2))), 2.5);
  // besseljy
