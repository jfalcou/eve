...
<typename T>(T const& a0, T const& a1, T const& a2)
{
  ...
  auto std__cyl_bessel_i0 = [](auto x) -> v_t { return NAMESPACE::cyl_bessel_i(v_t(0), x); };
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_i0(v_t(20)), std__cyl_bessel_i0(v_t(20)), 7.0);
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_i0(T(20)), T(std__cyl_bessel_i0(v_t(20))), 6.0);
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_i0(a0), map(std__cyl_bessel_i0, a0), 16.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_i0(a1), map(std__cyl_bessel_i0, a1), 16.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_i0(a2), map(std__cyl_bessel_i0, a2), 16.0);
};
...
{
  TTS_IEEE_EQUAL(eve::cyl_bessel_i0[mask](a0),
            eve::if_else(mask, eve::cyl_bessel_i0(a0), a0));
};
