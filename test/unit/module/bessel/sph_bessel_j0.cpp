...
<typename T>(T const& a0, T const& a1, T const& a2)
{
  ...
  auto std__sph_bessel_j0 = [](auto x) -> v_t { return NAMESPACE::sph_bessel(0u, double(x)); };
  ...
  TTS_ULP_EQUAL(eve__sph_bessel_j0(v_t(500)), std__sph_bessel_j0(v_t(500)), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(v_t(10)), std__sph_bessel_j0(v_t(10)), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(v_t(5)), std__sph_bessel_j0(v_t(5)), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(v_t(2)), std__sph_bessel_j0(v_t(2)), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(v_t(1.5)), std__sph_bessel_j0(v_t(1.5)), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(v_t(0.5)), std__sph_bessel_j0(v_t(0.5)), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(v_t(1)), std__sph_bessel_j0(v_t(1)), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(v_t(0)), eve::one(eve::as<v_t>()), 0.0);

  TTS_ULP_EQUAL(eve__sph_bessel_j0(T(500)), T(std__sph_bessel_j0(v_t(500))), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(T(10)), T(std__sph_bessel_j0(v_t(10))), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(T(5)), T(std__sph_bessel_j0(v_t(5))), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(T(2)), T(std__sph_bessel_j0(v_t(2))), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(T(1.5)), T(std__sph_bessel_j0(v_t(1.5))), 5000.0);
  TTS_ULP_EQUAL(eve__sph_bessel_j0(T(0.5)), T(std__sph_bessel_j0(v_t(0.5))), 5000.0);
