...
<typename T>(T const& a0, T const& a1, T const& a2, T const& a3)
{
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(v_t(1500)), std__cyl_bessel_j0(v_t(1500)), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(v_t(500)), std__cyl_bessel_j0(v_t(500)), 3000.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(v_t(10)), std__cyl_bessel_j0(v_t(10)), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(v_t(5)), std__cyl_bessel_j0(v_t(5)), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(v_t(2)), std__cyl_bessel_j0(v_t(2)), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(v_t(1.5)), std__cyl_bessel_j0(v_t(1.5)), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(v_t(0.5)), std__cyl_bessel_j0(v_t(0.5)), 300.0);
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(T(1500)), T(std__cyl_bessel_j0(v_t(1500))), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(T(500)), T(std__cyl_bessel_j0(v_t(500))), 3000.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(T(10)), T(std__cyl_bessel_j0(v_t(10))), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(T(5)), T(std__cyl_bessel_j0(v_t(5))), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(T(2)), T(std__cyl_bessel_j0(v_t(2))), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(T(1.5)), T(std__cyl_bessel_j0(v_t(1.5))), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(T(0.5)), T(std__cyl_bessel_j0(v_t(0.5))), 300.0);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(T(1)), T(std__cyl_bessel_j0(v_t(1))), 300.0);
  ...
  TTS_RELATIVE_EQUAL(eve__cyl_bessel_j0(a3), map(std__cyl_bessel_j0, a3), 0.02);
