...
<typename T>( [[maybe_unused]] T const& a0 )
{
  ...
  {
    TTS_ULP_EQUAL(eve::cyl_bessel_y0(eve::minf(eve::as<v_t>())), eve::nan(eve::as<v_t>()), 0);
    TTS_ULP_EQUAL(eve::cyl_bessel_y0(eve::inf(eve::as<v_t>())), v_t(0), 0);
    TTS_ULP_EQUAL(eve::cyl_bessel_y0(eve::nan(eve::as<v_t>())), eve::nan(eve::as<v_t>()), 0);
    TTS_ULP_EQUAL(eve::cyl_bessel_y0(eve::minf(eve::as<T>())), eve::nan(eve::as<T>()), 0);
    TTS_ULP_EQUAL(eve::cyl_bessel_y0(eve::inf(eve::as<T>())), T(0), 0);
    TTS_ULP_EQUAL(eve::cyl_bessel_y0(eve::nan(eve::as<T>())), eve::nan(eve::as<T>()), 0);
  }
...
{
  TTS_IEEE_EQUAL(eve::cyl_bessel_y0[mask](a0), eve::if_else(mask, eve::cyl_bessel_y0(a0), a0));
};
