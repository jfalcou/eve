...
<typename T>(T a0, T a1)
{
  ...
  TTS_ULP_EQUAL(eve::airy_ai(v_t(1500)), boost::math::airy_ai(v_t(1500)), 10.0);
  TTS_ULP_EQUAL(eve::airy_ai(T(1500)), T(boost::math::airy_ai(v_t(1500))), 10.0);

  TTS_ULP_EQUAL(eve::airy_ai(v_t(500)), boost::math::airy_ai(v_t(500)), 10.0);
  TTS_ULP_EQUAL(eve::airy_ai(T(500)), T(boost::math::airy_ai(v_t(500))), 10.0);

  TTS_ABSOLUTE_EQUAL(eve::airy_ai(v_t(-500)), boost::math::airy_ai(v_t(-500)), abstol);
  TTS_ABSOLUTE_EQUAL(eve::airy_ai(T(-500)), T(boost::math::airy_ai(v_t(-500))), abstol);

  TTS_ABSOLUTE_EQUAL(eve::airy_ai(v_t(-1500)), boost::math::airy_ai(v_t(-1500)), abstol);
  TTS_ABSOLUTE_EQUAL(eve::airy_ai(T(-1500)), T(boost::math::airy_ai(v_t(-1500))), abstol);

  TTS_ABSOLUTE_EQUAL(eve::airy_ai(a0), eve::detail::map(std__airy_ai, a0), 0.0005);
  TTS_RELATIVE_EQUAL(eve::airy_ai(a1), eve::detail::map(std__airy_ai, a1), 0.0005);
};
