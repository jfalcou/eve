  ...
  <typename T>(eve::as<T>)
{
  ...
  TTS_ULP_EQUAL((eve::log)(c_t(eve::minf (as<T>()), eve::mone(as<T>()))), c_t(eve::inf(as<T>()), -eve::pi(as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::inf(as<T>()), 0)), c_t(eve::inf(as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::minf(as<T>()), 0)), c_t(eve::inf(as<T>()), eve::pi(as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::nan(as<T>()), eve::nan(as<T>()))),  c_t(eve::nan(as<T>()), eve::nan(as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::inf  (as<T>()), eve::zero(as<T>()))),  c_t(eve::inf(as<T>()), eve::zero(as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::minf (as<T>()), eve::zero(as<T>()))),  c_t(eve::inf(as<T>()), eve::pi(as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::inf  (as<T>()), eve::zero(as<T>()))),  c_t(eve::inf (as<T>()), eve::zero (as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::one  (as<T>()), eve::inf (as<T>()))), c_t(eve::inf(as<T>()), eve::pio_2(as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::one  (as<T>()), eve::nan (as<T>()))), c_t(eve::nan(as<T>()), eve::nan(as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::inf  (as<T>()), eve::one (as<T>()))), c_t(eve::inf(as<T>()), eve::zero(as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::minf (as<T>()), eve::one(as<T>()))),  c_t(eve::inf(as<T>()), eve::pi(as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::inf  (as<T>()), eve::one (as<T>()))), c_t(eve::inf (as<T>()), eve::zero (as<T>())), 0.5);
  TTS_ULP_EQUAL((eve::log)(c_t(eve::nan  (as<T>()), eve::one(as<T>()))),  c_t(eve::nan (as<T>()), eve::nan(as<T>())), 0.5);
