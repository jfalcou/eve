  ...
  <typename T>(T const& a0, T const& a1 )
{
  ...
  for(auto e : a0)
  {
    for(auto f : a1)
    {
      TTS_ULP_EQUAL(eve::acosh(eve::complex<e_t>(e, f)),  cv(std::acosh(c_t(e, f))), 2.0);
    }
  }
};
  ...
  <typename T>(T const& a0, T const& a1 )
{
  ...
  TTS_ULP_EQUAL(eve::acosh(z_t{a0,a1}), init_with_std(a0, a1), 2);
};
...
//   auto tacoshine= [](auto z){return eve::pedantic(eve::acoshh)(eve::mul_i(z));};
//   for(int i=0; i < N; ++i)
//   {
