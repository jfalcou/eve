...
//  auto ulp = 100.0;
  ...
  {
    return cv(std::powm1( c_t(a0.get(i), a1.get(i)), c_t(a2.get(i), a3.get(i))));
  };
  auto init_with_std1 = [=](auto i, auto)
  {
    return cv(std::powm1( c_t(eve::abs(a0.get(i)), 0), c_t(a2.get(i), a3.get(i))));
  };
  ...
  {
    return cv(std::powm1(c_t(a2.get(i), a3.get(i)),  c_t(eve::abs(a0.get(i)), 0)));
  };
