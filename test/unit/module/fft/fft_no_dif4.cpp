...
TTS_CASE_TPL("Check fft_no_dif4 on aos", eve::test::simd::ieee_reals)
<typename T>(tts::type<T>)
{
  if constexpr(std::same_as<eve::element_type_t<T>, double>&& eve::cardinal_v<T> == 1)
  {
    ...
    pr("a avant", a);
    eve::aos(eve::fft_no_dif4)(a, e_t(1.0));
    pr("a apres", a);
    eve::aos(eve::ifft)(eve::aos(eve::fft_no_dif4), a, e_t(1)/N);
    pr("a apres ifft", a);
...
// TTS_CASE_TPL("Check fft_no_dif4 on soa", eve::test::simd::ieee_reals)
// <typename T>(tts::type<T>)
// {
...
//     }
//     pr("a avant", a);
//     eve::soa(eve::fft_no_dif4)(a, e_t(1.0));
//     pr("a apres", a);
//     eve::soa(eve::ifft)(eve::soa(eve::fft_no_dif4), a, e_t(1)/N);
//     pr("a apres ifft", a);
