...
TTS_CASE_TPL("Check ft_no_dif4", eve::test::simd::ieee_reals)
<typename T>(tts::type<T>)
{
  if(eve::cardinal_v<T> == 1)
  {
    using e_t = eve::element_type_t<T>;
    timeit("eve::aos(eve::fft_df_dif4)", eve::aos(eve::fft_no_dif4), eve::aos_type{}, e_t(1.0), 16);
//     using e_t = eve::element_type_t<T>;
//     timeit("eve::soa(eve::fft_df_dif2)", eve::soa(eve::fft_no_dif4), eve::soa_type{}, e_t(1.0), 16);
    std::cout << "==========================================================================================================================" << std::endl;
  }
  TTS_EQUAL(0, 0);
  return 0;
