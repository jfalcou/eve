  ...
  <typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL(eve::tanh(eve::inf(eve::as<dd_t>())), eve::one(eve::as<dd_t>()), 0.5);
  TTS_ULP_EQUAL(eve::tanh(eve::minf(eve::as<dd_t>())), eve::mone(eve::as<dd_t>()), 0.5);
  TTS_ULP_EQUAL(eve::tanh(eve::zero(eve::as<dd_t>())), eve::zero(eve::as<dd_t>()), 0.5);
  TTS_ULP_EQUAL(eve::tanh(eve::mzero(eve::as<dd_t>())), eve::mzero(eve::as<dd_t>()), 0.5);
  TTS_ULP_EQUAL(eve::tanh(eve::nan(eve::as<dd_t>())), eve::nan(eve::as<dd_t>()), 0.5);
};
