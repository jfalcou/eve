...
//      TTS_EQUAL( eve::frac(eve::dd<e_t>(e, f)), eve::dd<e_t>(ch, cl) ) << eve::dd<e_t>(e, f) << '\n' ;
      if constexpr(sizeof(e_t) == 4)
      {
        TTS_EQUAL ( eve::to_double(eve::frac(eve::dd<e_t>(e, f))), eve::frac(eve::to_double(eve::dd<e_t>(e, f))));
      }
    }
  }
};
