  ...
  <typename T>(T const& a0, T const& a1 )
{
  ...
  for(auto e : a0)
  {
    for(auto f : a1)
    {
      ...
      {
        TTS_ULP_EQUAL ( eve::to_double(eve::sqrt(eve::dd<e_t>(e, f))), eve::sqrt(eve::to_double(eve::dd<e_t>(e, f))), 10);
        std::cout << eve::to_double(eve::sqrt(eve::dd<e_t>(e, f)))- eve::sqrt(eve::to_double(eve::dd<e_t>(e, f))) << std::endl;
      }
//       else
//       {
//         TTS_EQUAL ( eve::to_float128(eve::sqrt(eve::dd<e_t>(e, f))), bm::sqrt(eve::to_float128(eve::dd<e_t>(e, f))));
//       }
    }
  }
};
