...
//      TTS_EQUAL( eve::sqr_abs(eve::dd<e_t>(e, f)), eve::dd<e_t>(ch, cl) ) << eve::dd<e_t>(e, f) << '\n' ;
      if constexpr(sizeof(e_t) == 4)
      {
        TTS_ULP_EQUAL ( eve::to_double(eve::sqr_abs(eve::dd<e_t>(e, f))), eve::sqr_abs(eve::to_double(eve::dd<e_t>(e, f))), 32);
      }
    }
  }
};
