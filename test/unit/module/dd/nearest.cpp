...
//      TTS_EQUAL( eve::nearest(eve::dd<e_t>(e, f)), eve::dd<e_t>(ch, cl) ) << eve::dd<e_t>(e, f) << '\n' ;
      if constexpr(sizeof(e_t) == 4)
      {
        TTS_EQUAL ( eve::to_double(eve::nearest(eve::dd<e_t>(e, f))), eve::nearest(eve::to_double(eve::dd<e_t>(e, f))));
      }
    }
  }
};
