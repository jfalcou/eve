  ...
  <typename T>(T const& a0, T const& a1 )
{
  ...
  for(auto e : a0)
  {
    for(auto f : a1)
    {
      ...
      std::cout << bm::abs(tts::uptype(eve::asin(z))- bm::asin(tts::uptype(z))) << "? < " << tts::uptype(eve::eps(eve::as(z))) << std::endl;
      TTS_EXPECT ( bm::abs(tts::uptype(eve::asin(z))- bm::asin(tts::uptype(z))) < tts::uptype(eve::eps(eve::as(z))));
    }
  }
};
