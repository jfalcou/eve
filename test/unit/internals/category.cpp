...
<typename T>(tts::type<T>)
{
  if constexpr( eve::has_native_abi_v<T> )
  {
    ...
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), size64_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), float64));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), lanes));
    TTS_CONSTEXPR_EQUAL(eve::_::categorize<T>(), float64 | lanes);
  }
...
<typename T>(tts::type<T>)
{
  if constexpr( eve::has_native_abi_v<T> )
  {
    ...
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), signed_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), size64_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), int_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), int64));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), lanes));
    TTS_CONSTEXPR_EQUAL(eve::_::categorize<T>(), int64 | lanes);
  }
...
<typename T>(tts::type<T>)
{
  if constexpr( eve::has_native_abi_v<T> )
  {
    ...
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), size64_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), uint_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), uint64));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), lanes));
    TTS_CONSTEXPR_EQUAL(eve::_::categorize<T>(), uint64 | lanes);
  }
...
<typename T>(tts::type<T>)
{
  if constexpr( eve::has_native_abi_v<T> )
  {
    ...
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), float_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), signed_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), size32_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), float32));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), lanes));
    TTS_CONSTEXPR_EQUAL(eve::_::categorize<T>(), float32 | lanes);
  }
...
<typename T>(tts::type<T>)
{
  if constexpr( eve::has_native_abi_v<T> )
  {
    ...
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), size32_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), int_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), int32));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), lanes));
    TTS_CONSTEXPR_EQUAL(eve::_::categorize<T>(), int32 | lanes);
  }
...
<typename T>(tts::type<T>)
{
  if constexpr( eve::has_native_abi_v<T> )
  {
    ...
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), size32_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), uint_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), uint32));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), lanes));
    TTS_CONSTEXPR_EQUAL(eve::_::categorize<T>(), uint32 | lanes);
  }
...
<typename T>(tts::type<T>)
{
  if constexpr( eve::has_native_abi_v<T> )
  {
    ...
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), integer_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), signed_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), size16_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), int_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), int16));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), lanes));
    TTS_CONSTEXPR_EQUAL(eve::_::categorize<T>(), int16 | lanes);
  }
...
<typename T>(tts::type<T>)
{
  if constexpr( eve::has_native_abi_v<T> )
  {
    ...
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), size16_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), uint_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), uint16));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), lanes));
    TTS_CONSTEXPR_EQUAL(eve::_::categorize<T>(), uint16 | lanes);
  }
...
<typename T>(tts::type<T>)
{
  if constexpr( eve::has_native_abi_v<T> )
  {
    ...
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), integer_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), signed_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), size8_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), int_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), int8));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), lanes));
    TTS_CONSTEXPR_EQUAL(eve::_::categorize<T>(), int8 | lanes);
  }
...
<typename T>(tts::type<T>)
{
  if constexpr( eve::has_native_abi_v<T> )
  {
    ...
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), size8_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), uint_));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), uint8));
    TTS_CONSTEXPR_EXPECT(match(eve::_::categorize<T>(), lanes));
    TTS_CONSTEXPR_EQUAL(eve::_::categorize<T>(), uint8 | lanes);
  }
