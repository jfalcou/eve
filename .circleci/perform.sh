...
then
  ...
  cmake ../.. -G Ninja $CMAKE_OPTIONS -DCMAKE_CXX_COMPILER="$COMPILER" -DCMAKE_CXX_FLAGS="$OPTIONS $COMMON_CXX_FLAGS" -DCMAKE_EXE_LINKER_FLAGS="$COMMON_LINKER_OPTIONS"  -DCMAKE_CROSSCOMPILING_CMD="$RUN_COMMAND"
else
  cmake ../.. -G Ninja $CMAKE_OPTIONS -DCMAKE_CXX_COMPILER="$COMPILER" -DCMAKE_CXX_FLAGS="$OPTIONS $COMMON_CXX_FLAGS" -DCMAKE_EXE_LINKER_FLAGS="$COMMON_LINKER_OPTIONS"
fi
