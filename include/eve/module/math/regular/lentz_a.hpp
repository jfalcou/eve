...
//!      or, if result_type is not a pair type, then the next \f$b_i\f$ value alone
...
//!      the relative error in the result less than tolerance or until the max_terms iteration is reached.
//!
//!   **Return value**
//!
