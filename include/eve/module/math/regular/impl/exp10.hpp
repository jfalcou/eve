...
namespace eve::detail
{
  ...
  requires(is_one_of<D>(types<regular_type, pedantic_type> {}))
  {
    if constexpr( has_native_abi_v<T> )
    {
      ...
      const T Log10_2hi   = ieee_constant<T>(0x1.3400000p-2f, 0x1.3440000000000p-2);
      const T Log10_2lo   = ieee_constant<T>(0x1.04d4280p-12f, 0x1.3509f79fef312p-18);
      ...
      else if constexpr( std::is_same_v<elt_t, double> )
      {
        ...
        T x2 = px
          / (
             eve::reverse_horner(xx, T(0x1.03f37650df6e2p+11), T(0x1.3e05eefd67782p+10)
                                , T(0x1.545fdce51ca08p+6), T(0x1.0p0))
