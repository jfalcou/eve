...
//!
//!      // Lanes masking
//!      constexpr auto acotpi[conditional_expr auto c](floatingvalue auto x) noexcept; // 2.1
//!      constexpr auto acotpi[logical_value auto m](floatingvalue auto x)    noexcept; // 2.2
//!   }
//!   @endcode
//!
//!   **Parameters**
