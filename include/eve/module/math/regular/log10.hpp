...
namespace eve
{
  ...
  struct log10_t : elementwise_callable<log10_t, Options, raw_option, fast_option>
  {
...
//================================================================================================
  ...
  namespace _
  {
    ...
    log10_(EVE_REQUIRES(cpu_), O const& o, T a0) noexcept
    {
      ...
      {
        return elt_t(0.301029995663981)*eve::log2[o](a0);
      }
      else
      {
        using uiT     = as_integer_t<T, unsigned>;
        using iT      = as_integer_t<T, signed>;
        T Invlog_10hi = ieee_constant<0x1.bcb7b15200000p-2 , 0x1.bcc0000p-2f  >(eve::as<T>{});
        ...
        if constexpr(std::same_as<eve::element_type_t<T>, eve::float16_t>)
          return eve::_::apply_fp16_as_fp32(eve::log10[o], a0);
