...
//!
//!      // Lanes masking
//!      constexpr auto acoth[conditional_expr auto c](floatingvalue auto x) noexcept; // 2.1
//!      constexpr auto acoth[logical_value auto m](floatingvalue auto x)    noexcept; // 2.2
//!   }
//!   @endcode
//!
//!   **Parameters**
