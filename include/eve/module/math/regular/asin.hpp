...
//!
//!      // Lanes masking
//!      constexpr auto asin[conditional_expr auto c](floatingvalue auto x) noexcept; // 2.1
//!      constexpr auto asin[logical_value auto m](floatingvalue auto x)    noexcept; // 2.2
//!   }
//!   @endcode
//!
//!   **Parameters**
