...
//!
//!      // Semantic options
//!      constexpr auto sinpi[quarter_circle](floating_value auto x)          noexcept; // 3.a
//!      constexpr auto sinpi[half_circle](floating_value auto x)             noexcept; // 3.b
//!      constexpr auto sinpi[full_circle](floating_value auto x)             noexcept; // 3.c
//!   }
//!   @endcode
//!
//! **Parameters**
