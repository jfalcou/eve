...
//================================================================================================
  ...
  namespace detail
  {
    ...
    EVE_FORCEINLINE constexpr T powm1_(EVE_REQUIRES(cpu_), O const & o, T a0, U a1) noexcept
    {
      return powm1[o](a0, T(a1));
    }

    template<typename T,  typename U, callable_options O>
    EVE_FORCEINLINE constexpr common_value_t<T, U> powm1_(EVE_REQUIRES(cpu_), O const & o, T a, U b) noexcept
    {
