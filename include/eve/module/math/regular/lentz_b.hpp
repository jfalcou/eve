...
namespace eve
{
  ...
  struct lentz_b_t : strict_elementwise_callable<lentz_b_t, Options>
  {
    ...
    {
      return this->behavior(as<as_wide_as_t<T, decltype(get<0>(g()))>>{}, eve::current_api, this->options(), g, eps, m);
    }
    ...
    {
      return this->behavior(as<as_wide_as_t<T, decltype(g())>>{}, eve::current_api, this->options(), g, eps, m);
    }
