...
//!
//!      // Lanes masking
//!      constexpr auto asecd[conditional_expr auto c](floating_value auto x) noexcept; // 3.1
//!      constexpr auto asecd[logical_value auto m](floating_value auto x)    noexcept; // 3.2
//!   }
//!   @endcode
//!
//!   **Parameters**
