...
namespace eve::detail
{
  ...
  /*EVE_FORCEINLINE */constexpr T log_(EVE_SUPPORTS(cpu_), pedantic_type const &, T a0) noexcept
  {
  ...
  /*EVE_FORCEINLINE*/ constexpr auto log_(EVE_SUPPORTS(cpu_), pedantic_type const &, T x) noexcept
  {
    using uiT = as_integer_t<T, unsigned>;
    using iT  = as_integer_t<T, signed>;
    T Log_2hi = Ieee_constant<T, 0x3f318000U, 0x3fe62e42fee00000ULL>();
