...
**/
//==================================================================================================
#ifndef EVE_MODULE_MATH_FUNCTION_GENERIC_ATAN2D_HPP_INCLUDED
#define EVE_MODULE_MATH_FUNCTION_GENERIC_ATAN2D_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  {
    if constexpr( has_native_abi_v<T> )
      return radindeg(pedantic_(atan2)(a, b));
    else
      return apply_over(pedantic_(atan2d), a, b);
  }
