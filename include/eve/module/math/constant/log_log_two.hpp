...
namespace eve
{
  ...
  //! | Member       | Effect                                                     |
  //! |:-------------|:-----------------------------------------------------------|
  //! | `operator()` | Computes the log_log_two constant                              |
  //!
  //! ---
  //!
  //!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
  ...
  //! **Return value**
  //!
  //! the log_log_two constant in the chosen type.
  //!
  //! ---
  //!
  //! #### Example
  ...
  //! @}
  //================================================================================================
  EVE_MAKE_CALLABLE(log_log_two_, log_log_two);

  namespace detail
  {
    template<floating_real_value T>
    EVE_FORCEINLINE auto log_log_two_(EVE_SUPPORTS(cpu_), eve::as<T> const & ) noexcept
    {
    ...
    EVE_FORCEINLINE constexpr auto log_log_two_(EVE_SUPPORTS(cpu_), D const &, as<T> const &) noexcept
