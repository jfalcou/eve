...
namespace eve
{
  ...
  //! #### Example
  //!
  //! @godbolt{doc/core/four_thirds_pi.cpp}
  //!
  //! @}
  //================================================================================================
  ...
  namespace detail
  {
    ...
    EVE_FORCEINLINE auto four_thirds_pi_(EVE_SUPPORTS(cpu_), eve::as<T> const & ) noexcept
    {
      ...
      if constexpr(std::is_same_v<t_t, float>)       return 0x1.0c1524p+2;
      else if constexpr(std::is_same_v<t_t, double>) return 0x1.0c152382d7366p+2;
    }
    ...
    requires(is_one_of<D>(types<upward_type, downward_type> {}))
    {
      ...
      {
        if constexpr(std::is_same_v<t_t, float>)  return 0x1.0c1522p+2;
        else if constexpr(std::is_same_v<t_t, double>) return 0x1.0c152382d7365p+2;
      }
    }
  }
}
