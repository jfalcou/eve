...
struct pi_minus_3_t : constant_callable<pi_minus_3_t, Options, downward_option, upward_option>
{
  ...
  static EVE_FORCEINLINE constexpr T value(eve::as<T> const&, Opts const&)
  {
    ...
    {
      if constexpr(Opts::contains(upward2))        return T(0x1.21fb56p-3);
      else if constexpr(Opts::contains(downward2)) return T(0x1.21fb54p-3);
      else                                         return T(0x1.21fb54p-3);
    }
    else
    {
      if constexpr(Opts::contains(upward2))        return T(0x1.21fb54442d185p-3);
      else if constexpr(Opts::contains(downward2)) return T(0x1.21fb54442d184p-3);
