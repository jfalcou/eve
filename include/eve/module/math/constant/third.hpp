...
struct third_t : constant_callable<third_t, Options, downward_option, upward_option>
{
  ...
  static EVE_FORCEINLINE constexpr T value(eve::as<T> const&, Opts const&)
  {
    ...
    {
      if constexpr(Opts::contains(upward2))        return T(0x1.555556p-2);
      else if constexpr(Opts::contains(downward2)) return T(0x1.555554p-2);
      else                                         return T(0x1.555556p-2);
    }
    else
    {
      if constexpr(Opts::contains(upward2))        return T(0x1.5555555555556p-2);
      else if constexpr(Opts::contains(downward2)) return T(0x1.5555555555555p-2);
