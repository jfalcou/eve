...
//     using e_t = doublereal<t_t>;
  ...
  { return doublereal_mk_cts(eve::tag::log_10_{}, as<T>(), 2.302585092994045901e+00, -2.170756223382249351e-16); }
...
//   template<typename T>
//   EVE_FORCEINLINE constexpr auto doublereal_cts_dispatch(eve::tag::_, as<T> const&) noexcept
//   { return doublereal_mk_cts(eve::tag::_{}, as<T>(), ); }
...
// const doublereal_real doublereal_real::_safe_max =
