...
//          dd_t(0x1.a38114p-39, -0x1.c93c08p-65),
  ...
  dd_unary_dispatch(eve::tag::expm1_, Z const& xx) noexcept
  {
    ...
    {
      using A4 = kumi::result::generate_t<4, dd_t>;
      using A9 = kumi::result::generate_t<9, dd_t>;
      const A4 P = {
        dd_t(0x1.29f6b20961cp-22, 0x1.29f6b20961cp-82),
        dd_t(0x1.c01c01c01c01cp-13, 0x1.c01c01c01c01cp-73),
        dd_t(0x1.1111111111111p-5, 0x1.1111111111111p-61),
        dd_t(0x1p+0, 0x0p+0)
      };
      //{1/dd_t(3603600ll), 1/dd_t(4680ll),  1/dd_t(30ll), dd_t(1)};
      const A9 Q = {
        dd_t(0x1.08db48ebe51c7p-29, 0x1.d7aa2655dac39p-85),
        dd_t(-0x1.29f6b20961cp-23, -0x1.29f6b20961cp-83),
        dd_t(0x1.45e5d2ba42eap-18, 0x1.45e5d2ba42eap-78),
        dd_t(-0x1.c01c01c01c01cp-14, -0x1.c01c01c01c01cp-74),
        dd_t(0x1.a41a41a41a41ap-10, 0x1.069069069069p-64),
        dd_t(-0x1.1111111111111p-6, -0x1.1111111111111p-62),
        dd_t(0x1.ddddddddddddep-4, -0x1.1111111111111p-59),
        dd_t(-0x1p-1, 0x0p+0),
        dd_t(0x1p+0, 0x0p+0)
      };
      //     {1/dd_t(518918400ll), -1/dd_t(7207200ll), 1/dd_t(205920ll),
      //      -1/dd_t(9360ll), 1/dd_t(624ll), -1/dd_t(60ll), 7/dd_t(60ll),
      //      -1/dd_t(2.0), dd_t(1.0)};
      //////////////////////////////////////////////////////////////////////////////
    ...
    else
    {
      ...
      using A4 = kumi::result::generate_t<4, dd_t>;
      const A3 P = {
        dd_t(1.2617719307481059087798E-4),
        dd_t(3.0299440770744196129956E-2),
        dd_t(9.9999999999999999991025E-1)
      };
      const A4 Q = {
        dd_t(3.0019850513866445504159E-6),
        dd_t(2.5244834034968410419224E-3),
        dd_t(2.2726554820815502876593E-1),
        dd_t(2.0000000000000000000897E0)
      };
      auto x2 = sqr(xx);
