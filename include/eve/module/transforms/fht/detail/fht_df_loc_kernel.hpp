  ...
  // requires(std::is_floating_point_v<typename R::value_type>)
  {
    ...
    else
    {
      ...
      for (i_t l2_m=1; l2_m<l2_n; ++l2_m)
        fht_loc_df_core<is_final_radix_16>(f+(1UL<<l2_m), l2_m, simd);
    }
  }
