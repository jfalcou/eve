...
//! @{
//!   @var naive_ft
//!   @brief Implement the raw fourier transform
//!
...
//!     void naive_ft(R a, T fac = 1, T sign = -1) noexcept;         //1
//!
//!     template< eve::Range R, floating_ordered_value T>
//!     void naive_ft(R ar, R ai, T fac = 1, T sign = -1) noexcept;  //2
//!   }
//!   @endcode
//!
//!   **Parameters**
...
//!
//!   @note never use this function in production.
//!
//!   @groupheader{Example}
//!
...
//! @}
//================================================================================================
  EVE_MAKE_CALLABLE(naive_ft_, naive_ft);

}

#include <eve/module/transforms/fft/impl/naive_ft.hpp>
