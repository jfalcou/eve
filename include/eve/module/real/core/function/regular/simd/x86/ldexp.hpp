...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T, N> ldexp_(EVE_SUPPORTS(avx512_), wide<T, N> a0, wide<T, N> a1) noexcept
  ...
  EVE_FORCEINLINE
  wide<T, N> ldexp_(EVE_SUPPORTS(avx512_), C const &cx
                   , wide<T, N> const &v, wide<T, N> const &w) noexcept
      requires x86_abi<abi_t<T, N>>
  {
    constexpr auto c = categorize<wide<T, N>>();
