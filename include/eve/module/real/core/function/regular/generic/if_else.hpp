...
//       {
//         //  using w_t =  as_wide<elt_t, cardinal_t<T>>;
//         return if_else(is_nez(cond), t, f); //w_t(t), w_t(f));
//       }
//       else
...
//         std::cout << "c   " << tts::typename_of_(c) << std::endl;
//         std::cout << "v_t " << tts::typename_of_(logical<v_t>())<< std::endl;
//         std::cout << "t "   << tts::typename_of_(t)            << std::endl;
//         std::cout << "f "   << tts::typename_of_(f)            << std::endl;
        //       return v_t(); //if_else(c, t, f);
