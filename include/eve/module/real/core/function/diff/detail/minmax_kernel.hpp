...
//   auto minmaxabs_kernel(F const & op, T0 arg0, T1 arg1, Ts... args) noexcept
//   {
//     using r_t = common_compatible_t<T0,T1, Ts...>;
//     auto getNth = []<std::size_t... I>(std::index_sequence<I...>, auto& that, auto... vs)
//       {
...
//       if constexpr(N==1)
//       {
//         return if_else(m == eve::abs(arg0), eve::sign(arg0), zero);
//       }
//       else if constexpr(N==2)
//       {
//         return  if_else(m == eve::abs(arg1), eve::sign(arg1), zero);
//       }
//       else
//       {
//         r_t that(0);
//         getNth(std::make_index_sequence<sizeof...(args)>{},that,args...);
//         return if_else(m == eve::abs(that), eve::sign(that), zero);
//       }
//     }
//   }
}
