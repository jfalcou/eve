...
//!    **Return value**
//!
//!    the value of the polynomial at `x` is returned. (the polynomial can be evaluated anywhere).
//!
//!  @groupheader{Example}
//!
...
//!     The expression `kind_2(tchebytchev)(n,x)` evaluates the nth polynominial of tchebytchev of
