...
namespace eve::detail
{
  ...
  template <typename T > constexpr T cb_y0(T x) noexcept
  {
    ...
    auto br_3 = [evaluate](auto xx)
      {
        ...
        constexpr A6 Q1 = {5.8873865738997033405e+11,
    ...
    auto br_5 = [evaluate](auto xx)
      {
        ...
        constexpr A7 Q2 = {4.3386146580707264428e+14,
    ...
    auto br_8 = [evaluate](auto xx)
      {
        ...
        constexpr A8 Q3 = {3.4563724628846457519e+17,
