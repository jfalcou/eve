...
namespace eve::detail
{
  ...
  template <typename T > constexpr T cb_j0(T a0) noexcept
  {
    ...
    if constexpr( std::is_same_v<elt_t, float> )
    {
      ...
      auto br_8 = [](auto xx){
        ...
        *
        ...
        return if_else(xx == inf(as(xx)), zero, p3 * cos(xn + xx));
      };
