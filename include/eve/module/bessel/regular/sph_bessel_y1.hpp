...
namespace eve
{
  ...
  //!
  //!      // Lanes masking
  //!      constexpr auto sph_bessel_y1[conditional_expr auto c](floating_value auto x) -> decltype(x) noexcept; // 2
  //!      constexpr auto sph_bessel_y1[logical_value auto m](floating_value auto x) -> decltype(x)    noexcept; // 2
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
