...
cyl_bessel_y1_(EVE_SUPPORTS(cpu_), T x) noexcept
{
  ...
  {
    constexpr std::array<v_t, 7> P1 = {4.0535726612579544093e+13,
    ...
    constexpr std::array<v_t, 7> Q1 = {3.0737873921079286084e+14,
  ...
  auto br_8 = [evaluate](auto x)
  {
    ...
    constexpr std::array<v_t, 9> P2 = {1.1514276357909013326e+19,
    ...
    constexpr std::array<v_t, 9> Q2 = {5.3321844313316185697e+20,
  ...
  auto br_large = [Pi](auto x)
  {
    ...
    constexpr std::array<v_t, 7> QC     = {-4.4357578167941278568e+06,
                                           ...
                                           1.0};
    constexpr std::array<v_t, 7> PS     = {3.3220913409857223519e+04,
                                           ...
                                           0.0};
    constexpr std::array<v_t, 7> QS     = {7.0871281941028743574e+05,
