...
cyl_bessel_j1_(EVE_SUPPORTS(cpu_), T x) noexcept
{
  ...
  auto br_large = [](auto x) // TODO specialize for float
  {
    ...
    A7 PC     = {-4.4357578167941278571e+06,
                 ...
                 0.0};
    A7 QC     = {-4.4357578167941278568e+06,
                 ...
                 1.0};
    A7 PS     = {3.3220913409857223519e+04,
                 ...
                 0.0};
    A7 QS     = {7.0871281941028743574e+05,
  ...
  if constexpr( has_native_abi_v<T> )
  {
    if constexpr( std::is_same_v<elt_t, float> )
    {
      ...
      auto br_8 = [](auto x)
      {
        ...
        A8 MO1     = {6.913942741265801E-002f,
        ...
        A8 PH1     = {-4.497014141919556E+001f,
