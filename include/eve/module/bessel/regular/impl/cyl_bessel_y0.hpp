...
cyl_bessel_y0_(EVE_SUPPORTS(cpu_), T x) noexcept
{
  ...
  auto br_3 = [evaluate](auto x)
  {
    ...
    A6 P1 = {1.0723538782003176831e+11,
    ...
    A6 Q1 = {5.8873865738997033405e+11,
  ...
  auto br_5 = [evaluate](auto x)
  {
    ...
    A7 P2 = {-2.2213976967566192242e+13,
    ...
    A7 Q2 = {4.3386146580707264428e+14,
  ...
  auto br_8 = [evaluate](auto x)
  {
    ...
    A8 P3 = {-8.0728726905150210443e+15,
    ...
    A8 Q3 = {3.4563724628846457519e+17,
