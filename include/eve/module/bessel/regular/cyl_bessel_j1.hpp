...
namespace eve
{
  ...
  //! @{
  //!   @var cyl_bessel_j1
  //!   @brief Computes the \f$ J_1(x)=\frac1{\pi }\int _{0}^{\pi}\cos(\tau-x\sin \tau )\,\mathrm {d} \tau \f$.
  //!
  ...
  //!    **Return value**
  //!
  //!    value of \f$ \displaystyle J_1(x)=\frac1{\pi }\int _{0}^{\pi}\cos(\tau-x\sin \tau )\,\mathrm {d} \tau \f$
  //!    is returned.
  //!
  //!  @groupheader{Example}
  //!
