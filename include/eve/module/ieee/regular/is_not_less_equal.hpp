...
namespace eve
{
  ...
  //! #### Example
  //!
  //! @godbolt{doc/ieee/is_not_less_equal.cpp}
  //!
  //!  @}
  //================================================================================================
...
#include <eve/module/ieee/regular/impl/is_not_less_equal.hpp>

#if defined(EVE_INCLUDE_X86_HEADER)
#  include <eve/module/ieee/regular/impl/simd/x86/is_not_less.hpp>
#endif
