...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto
  quaternion_unary_dispatch(eve::tag::arg_, auto const& z) noexcept
  {
    return eve::atan2(imag(z), real(z));
  }

  EVE_FORCEINLINE auto
  quaternion_unary_dispatch(eve::tag::arg_, pedantic_type const&, auto const& z) noexcept
  {
  ...
  template<typename Z>
  EVE_FORCEINLINE auto
  quaternion_unary_dispatch(eve::tag::dec_, Z const& z) noexcept
  {
  ...
  template<typename Z>
  EVE_FORCEINLINE auto
  quaternion_unary_dispatch(eve::tag::inc_, Z const& z) noexcept
  {
  ...
  template<typename Z>
  EVE_FORCEINLINE auto
  quaternion_unary_dispatch(eve::tag::proj_, Z const& z) noexcept
  {
  ...
  template<typename Z>
  EVE_FORCEINLINE auto
  quaternion_unary_dispatch(eve::tag::sqr_, eve::pedantic_type const&, Z const& z) noexcept
  {
    auto [zr, zi] = z;
  ...
  template<typename Z>
  EVE_FORCEINLINE auto
  quaternion_unary_dispatch(eve::tag::sqr_, eve::numeric_type const&, Z const& z) noexcept
  {
    auto [zr, zi] = z;
  ...
  EVE_FORCEINLINE auto
  quaternion_unary_dispatch(eve::tag::sqr_abs_, eve::pedantic_type const&, auto const& z) noexcept
  {
    auto [zr, zi] = z;
  ...
  EVE_FORCEINLINE auto
  quaternion_binary_dispatch(eve::tag::negate_, auto const& z1, auto const& z2) noexcept
  {
    return z1 * sign(z2);
  }
  ...
  template<typename Z1, typename Z2>
  EVE_FORCEINLINE auto
  quaternion_binary_dispatch(eve::tag::negatenz_, Z1 const& z1, Z2 const& z2) noexcept
  {
    return if_else(eve::is_eqz(z2), to_quaternion(z1), z1 * sign(z2));
  }
  ...
  //================================================================================================
  EVE_FORCEINLINE auto
  quaternion_ternary_dispatch(eve::tag::fam_, auto const& z1, auto const& z2, auto const& z3) noexcept
  {
    return fma(z2, z3, z1);
  }

  EVE_FORCEINLINE auto
  quaternion_ternary_dispatch(eve::tag::fma_, auto const& z1, auto const& z2, auto const& z3) noexcept
  {
  ...
  EVE_FORCEINLINE auto
  quaternion_ternary_dispatch(eve::tag::fms_, auto const& z1, auto const& z2, auto const& z3) noexcept
  {
    using z_t       = decltype(z1 * z2 + z3);
    auto [rz1, iz1] = z_t(z1);
    auto [rz2, iz2] = z_t(z2);
  ...
  EVE_FORCEINLINE auto
  quaternion_ternary_dispatch(eve::tag::fsm_, auto const& z1, auto const& z2, auto const& z3) noexcept
  {
    return fms(z2, z3, z1);
  }

  EVE_FORCEINLINE auto
  quaternion_ternary_dispatch(eve::tag::fnma_, auto const& z1, auto const& z2, auto const& z3) noexcept
  {
    return -fms(z1, z2, z3);
  }

  EVE_FORCEINLINE auto
  quaternion_ternary_dispatch(eve::tag::fnms_, auto const& z1, auto const& z2, auto const& z3) noexcept
  {
    return -fma(z1, z2, z3);
  }

  EVE_FORCEINLINE auto
  quaternion_ternary_dispatch(eve::tag::fanm_, auto const& z1, auto const& z2, auto const& z3) noexcept
  {
    return fnma(z2, z3, z1);
  }

  EVE_FORCEINLINE auto
  quaternion_ternary_dispatch(eve::tag::fsnm_, auto const& z1, auto const& z2, auto const& z3) noexcept
  {
  ...
  EVE_FORCEINLINE auto
  quaternion_nary_dispatch(eve::tag::sum_of_prod_, Z1 const& z1, Z2 const& z2, Z3 const& z3, Z4 const& z4) noexcept
  {
  ...
  template<typename Z1, typename Z2, typename Z3, typename Z4>
  EVE_FORCEINLINE auto
  quaternion_nary_dispatch(eve::tag::diff_of_prod_, Z1 const& z1, Z2 const& z2, Z3 const& z3, Z4 const& z4) noexcept
  {
