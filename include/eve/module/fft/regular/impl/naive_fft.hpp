...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE constexpr auto
  naive_fft_(EVE_SUPPORTS(cpu_), std::vector<T> const & a, T f, T s) noexcept
  ...
  template<value T, value T1>
  EVE_FORCEINLINE constexpr auto
  naive_fft_(EVE_SUPPORTS(cpu_), eve::algo::soa_vector<complex<T>> const & a, T1 f, T1 s) noexcept
