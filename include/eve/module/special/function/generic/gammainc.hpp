...
//     @par Semantic:
//     For any floating-point values a0 a1 of type T:
//
//     T r = gammainc(a0,a1);
//
//     returns the value computed by the formula:
//     $ gammainc(x)=\int_0^{a_1} t^{a_0-1}e^{-t}dt$

  template<floating_value T, floating_value U>
  EVE_FORCEINLINE  auto gammainc_(EVE_SUPPORTS(cpu_)
                              , T a
                              , U b) noexcept
  requires compatible_values<T, U>
  {
    return arithmetic_call(gammainc, a, b);
  }
