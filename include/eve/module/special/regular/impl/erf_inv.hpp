...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE T erf_inv_(EVE_SUPPORTS(cpu_), T a0) noexcept
  {
...
//         const A0 Sixteen  =  double_constant<A0, 0x4030000000000000ll>(); //16.0
      ...
      return apply_over(erf_inv, a0);
  }

  // -----------------------------------------------------------------------------------------------
  // Masked case
  template<conditional_expr C, real_value U>
  EVE_FORCEINLINE auto erf_inv_(EVE_SUPPORTS(cpu_), C const &cond, U const &t) noexcept
  {
