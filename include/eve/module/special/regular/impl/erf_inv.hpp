      ...
      if constexpr( std::is_same_v<elt_t, float> )
      {
        ...
        if( eve::any(notdone) )
        {
          auto br_wge5 = [](auto w)
            {
              return
              eve::reverse_horner(w, T(0x1.6a9efcp+1f), T(0x1.006db6p+0f), T(0x1.354afcp-7f)
                                 , T(-0x1.f38baep-8f), T(0x1.7824f6p-8f), T(-0x1.e17bcep-9f)
                                 , T(0x1.61b8e4p-10f), T(0x1.a76ad6p-14f), T(-0x1.a3e136p-13f))
              ;
            };
