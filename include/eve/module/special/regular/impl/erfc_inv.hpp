    ...
    if constexpr( has_native_abi_v<T> )
    {
      ...
      if constexpr( std::is_same_v<elt_t, float> )
      {
        ...
        auto br_wlt5 = [a00](auto w)
          {
            return a00
            *
            eve::reverse_horner(w, T(0x1.805c5ep+0f), T(0x1.f91ec6p-3f), T(-0x1.11c9dep-8f)
        ...
        if( eve::any(notdone) )
        {
          auto br_wge5 = [a00](auto w)
            {
              auto h =
              eve::reverse_horner(w, T(-0x1.5f17fcp-8f), T(0x1.31c2f8p-6f), T(-0x1.179ec6p-6f)
      ...
      else // double
      {
        ...
        auto br_wlt6_25 = [](auto w)
          {
            return
            eve::reverse_horner(w, T(0x1.a755e7c99ae86p+0), T(0x1.ebd80d9b13e28p-3), T(-0x1.8b6c33114f909p-8)
                               , T(-0x1.845769484fca8p-11), T(0x1.879c2a212f024p-13), T(-0x1.d1d1f7b8736f6p-17), T(-0x1.6e8a5434ae8a2p-20), T(0x1.c6b4f5d03b787p-22), T(-0x1.f36cd6d3d46a9p-26), T(-0x1.1a9e38dc84d60p-28), T(0x1.20f47ccf46b3cp-30), T(-0x1.dc583d118a561p-35), T(-0x1.c8859c4e5c0afp-37), T(0x1.72a22c2d77e20p-39), T(-0x1.6f2167040d8e2p-44), T(-0x1.6d33eed66c487p-45), T(0x1.de4acfd9e26bap-48), T(0x1.82e11898132e0p-56), T(-0x1.33689090a6b96p-53), T(0x1.9ba72cd589b91p-57), T(0x1.7b83eef0b7c9fp-60), T(-0x1.8ddf93324d327p-63), T(-0x1.135d2e746e627p-68))
            ;
          };
        ...
        if( eve::any(notdone) )
        {
          auto br_wlt16 = [](auto w)
            {
              return
              eve::reverse_horner(w, T(0x1.8abcc380d5a48p+1), T(0x1.0158a6d641d39p+0), T(0x1.5ffcfe5b76afcp-8)
          ...
          if( eve::any(notdone) )
          {
            auto br_wge16 = [](auto w)
              {
                return
                eve::reverse_horner(w, T(0x1.3664ddd1ad7fbp+2), T(0x1.02a30d1fba0dcp+0), T(-0x1.22ea5df04047cp-13)
