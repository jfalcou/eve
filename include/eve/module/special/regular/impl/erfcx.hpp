...
namespace eve::detail
{
  ...
  erfcx_(EVE_REQUIRES(cpu_), O const&, T x) 
  {
    ...
    {
      p =
        eve::reverse_horner(q, T(0x1.1ba03ap-2f), T(-0x1.7bf5cep-4f), T(-0x1.54081ap-3f)
    ...
    {
      p =
        eve::reverse_horner(q, T(0x1.dd2c8b74febf6p-3), T(-0x1.1df1ad154a27fp-3), T(0x1.f7f5df66fc349p-7)
