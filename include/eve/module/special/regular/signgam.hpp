...
//! **Return value**
//!
//! Returns [elementwise](@ref glossary_elementwise) the sign of \f$\displaystyle
//! \Gamma(x)=\int_0^\infty t^{x-1}e^{-t}\mbox{d}t\f$
//!
...
//!  **Return value**
//!
//!  A Callable object so that the expression `signgam[cond](x, ...)` is equivalent to
//!  `if_else(cond,signgam(x, ...),x)`
//!
//! ---
//!
