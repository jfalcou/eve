...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_COMMON_SIMD_EXPM1_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_COMMON_SIMD_EXPM1_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  requires(T, behave_as<floating_point, T>, vectorized<T>)
  {
    ...
    else if constexpr(is_aggregated_v<t_abi> ) return aggregate(eve::expm1, xx);
    else
    {
