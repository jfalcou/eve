...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_COMMON_BITWISE_OR_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_COMMON_BITWISE_OR_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto bitwise_or_(EVE_SUPPORTS(simd_),
                                   ...
                                   U const &v1) noexcept requires(wide<T, N, emulated_>,
                                                                  Convertible<U, T>)
  {
    return map(eve::bitwise_or, v0, T(v1));
  }

  template<typename T, typename N, typename U>
  EVE_FORCEINLINE auto
  bitwise_or_(EVE_SUPPORTS(simd_),
              U const &                    v0,
              wide<T, N, emulated_> const &v1) noexcept requires(wide<T, N, emulated_>,
                                                                 Convertible<U, T>)
  {
    return map(eve::bitwise_or, T(v0), v1);
  }
  ...
  EVE_FORCEINLINE auto bitwise_or_(EVE_SUPPORTS(simd_),
                                   ...
                                   U const &              v1) noexcept requires(wide<T, N, ABI>,
                                                                  Convertible<U, T>)
  {
    return eve::bitwise_or(v0, wide<T, N, ABI>(v1));
  }
  ...
  {
    return eve::bitwise_or(v0, bitwise_cast<wide<U, M>>(v1));
  }
}
...
namespace eve
{
  ...
  {
    return eve::bitwise_or(v0, eve::bitwise_cast<wide<T0, N0, ABI>>(v1));
  }
