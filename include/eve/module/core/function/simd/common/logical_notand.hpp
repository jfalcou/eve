...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE constexpr auto logical_notand_(EVE_SUPPORTS(cpu_), T const &a, U const &b) noexcept
  ...
  template<typename T, typename U>
  EVE_FORCEINLINE constexpr auto logical_notand_( EVE_SUPPORTS(cpu_),
                                    ...
                                    )
  {
    ...
    return bitwise_cast<r_t>( bitwise_notand(bitwise_mask(a), bitwise_mask(b)) );
  }
}
