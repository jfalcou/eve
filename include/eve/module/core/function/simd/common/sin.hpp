...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_COMMON_SIN_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_COMMON_SIN_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  // small      abs(x) < pi/2
  // medium     abs(x) < 281474976710656.0
                            ...
                            , eve::wide<T,N,ABI> const &a0) noexcept
  {
    ...
    else if(all(x <= medthresh))      return medium_(sin)(a0);
    else
    {
      return big_(sin)(a0);
    }
