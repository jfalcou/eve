...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T,N,aggregated_> bitwise_notand_( EVE_SUPPORTS(simd_)
  ...
  EVE_FORCEINLINE auto bitwise_notand_ ( EVE_SUPPORTS(simd_)
                  ...
                  requires(wide<T,N,emulated_>, Convertible<U,T>)
  {
    return map( eve::bitwise_notand, T(v0), v1);
  }
  ...
  EVE_FORCEINLINE auto bitwise_notand_ ( EVE_SUPPORTS(simd_)
                  ...
                  requires(wide<T,N,ABI>, Convertible<U,T>)
  {
    return eve::bitwise_notand( wide<T,N,ABI>(v0), v1 );
  }
}
