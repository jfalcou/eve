...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto  sub_( EVE_SUPPORTS(simd_), wide<T,N,ABI> const& v0, U const& v1) noexcept
  ...
  template<typename T, typename N, typename ABI, typename U>
  EVE_FORCEINLINE auto  sub_( EVE_SUPPORTS(simd_), U const& v0, wide<T,N,ABI> const& v1) noexcept
                        requires( wide<T,N,ABI>, detail::Convertible<U,T> )
  {
