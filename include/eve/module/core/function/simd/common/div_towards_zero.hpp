...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_COMMON_DIV_TOWARDS_ZERO_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_COMMON_DIV_TOWARDS_ZERO_HPP_INCLUDED
...
namespace eve::detail
{
          ...
          )
  {
    ...
    {
      return map( eve::div, abi_cast<value_type_t<U>>(a), abi_cast<value_type_t<T>>(b), tzt_);
    }
      ...
      if constexpr(std::is_same_v<T, U>)
      {
        ...
        else if constexpr(std::is_signed_v<v_t>)
        {
          if constexpr(std::is_same_v<v_t, std::int64_t>)
          {
            ...
            auto q = eve::saturated_(eve::div)(a, bb);
          ...
          {
            return if_else(is_nez(b)
                          , saturated_(convert)(itrunc(convert(a, double_)/
