...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_COMMON_IFNOT_ELSE_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_COMMON_IFNOT_ELSE_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto ifnot_else_ ( EVE_SUPPORTS(simd_)
                                , wide<logical<U>, N, ABI> const& v0
                                , wide<T, N, ABI> const& v1
                                , wide<T, N, ABI> const& v2
                                ) noexcept
  {
    return bitwise_select( bitwise_mask(v0), v2, v1); 
  }
                                ...
                                ) noexcept
  {
    ...
    return bitwise_cast<t_t>(bitwise_select( bitwise_mask(v0), bitwise_mask(v2), bitwise_mask(v1))); 
  }
  ...
  {
    return ifnot_else(is_nez(v0), v1, v2); 
  }
  ...
  {
    return aggregate( eve::ifnot_else, v0, v1, v2);
  }
  ...
  template<typename U, typename T, typename N>
  EVE_FORCEINLINE  wide<T,N,emulated_> ifnot_else_ ( EVE_SUPPORTS(simd_)
                                                       , wide<U,N,emulated_> const& v0
                                                       , wide<T,N,emulated_> const& v1
                                                       , wide<T,N,emulated_> const& v2
                                                       ) noexcept
  {
    return map( eve::ifnot_else, v0, v1, v2);
  }
  ...
  ifnot_else_(EVE_SUPPORTS(simd_)
          , wide<T, N, ABI> const &v0
          , T const &v1
          , T const &v2) noexcept
  {
    return eve::ifnot_else(v0, wide<T, N>(v1), wide<T, N>(v2));
  }
  ...
  ifnot_else_(EVE_SUPPORTS(simd_)
          ...
          , U const &v2) noexcept
  {
    return eve::ifnot_else(v0, v1, wide<U, N>(v2));
  }
  ...
  {
    return eve::ifnot_else(v0, wide<U, N>(v1), v2);
  }
