...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_COMMON_IF_NAN_ELSE_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_COMMON_IF_NAN_ELSE_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  if_else_(EVE_SUPPORTS(simd_)
          ...
          ) noexcept requires(wide<U, N, ABI>, detail::Floating<U>)
  {
