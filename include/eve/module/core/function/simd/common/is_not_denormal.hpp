...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto is_not_denormal_(EVE_SUPPORTS(simd_),wide<T, N, ABI> const &v) noexcept
  {
  ...
  template<typename T, typename N, typename ABI>
  EVE_FORCEINLINE constexpr auto is_not_denormal_ ( EVE_SUPPORTS(simd_),
