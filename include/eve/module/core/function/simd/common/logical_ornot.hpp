...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto logical_ornot_(EVE_SUPPORTS(simd_),
                                    wide<T, N, ABI> const &v0,
                                    wide<T, N, ABI> const &v1) noexcept
  {
    return eve::bitwise_cast <as_logical_t<wide<T, N, ABI>>>(eve::bitwise_ornot(eve::bitwise_mask(v0), eve::bitwise_mask(v1))) ;
  }
  ...
  {
    return eve::logical_ornot(v0, wide<T, N, ABI>(static_cast<T>(v1)));
  }

  template<typename T, typename N, typename ABI, typename U>
  EVE_FORCEINLINE auto
  logical_ornot_(EVE_SUPPORTS(simd_),
            U const &              v0,
            wide<T, N, ABI> const &v1) noexcept requires(as_logical_t<wide<T, N, ABI>>,
                                                         detail::Convertible<U, T>)
  {
    return eve::logical_ornot(wide<T, N, ABI>(static_cast<T>(v0)), v1);
  }
  ...
  {
    return aggregate(eve::logical_ornot, v0, v1);
  }
  ...
  {
    return map(eve::logical_ornot, v0, v1);
  }
}
