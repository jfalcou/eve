...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_PPC_WIDE_CAST_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_PPC_WIDE_CAST_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<U,N> wide_cast_( EVE_SUPPORTS(vmx_),
