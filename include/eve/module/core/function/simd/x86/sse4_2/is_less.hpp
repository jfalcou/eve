...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_SSE4_2_IS_LESS_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_SSE4_2_IS_LESS_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto is_less_(EVE_SUPPORTS(sse4_2_),
                                 ...
                                 wide<T, N, sse_> const &v1) noexcept
  {
    ...
    {
      if constexpr(std::is_same_v<T, float>) return as_logical_t<t_t>(_mm_cmplt_ps(v0, v1));
      if constexpr(std::is_same_v<T, double>) return as_logical_t<t_t>(_mm_cmplt_pd(v0, v1));
    }
    else
    {
      ...
      if constexpr(std::is_unsigned_v<T>)
      {
        ...
        return bitwise_cast<l_t>(eve::is_less( bitwise_cast<s_t>(v0) - sm
