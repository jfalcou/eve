...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_X86_SSE4_2_IS_LESS_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_X86_SSE4_2_IS_LESS_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  is_less_(EVE_SUPPORTS(sse4_2_), wide<T, N, sse_> const &v0, wide<T, N, sse_> const &v1) noexcept
  {
