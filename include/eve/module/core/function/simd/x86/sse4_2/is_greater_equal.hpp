...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_X86_SSE4_2_IS_GREATER_EQUAL_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_X86_SSE4_2_IS_GREATER_EQUAL_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  is_greater_equal_(EVE_SUPPORTS(sse4_2_), wide<T, N, sse_> const &v0, wide<T, N, sse_> const &v1) noexcept
  {
    ...
    else
    {
      ...
      {
        t_t that = _mm_cmpgt_epi64(a1,a0);
