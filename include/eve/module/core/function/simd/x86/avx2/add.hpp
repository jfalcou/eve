...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_X86_AVX2_ADD_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_X86_AVX2_ADD_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T, N, avx_>
                  add_(EVE_SUPPORTS(avx2_), wide<T, N, avx_> const &v0, wide<T, N, avx_> const &v1) noexcept
  {
