...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_X86_SSE2_IS_NOT_GREATER_EQUAL_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_X86_SSE2_IS_NOT_GREATER_EQUAL_HPP_INCLUDED
                       ...
                       , wide<T, N, sse_> const &v1) noexcept
  {
    ...
    else
    {
      if constexpr(std::is_signed_v<T>)
      {
        ...
        if constexpr(sizeof(T) == 8)  return is_less(v0, v1); 
      }
      else
      {
        ...
        return eve::bitwise_cast<l_t>(
          eve::is_not_greater_equal(eve::bitwise_cast<s_t>(v0) - sm, eve::bitwise_cast<s_t>(v1) - sm));
      }
    }
  }
}
