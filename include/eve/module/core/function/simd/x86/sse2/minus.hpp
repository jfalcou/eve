...
namespace eve::detail
{
  ...
  // double
  template<typename N>
  EVE_FORCEINLINE wide<double,N,sse_> minus_( EVE_SUPPORTS(sse2_)
  ...
  // float
  template<typename N>
  EVE_FORCEINLINE wide<float,N,sse_> minus_ ( EVE_SUPPORTS(sse2_)
  ...
  template< typename T, typename N
          ...
          >
  EVE_FORCEINLINE wide<T,N,sse_> minus_ ( EVE_SUPPORTS(sse2_)
