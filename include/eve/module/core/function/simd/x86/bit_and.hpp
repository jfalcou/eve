...
namespace eve::detail
{
                                           ...
                                           , wide<T, N, sse_> const &v1) noexcept
  {
    ...
    else if constexpr(std::same_as<T, double>) return _mm_and_pd(v0, v1);
    else if constexpr(std::integral<T>)        return _mm_and_si128(v0, v1);
  }
                                           ...
                                           , wide<T, N, avx_> const &v1) noexcept
  {
    ...
    else if constexpr(std::integral<T>)
    {
      ...
      else return _mm256_castps_si256(_mm256_and_ps(_mm256_castsi256_ps(v0), _mm256_castsi256_ps(v1)));
    }
  }
}
