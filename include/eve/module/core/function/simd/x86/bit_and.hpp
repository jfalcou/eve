...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T, N, sse_>
                  bit_and_(EVE_SUPPORTS(sse2_), wide<T, N, sse_> const &v0, wide<T, N, sse_> const &v1) noexcept
  {
  ...
  EVE_FORCEINLINE wide<T, N, avx_>
                  bit_and_(EVE_SUPPORTS(avx_), wide<T, N, avx_> const &v0, wide<T, N, avx_> const &v1) noexcept
  {
