...
namespace eve::detail
{
  ...
  // double
  template<typename N>
  EVE_FORCEINLINE wide<double,N,avx_> add_( EVE_SUPPORTS(avx_)
  ...
  // float
  template<typename N>
  EVE_FORCEINLINE wide<float,N,avx_> add_ ( EVE_SUPPORTS(avx_)
  ...
  template< typename T, typename N
          ...
          >
  EVE_FORCEINLINE auto  add_( EVE_SUPPORTS(avx_)
