...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_X86_AVX_BITWISE_XOR_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_X86_AVX_BITWISE_XOR_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T, N, avx_>
                  bitwise_xor_(EVE_SUPPORTS(avx_), wide<T, N, avx_> const &v0, wide<T, N, avx_> const &v1) noexcept
  {
