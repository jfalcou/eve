...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_X86_AVX_IS_EQUAL_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_X86_AVX_IS_EQUAL_HPP_INCLUDED
...
namespace eve::detail
{
                                 ...
                                 wide<T, N, sse_> const &v1) noexcept
  {
    ...
    if constexpr( std::is_integral_v<T>   ) return is_equal_(EVE_RETARGET(sse4_1_),v0,v1);
  }
}
