...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_X86_AVX_BITWISE_AND_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_X86_AVX_BITWISE_AND_HPP_INCLUDED
...
namespace eve { namespace detail
{
                                              ...
                                              ) noexcept
  {
    ...
    if constexpr( std::is_integral_v<T>     )
      return _mm256_castps_si256( _mm256_and_ps ( _mm256_castsi256_ps(v0)
