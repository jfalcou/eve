...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_X86_FMA4_FNMS_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_X86_FMA4_FNMS_HPP_INCLUDED
...
# if defined(EVE_SUPPORTS_FMA4)
      ...
      if constexpr(std::is_same_v<T, float>)  return _mm_nmacc_ps(a, b, c);
# else
...
# if defined(EVE_SUPPORTS_XOP)
      ...
      else                                            return fnms_(EVE_RETARGET(sse4_1_),a, b, c);
# else
      return fnms_(EVE_RETARGET(sse4_1_),a, b, c);
# endif
    }
...
# if defined(EVE_SUPPORTS_FMA4)
      ...
      if constexpr(std::is_same_v<T, float>)  return _mm256_nmacc_ps(a, b, c);
# else
