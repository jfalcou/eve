...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_X86_BIT_CAST_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_X86_BIT_CAST_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<Target, M, sse_> bit_cast_(EVE_SUPPORTS(sse2_),
  ...
  // SSE2 supports logical bit casting
  template<typename Target, typename Source, typename N, typename M>
  EVE_FORCEINLINE logical<wide<Target, M, sse_>>
                  bit_cast_(EVE_SUPPORTS(sse2_),
                                wide<Source, N, sse_> const &              v0,
  ...
  template<typename Target, typename Source, typename N, typename M>
  EVE_FORCEINLINE wide<Target, M, avx_> bit_cast_(EVE_SUPPORTS(avx_),
  ...
  // AVX supports logical bit casting
  template<typename Target, typename Source, typename N, typename M>
  EVE_FORCEINLINE logical<wide<Target, M, avx_>>
                  bit_cast_(EVE_SUPPORTS(avx_),
                                wide<Source, N, avx_> const &              v0,
