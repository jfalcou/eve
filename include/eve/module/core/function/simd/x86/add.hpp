...
namespace eve::detail
{
  ...
  add_(EVE_SUPPORTS(sse2_), wide<T, N, sse_> v0, wide<T, N, sse_> const &v1) noexcept
  {
    return v0 += v1;
  }
  ...
  template<typename T, typename N> EVE_FORCEINLINE wide<T, N, avx_>
  add_(EVE_SUPPORTS(avx_), wide<T, N, avx_> v0, wide<T, N, avx_> const &v1) noexcept
  {
    return v0 += v1;
  }
