...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_X86_FMA3_FMS_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_X86_FMA3_FMS_HPP_INCLUDED
...
namespace eve::detail
{
                                                            ...
                                                            ) noexcept
  {
    if constexpr(std::is_floating_point_v<T>)
    {
      ...
      if constexpr(std::is_same_v<T, float>)  return _mm_fmsub_ps(a, b, c);
    }
    else
    {
                                                            ...
                                                            ) noexcept
  {
    if constexpr(std::is_floating_point_v<T>)
    {
      ...
      if constexpr(std::is_same_v<T, float>)  return _mm256_fmsub_ps(a, b, c);
    }
    else
    {
