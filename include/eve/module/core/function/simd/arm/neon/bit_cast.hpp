...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_ARM_NEON_BIT_CAST_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_ARM_NEON_BIT_CAST_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<Target, M, neon64_>
                  bit_cast_(EVE_SUPPORTS(neon128_),
...
// Dispatch to sub-functions
  ...
  // -----------------------------------------------------------------------------------------------
  // NEON supports logical bit casting
  template<typename Target, typename Source, typename N, typename M>
