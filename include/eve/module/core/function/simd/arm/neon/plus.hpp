...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_ARM_NEON_PLUS_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_ARM_NEON_PLUS_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T,N,neon64_> plus_ ( EVE_SUPPORTS(neon128_)
  ...
  template<typename T, typename N>
  EVE_FORCEINLINE wide<T,N,neon128_> plus_( EVE_SUPPORTS(neon128_)
