...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_ARM_NEON_FNMS_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_ARM_NEON_FNMS_HPP_INCLUDED
...
namespace eve::detail
{
                                          ...
                                          ) noexcept
  {
    ...
    if constexpr(is_signed_int && sizeof(T) == 8) return map(fnms, v0, v1, v2);
    ...
    if constexpr(is_unsigned_int && sizeof(T) == 8) return map(fnms, v0, v1, v2);
