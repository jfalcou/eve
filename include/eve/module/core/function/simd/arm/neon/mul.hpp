...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto mul_ ( EVE_SUPPORTS(neon128_),
                            ...
                            ) noexcept requires(wide<T, N, neon64_>, Arithmetic<U>)
  {
    return mul(v1, v0);
  }
                            ...
                            ) noexcept requires(wide<T, N, neon64_>, Arithmetic<U>)
  {
    ...
    if constexpr(is_signed_int && sizeof(T) == 8) return map(mul, v0, static_cast<T>(v1));
    ...
    if constexpr(is_signed_int && sizeof(T) == 1) return vmul_s8(v0, wide<T, N, neon64_>(v1));
    if constexpr(is_unsigned_int && sizeof(T) == 8) return map(mul, v0, static_cast<T>(v1));
    ...
    if constexpr(is_unsigned_int && sizeof(T) == 1) return vmul_u8(v0, wide<T, N, neon64_>(v1));
  }
  ...
  EVE_FORCEINLINE auto mul_ ( EVE_SUPPORTS(neon128_),
                            ...
                            ) noexcept requires(wide<T, N, neon128_>, Arithmetic<U>)
  {
    return mul(v1, v0);
  }
                            ...
                            ) noexcept requires(wide<T, N, neon128_>, Arithmetic<U>)
  {
    ...
    if constexpr(is_signed_int && sizeof(T) == 1) return vmulq_s8(v0, wide<T, N, neon128_>(v1));
    if constexpr(is_unsigned_int && sizeof(T) == 8) return map(mul, v0, static_cast<T>(v1));
    ...
    if constexpr(is_unsigned_int && sizeof(T) == 1) return vmulq_u8(v0, wide<T, N, neon128_>(v1));
  }
}
