...
namespace eve::detail
{
                                           ...
                                           wide<T, N, neon64_> const &v1) noexcept
  {
    ...
    if constexpr(is_signed_int && sizeof(T) == 8) return vmax_s64(v0, v1);
    ...
    if constexpr(is_unsigned_int && sizeof(T) == 8) return vmax_u64(v0, v1);
                                            ...
                                            wide<T, N, neon128_> const &v1) noexcept
  {
    ...
    if constexpr(is_signed_int && sizeof(T) == 8) return vmaxq_s64(v0, v1);
    ...
    if constexpr(is_unsigned_int && sizeof(T) == 8) return vmaxq_u64(v0, v1);
