...
namespace eve::detail
{
  ...
  bit_and_(EVE_SUPPORTS(neon128_), wide<T, N, neon64_> v0, wide<T, N, neon64_> const &v1) noexcept
  {
    return v0 &= v1;
  }
  ...
  bit_and_(EVE_SUPPORTS(neon128_),wide<T, N, neon128_> v0,wide<T, N, neon128_> const &v1) noexcept
  {
    return v0 &= v1;
  }
}
