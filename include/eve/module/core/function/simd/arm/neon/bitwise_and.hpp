...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SIMD_ARM_NEON_BITWISE_AND_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SIMD_ARM_NEON_BITWISE_AND_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T, N, neon64_> bitwise_and_(EVE_SUPPORTS(neon128_),
...
// Dispatch to sub-functions
  ...
  template<typename T, typename N>
  EVE_FORCEINLINE wide<T, N, neon128_> bitwise_and_(EVE_SUPPORTS(neon128_),
