...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_SCALAR_DIV_DOWNWARD_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_SCALAR_DIV_DOWNWARD_HPP_INCLUDED
...
#pragma warning(disable: 4723) // potential divide by 0
  ...
  {
    if constexpr(std::is_floating_point_v<T>) return floor(a0/a1);
    else if constexpr(std::is_signed_v<T>)
    {
      if constexpr(std::is_same_v<T, std::int64_t>)
      {
        ...
        if(a1)
        {
          ...
          auto r =a0-q*a1;
         if (is_nez(r)&&((a0^a1) <= 0)) return saturated_(dec)(q);
          return q;
        }
        else
