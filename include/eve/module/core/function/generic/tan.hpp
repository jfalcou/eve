...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_GENERIC_TAN_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_GENERIC_TAN_HPP_INCLUDED
...
namespace eve::detail
{
                                     ...
                                     , T a0) noexcept
  {
    ...
    else return apply_over(restricted_(tan), a0);
  }
                                      ...
                                      , T a0) noexcept
  {
    ...
    else return apply_over(small_(tan), a0);
  }
