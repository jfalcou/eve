...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_GENERIC_BINARIZE_C_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_GENERIC_BINARIZE_C_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto  binarize_c_(EVE_SUPPORTS(cpu_)
                           ...
                           ) noexcept
  {
    ...
    else                            return  eve::binarize_c(cond,Mone<value_type_t<T>>());
  }
