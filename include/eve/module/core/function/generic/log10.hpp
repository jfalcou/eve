...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_GENERIC_LOG10_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_GENERIC_LOG10_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE constexpr T log10_(EVE_SUPPORTS(cpu_), D const &, T a0) noexcept
