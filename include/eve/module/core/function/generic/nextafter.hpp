...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_GENERIC_NEXTAFTER_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE constexpr auto nextafter_(EVE_SUPPORTS(cpu_)
                                      , D const &
                                      , T const &a
                                      , U const &b ) noexcept
                                      ...
                                      , T const &b ) noexcept
  {
    if constexpr(scalar_value<T>)
    {
      ...
      {
        if (is_unordered(a, b)) return Nan(as(a));
      }
