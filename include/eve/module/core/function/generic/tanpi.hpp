...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_GENERIC_TANPI_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_GENERIC_TANPI_HPP_INCLUDED
...
namespace eve::detail
{
                                       ...
                                       , T x) noexcept
  {
    ...
    else return apply_over(restricted_(tanpi), x);
  }
                                       ...
                                       , T a0) noexcept
  {
    if constexpr(has_native_abi_v<T>)
    {
      ...
      { if (is_eqz(a0)) return a0;
        if (is_not_finite(x)|| (frac(x) == Half<T>())) return Nan<T>();
                                       ...
                                       , T const &a0) noexcept
  {
    ...
    {
      auto x =  abs(a0);
      if (all(eve::abs(x) <= T(0.25))) return restricted_(tanpi)(a0);
