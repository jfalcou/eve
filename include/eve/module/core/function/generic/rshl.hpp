...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_GENERIC_RSHL_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_GENERIC_RSHL_HPP_INCLUDED
...
namespace eve::detail
{
                            ...
                            , U const &a1) noexcept
  {
    ...
    else
    {
      ...
      {
#ifndef NDEBUG
      return if_else(is_gtz(a1), shl(a0, max(Zero(as(a1)), a1)), shr(a0, max(Zero(as(a1)), -a1)));
#else
