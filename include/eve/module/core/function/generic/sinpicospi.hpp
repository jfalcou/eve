...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_FUNCTION_GENERIC_SINPICOSPI_HPP_INCLUDED
#define EVE_MODULE_CORE_FUNCTION_GENERIC_SINPICOSPI_HPP_INCLUDED
...
namespace eve::detail
{
                                        ...
                                        , T a0) noexcept
  {
    ...
    else return apply_over2(restricted_(sinpicospi), a0);
  }
                                        ...
                                        , T a0) noexcept
  {
    if constexpr(has_native_abi_v<T>)
    {
      ...
      {
        if (x > Maxflint<T>()) return std::make_tuple(T{0}, T(1));
      }
      else
      {
                                        ...
                                        , T const &a0) noexcept
  {
    ...
    {
      auto x =  abs(a0);
      if (all(x <=  T(0.25)))     return restricted_(sinpicospi)(a0);
