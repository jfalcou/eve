...
namespace eve::_
{
  template <typename U, cardinal_type N>
  ...
  template<typename T, cardinal_type N> constexpr bool compress_sve_should_split()
  {
  ...
  template<relative_conditional_expr C, typename T, typename U, cardinal_type N>
  EVE_FORCEINLINE
