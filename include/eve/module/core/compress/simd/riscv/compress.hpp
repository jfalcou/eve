...
template<relative_conditional_expr C, typename T, cardinal_type N, typename U>
...
requires rvv_abi<abi_t<T, N>>
{
  ...
  logical<wide<T, N>> real_mask     = __riscv_vmand(c_mask, formated_mask, N);
  wide<T, N>          init {0};
  wide<T, N>          compressed      = __riscv_vcompress_tu(init, v, real_mask, N);
