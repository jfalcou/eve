...
//!    5. The product is computed in a 'round toward \f$-\infty\f$ mode. The result is guaranteed
...
//!    6. The product is computed in a 'round toward \f$\infty\f$ mode. The result is guaranteed
