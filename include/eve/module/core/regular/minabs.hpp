...
namespace eve
{
  ...
  struct minabs_t : elementwise_callable<minabs_t, Options, numeric_option, pedantic_option, saturated_option>
  {
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE constexpr auto minabs_(EVE_REQUIRES(cpu_), O const & o, Ts tup) noexcept
  {
    return kumi::apply( [&](auto... a) { return eve::minabs[o](a...); }, tup);
  }
}
