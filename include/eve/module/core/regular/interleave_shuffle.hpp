...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto interleave_shuffle_(EVE_SUPPORTS(cpu_), Wide a, Wide b) noexcept
  {
  ...
  EVE_FORCEINLINE auto interleave_shuffle_(EVE_SUPPORTS(cpu_), Wide a,U b) noexcept
  {
    return interleave_shuffle_(EVE_RETARGET(cpu_),a,Wide(b));
  }

  template<simd_value Wide, scalar_value U>
  EVE_FORCEINLINE auto interleave_shuffle_(EVE_SUPPORTS(cpu_),U a, Wide b) noexcept
  {
