...
//================================================================================================
  ...
  namespace detail
  {
    ...
    auto logical_and_(EVE_REQUIRES(cpu_), O const & o, T a, bool b) noexcept
    {
    ...
    EVE_FORCEINLINE constexpr
    auto logical_and_(EVE_REQUIRES(cpu_), O const & o, bool a, U b) noexcept
    {
    ...
    EVE_FORCEINLINE constexpr
    auto logical_and_(EVE_REQUIRES(cpu_), O const & o, bool a, bool b) noexcept
    { return a && b; }
  }
}
