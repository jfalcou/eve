...
//================================================================================================
  ...
  namespace _
  {
    ...
    constexpr auto cosine_similarity_(EVE_REQUIRES(emulated_), O const & o, Ts... ts) noexcept
    ...
    constexpr auto cosine_similarity_(EVE_REQUIRES(cpu_), O const & o, PT1 f, PT2 s) noexcept
