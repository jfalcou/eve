...
namespace eve
{
  ...
  namespace detail
  {
    ...
    EVE_FORCEINLINE constexpr common_logical_t<T, U> is_less_(EVE_REQUIRES(cpu_), O const&, logical<T> a, logical<U> b) noexcept
    {
    ...
    template<callable_options O, value T, value U>
    EVE_FORCEINLINE constexpr common_logical_t<T, U> is_less_(EVE_REQUIRES(cpu_), O const& o, T const& aa, U const& bb) noexcept
    {
