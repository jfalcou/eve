...
namespace eve
{
  ...
  struct bit_and_t : strict_tuple_callable<bit_and_t, Options>
  {
    ...
    {
      return EVE_DISPATCH_CALL_PT((as<bit_value_t<T0, T1>>{}), t0, t1);
    }
    ...
    {
      return EVE_DISPATCH_CALL_PT((as<bit_value_t<T0, T1, Ts...>>{}), t0, t1, ts...);
    }
    ...
    {
      return EVE_DISPATCH_CALL_PT((as<kumi::apply_traits_t<bit_value, Tup>>{}), t);
    }
...
//!   **Parameters**
//!
//!     * `x`: first [argument](@ref value).
//!     * `xs...`: other [arguments](@ref value).
