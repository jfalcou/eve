...
namespace eve
{
  ...
  //! #### Example
  //!
  //! @godbolt{doc/arithmetic/fnma.cpp}
  //!
  //!  @}
  //================================================================================================
...
#  include <eve/module/arithmetic/regular/impl/simd/x86/fnma.hpp>
#endif

#if defined(EVE_INCLUDE_ARM_HEADER)
#  include <eve/module/arithmetic/regular/impl/simd/arm/neon/fnma.hpp>
#endif
