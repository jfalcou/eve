...
namespace eve
{
  ...
  //!   * Masked Call
  //!
  //!     The call `eve;::is_not_infinite[mask](x)` provides a masked version of `eve::is_not_infinite` which is
  //!     equivalent to `if_else (mask, is_not_infinite(x), eve::false( eve::as(x)))`.
  //!
  //!      **Example**
  //!
