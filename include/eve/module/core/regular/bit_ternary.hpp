...
//================================================================================================
  ...
  namespace _
  {
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_1([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0x1b) return bit_not(bit_select(c, a, b));
      else if constexpr(K == 0x1c) return bit_notand(bit_and(a, c), bit_xor(a, b));
      else if constexpr(K == 0x1d) return bit_not(bit_select(b, a, c));
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_2([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0x27) return bit_not(bit_select(c, b, a));
      ...
      else if constexpr(K == 0x2e) return bit_select(b, bit_not(a), c);
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_3([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0x35) return bit_not(bit_select(a, b, c));
      ...
      else if constexpr(K == 0x3a) return bit_select(a, bit_not(b), c);
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_4([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0x47) return bit_not(bit_select(b, c, a));
      ...
      else if constexpr(K == 0x4e) return bit_select(c, bit_not(a), b);
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_5([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0x53) return bit_not(bit_select(a, c, b));
      ...
      else if constexpr(K == 0x5c) return bit_select(a, bit_not(c), b);
    ...
    { 
      ...
      else if constexpr(K == 0x72) return bit_select(c, bit_not(b), a);
      else if constexpr(K == 0x73) return bit_or(bit_notand(c, a), bit_not(b));
      else if constexpr(K == 0x74) return bit_select(b, bit_not(c), a);
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_8([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0x8b) return bit_select(b, c, bit_not(a));
      else if constexpr(K == 0x8c) return bit_notand(bit_notand(c, a), b);
      else if constexpr(K == 0x8d) return bit_select(c, b, bit_not(a));
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_a([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0xa3) return bit_select(a, c, bit_not(b));
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_b([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0xb2) return bit_or(bit_and(b, a, c),bit_notand(b, bit_or(a, c)));
      ...
      else if constexpr(K == 0xb8) return bit_select(b, c, a);
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_c([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0xc5) return bit_select(a, b, bit_not(c));
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_d([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0xd8) return bit_select(c, b, a);
    ...
    EVE_FORCEINLINE auto bit_ternary_lut_e([[maybe_unused]] T a, [[maybe_unused]] T b, [[maybe_unused]] T c)
    {
      ...
      else if constexpr(K == 0xe2) return bit_select(b, a, c);
                ...
                ) noexcept
    {
      ...
      constexpr std::uint8_t chunk = K >> 4;
           if constexpr (chunk == 0x0) return bit_cast(eve::_::bit_ternary_lut_0<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0x1) return bit_cast(eve::_::bit_ternary_lut_1<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0x2) return bit_cast(eve::_::bit_ternary_lut_2<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0x3) return bit_cast(eve::_::bit_ternary_lut_3<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0x4) return bit_cast(eve::_::bit_ternary_lut_4<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0x5) return bit_cast(eve::_::bit_ternary_lut_5<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0x6) return bit_cast(eve::_::bit_ternary_lut_6<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0x7) return bit_cast(eve::_::bit_ternary_lut_7<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0x8) return bit_cast(eve::_::bit_ternary_lut_8<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0x9) return bit_cast(eve::_::bit_ternary_lut_9<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0xa) return bit_cast(eve::_::bit_ternary_lut_a<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0xb) return bit_cast(eve::_::bit_ternary_lut_b<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0xc) return bit_cast(eve::_::bit_ternary_lut_c<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0xd) return bit_cast(eve::_::bit_ternary_lut_d<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0xe) return bit_cast(eve::_::bit_ternary_lut_e<K>(xa, xb, xc), as<T>());
      else if constexpr (chunk == 0xf) return bit_cast(eve::_::bit_ternary_lut_f<K>(xa, xb, xc), as<T>());
    }
  }
