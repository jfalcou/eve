...
//================================================================================================
  ...
  namespace _
  {
                ...
                ) noexcept
    {
      ...
      if constexpr (chunk == 0x1) return bit_cast(eve::_::bit_ternary_lut_1<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0x2) return bit_cast(eve::_::bit_ternary_lut_2<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0x3) return bit_cast(eve::_::bit_ternary_lut_3<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0x4) return bit_cast(eve::_::bit_ternary_lut_4<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0x5) return bit_cast(eve::_::bit_ternary_lut_5<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0x6) return bit_cast(eve::_::bit_ternary_lut_6<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0x7) return bit_cast(eve::_::bit_ternary_lut_7<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0x8) return bit_cast(eve::_::bit_ternary_lut_8<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0x9) return bit_cast(eve::_::bit_ternary_lut_9<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0xa) return bit_cast(eve::_::bit_ternary_lut_a<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0xb) return bit_cast(eve::_::bit_ternary_lut_b<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0xc) return bit_cast(eve::_::bit_ternary_lut_c<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0xd) return bit_cast(eve::_::bit_ternary_lut_d<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0xe) return bit_cast(eve::_::bit_ternary_lut_e<K>(xa, xb, xc), as<T>());
      if constexpr (chunk == 0xf) return bit_cast(eve::_::bit_ternary_lut_f<K>(xa, xb, xc), as<T>());
    }
  }
