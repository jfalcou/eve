  ...
  namespace detail
  {
    template<floating_value T> struct welford_cosine_similarity_result
    {
      ...
      void print(std::string s){
        std::cout << s << std::endl;
        std::cout << "x2 " << sumx2 << std::endl;
        std::cout << "y2 " << sumy2 << std::endl;
        std::cout << "xy " << sumxy << std::endl;
        std::cout << "sim " << cosine_similarity<< std::endl;
        std::cout << " =========== " << std::endl;
      };
...
//================================================================================================
  ...
  namespace detail
  {
    ...
    {
//      std::cout << "icitte simds" << std::endl;
    ...
    {
 //      std::cout << "icitte scalars" << std::endl;
    ...
    {
//       std::cout << "icitte tuples" << std::endl;
//      std::cout << " kumi::cat(t1, t2) " <<  kumi::cat(t1, t2)<< std::endl;
