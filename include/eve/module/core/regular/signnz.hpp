...
//!
//! For   [floating real value](@ref eve::floating_value) the positivity is only here based on the
//! bit of sign. In particular -0.0 is negative and +0.0 is positive.
//!
//! ---
//!
//!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
...
//!  **Return value**
//!
//!  A Callable object so that the expression `signnz[cond](x, ...)` is equivalent to
//!  `if_else(cond,signnz(x, ...),x)`
//!
//! ---
//!
