...
namespace eve
{
  ...
  namespace detail
  {
    ...
    EVE_FORCEINLINE constexpr as_logical_t<T> is_nez_(EVE_REQUIRES(cpu_), O const&, T const& a) noexcept
    {
...
#  include <eve/module/core/regular/impl/simd/x86/is_nez.hpp>
#endif

#if defined(EVE_INCLUDE_ARM_NEON_HEADER)
#  include <eve/module/core/regular/impl/simd/arm/neon/is_nez.hpp>
#endif
