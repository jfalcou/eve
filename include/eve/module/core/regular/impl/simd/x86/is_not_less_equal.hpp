...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE logical<wide<T, N>> is_not_less_equal_(EVE_REQUIRES(sse2_),
                                                              O          const &o,
                                                              wide<T, N> const &a,
...
// masked  implementation
  ...
  EVE_FORCEINLINE logical<wide<T, N>> is_not_less_equal_(EVE_REQUIRES(avx512_),
                                                               C          const& mask,
                                                               O          const& o,
                                                               wide<T, N> const& v,
  ...
  requires x86_abi<abi_t<T, N>>
  {
    ...
    {
      return is_not_less_equal.behavior(as<logical<wide<T, N>>>{}, cpu_{}, o, v, w);
    }
    else
    {
