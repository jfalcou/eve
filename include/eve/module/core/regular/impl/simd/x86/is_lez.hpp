...
namespace eve::detail
{
  ...
  is_lez_(EVE_REQUIRES(sse2_), O const &, wide<T, N> const& v) noexcept
  ...
  requires x86_abi<abi_t<T, N>>
  {
    ...
    constexpr auto f = fpclass::neg | fpclass::negzero | fpclass::poszero;
...
// masked  implementation
    ...
    requires x86_abi<abi_t<T, N>>
  {
    ...
    {
      return is_lez.behavior(cpu_{}, o, v, v);
    }
    else
    {
