...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE as_logical_t<wide<T, N>> is_not_less_(EVE_REQUIRES(sse2_), O const& o, wide<T, N> a, wide<T, N> b) noexcept
    requires x86_abi<abi_t<T, N>>
  {
    ...
    else
    {
      ...
      else return  is_greater_equal(a, b);
    }
  }
...
// masked  implementation
  ...
  EVE_FORCEINLINE as_logical_t<wide<T, N>> is_not_less_(EVE_REQUIRES(avx512_), C const& mask, O const& o, wide<T, N> a, wide<T, N> b) noexcept
    requires x86_abi<abi_t<T, N>>
  {
    ...
    else
    {
      ...
      else                                           return is_greater_equal[mask](a, b);
    }
  }
}
