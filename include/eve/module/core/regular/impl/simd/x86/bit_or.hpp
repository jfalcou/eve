...
namespace eve::_
{
  ...
  EVE_FORCEINLINE wide<T, N> bit_or_(EVE_REQUIRES(sse2_), O const&, wide<T, N> a, wide<T, N> b) noexcept
    requires x86_abi<abi_t<T, N>>
  {
    ...
    else  if constexpr  ( match(c, category::float16) ) return apply_fp16_as_u16(bit_or, a, b);
