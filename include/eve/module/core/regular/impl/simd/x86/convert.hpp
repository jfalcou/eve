...
namespace eve::detail
{
                                                  ...
                                                  ) noexcept
  {
    ...
    else if constexpr( sizeof(U)/sizeof(T) == 2 && N::value > 1)
    {
    ...
    else  if constexpr(c_in == int16x16 && sizeof(U) == 1) return _mm_packs_epi16 ( v.slice(lower_)
                                                                                  , v.slice(upper_)
                                                                                  );
    //==============================================================================================
    // 32 bits cases
    else  if constexpr( c_in == int32x4 && sizeof(U) == 2)  return  _mm_packs_epi32( v, v);
    else  if constexpr( c_in == int32x8 && sizeof(U) == 2)  return  _mm_packs_epi32( v.slice(lower_)
                                                                                   , v.slice(upper_)
                                                                                   );
    //==============================================================================================
