...
namespace eve::_
{
  ...
  template<std::uint8_t I, floating_scalar_value T, cardinal_type N, callable_options O>
...
// masked  implementation
  template<std::uint8_t I, conditional_expr C, floating_scalar_value T, cardinal_type N, callable_options O>
