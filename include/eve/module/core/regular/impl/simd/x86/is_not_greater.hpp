...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE logical<wide<T, N>> is_not_greater_(EVE_SUPPORTS(sse2_),
                                                      O          const & opts,
                                                      wide<T, N> const &a,
...
// masked  implementation
  ...
  EVE_FORCEINLINE as_logical_t<wide<T, N>> is_not_greater_(EVE_SUPPORTS(avx512_),
                                                           C          const& mask,
                                                           O          const& o,
                                                           wide<T, N> const& v,
  ...
  requires x86_abi<abi_t<T, N>>
  {
    ...
    else return is_less_equal[o](v, w);
  }
}
