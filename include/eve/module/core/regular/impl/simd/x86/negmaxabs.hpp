...
namespace eve::detail
{
  ...
  requires x86_abi<abi_t<T, N>>
  {
   if constexpr(O::contains(numeric) || O::contains(pedantic) || O::contains(saturated))
      return negmaxabs.behavior(as<wide<T, N>>{}, cpu_{}, opts, v0, v1);
    else
    {
      ...
      else return negmaxabs.behavior(as<wide<T, N>>{}, cpu_{}, opts, v0, v1);
    }
  }
  ...
  {
    if constexpr(O::contains(numeric) || O::contains(pedantic) || O::contains(saturated))
      return negmaxabs.behavior(as<wide<T, N>>{}, cpu_{}, opts, v, w);
    else
    {
      ...
      else return negmaxabs.behavior(as<wide<T, N>>{}, cpu_{}, opts, v, w);
    }
  }
}
