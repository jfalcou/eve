...
namespace eve::_
{
  ...
  template<conditional_expr C, integral_scalar_value T, typename S, size_type N, callable_options O>
  ...
  template<conditional_expr C, integral_scalar_value T, size_type N, callable_options O>
