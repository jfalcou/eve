...
namespace eve::_
{
template<typename T, typename S, cardinal_type N, callable_options O>
...
template<typename T, auto S, cardinal_type N, callable_options O>
...
template<conditional_expr C, typename T, typename S, cardinal_type N, callable_options O>
...
template<conditional_expr C, typename T, auto S, cardinal_type N, callable_options O>
