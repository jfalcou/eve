...
namespace eve::_
{
  template<auto S, floating_scalar_value T, size_type N, callable_options O>
  ...
  // -----------------------------------------------------------------------------------------------
  // Masked case
  template<auto S, conditional_expr C, floating_scalar_value T, size_type N, callable_options O>
  EVE_FORCEINLINE wide<T, N> fracscale_(EVE_REQUIRES(avx512_),
                                        C          const &mask,
                                        O          const &o,
                                        wide<T, N> const &a0,
