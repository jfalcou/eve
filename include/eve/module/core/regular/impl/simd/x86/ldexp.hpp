...
namespace eve::_
{
  template<floating_scalar_value T, value U, width_type N, callable_options O>
  ...
  template<floating_scalar_value T, value U, width_type N, conditional_expr C, callable_options O>
