...
namespace eve::_
{
  template<floating_scalar_value T, value U, size N, callable_options O>
  ...
  template<floating_scalar_value T, value U, size N, conditional_expr C, callable_options O>
