...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T, N> fms_(EVE_REQUIRES(avx2_), O const& opts, wide<T, N> a, wide<T, N> b, wide<T, N> c) noexcept
...
// Masked case
  ...
  EVE_FORCEINLINE wide<T, N> fms_(EVE_REQUIRES(avx512_), C const& mask, O const& opts, wide<T, N> a, wide<T, N> b, wide<T, N> c) noexcept
    requires x86_abi<abi_t<T, N>>
  {
