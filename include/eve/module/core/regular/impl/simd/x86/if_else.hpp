...
EVE_FORCEINLINE wide<T, N>
                if_else_(EVE_SUPPORTS(sse4_1_),
                         logical<wide<T, N>> const                &v0,
                         wide<T, N> const                         &v1,
                         wide<T, N> const                         &v2) noexcept requires x86_abi<abi_t<T, N>>
{
...
if_else_(EVE_SUPPORTS(sse2_),
         logical<wide<T, N>> const& v0,
         logical<wide<T, N>> const& v1,
         logical<wide<T, N>> const& v2) noexcept requires x86_abi<abi_t<T, N>>
{
  if constexpr( !abi_t<T, N>::is_wide_logical )
  {
