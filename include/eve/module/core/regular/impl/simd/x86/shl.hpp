...
namespace eve::_
{
  template<callable_options O, typename T, width_type N, integral_scalar_value S>
  ...
  template<callable_options O, conditional_expr C, integral_scalar_value T, typename S, width_type N>
  ...
  template<callable_options O, conditional_expr C, integral_scalar_value T, width_type N>
