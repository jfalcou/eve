  ...
  else
  {
    ...
    if constexpr( c == category::float32x16 )
      return ic(src,
                ...
                { return _mm512_mask_roundscale_ps(src, m, a, decltype(b)::value); });
      ...
      return ic(src,
                ...
                s,
                [](auto src, auto m, auto a, auto b)
                { return _mm512_mask_roundscale_pd(src, m, a, decltype(b)::value); });
      ...
      return ic(src,
                ...
                s,
                [](auto src, auto m, auto a, auto b)
                { return _mm256_mask_roundscale_ps(src, m, a, decltype(b)::value); });
      ...
      return ic(src,
                ...
                s,
                [](auto src, auto m, auto a, auto b)
                { return _mm256_mask_roundscale_pd(src, m, a, decltype(b)::value); });
      ...
      return ic(src,
                ...
                s,
                [](auto src, auto m, auto a, auto b)
                { return _mm_mask_roundscale_ps(src, m, a, decltype(b)::value); });
      ...
      return ic(src,
                ...
                s,
                [](auto src, auto m, auto a, auto b)
                { return _mm_mask_roundscale_pd(src, m, a, decltype(b)::value); });
  }
}
