...
namespace eve::_
{
template<relative_conditional_expr C, arithmetic_scalar_value T, width_type N>
...
template<relative_conditional_expr C, arithmetic_scalar_value T, width_type N, typename Lanes>
