...
namespace eve::_
{
template<relative_conditional_expr C, arithmetic_scalar_value T, cardinal_type N>
...
template<relative_conditional_expr C, arithmetic_scalar_value T, cardinal_type N, typename Lanes>
...
#else
template<relative_conditional_expr C, arithmetic_scalar_value T, cardinal_type S, cardinal_type Lanes>
