...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE std::optional<std::ptrdiff_t> last_true_(EVE_REQUIRES(neon128_), O const& opts, logical<wide<T, N>> v) noexcept
    requires std::same_as<abi_t<T, N>, arm_128_>
  {
    ...
    else return last_true.behavior(cpu_{}, opts, v);
  }
}
