...
namespace eve::_
{
  template<callable_options O, typename T, typename I, typename N>
   wide<T, N> lookup_(EVE_REQUIRES(neon128_), O const&, wide<T, N> a, wide<I, N> idx) noexcept
        ...
        else
        {
          if constexpr( sizeof(I) == 1 && sizeof(T) == 1 )
          {
            ...
            else
            {
              ...
              bytes_t     bi  = vcombine_u8(vtbl2_u8(lhi, vget_low_u8(idx)), vtbl2_u8(lhi, vget_high_u8(idx)));
          ...
          else
          {
            ...
            else
            {
              ...
              bytes_t i1 = bit_cast(bit_cast(bi, as<i_t>()) + i_t{offset<T>}, tgt_t());
