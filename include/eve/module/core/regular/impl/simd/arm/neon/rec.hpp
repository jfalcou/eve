...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T, N> rec_(EVE_SUPPORTS(neon128_), raw_type const &, wide<T, N> v) noexcept
  ...
  template<floating_real_scalar_value T, typename N>
  EVE_FORCEINLINE wide<T, N> rec_(EVE_SUPPORTS(neon128_), wide<T, N> v0) noexcept
      requires arm_abi<abi_t<T, N>>
  {
    return T{1} / v0;
  }
