...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T, N> fnma_(EVE_REQUIRES(sve_),O const&,wide<T, N> a, wide<T, N> b,wide<T, N> c) noexcept
  {
  ...
  requires sve_abi<abi_t<T, N>>
  EVE_FORCEINLINE wide<T, N> fnma_(EVE_REQUIRES(sve_), C cond, O const&, wide<T,N> a, wide<T,N> b, wide<T,N> c) noexcept
  {
    // We don't care about PEDANTIC as this is a proper FMA.
    // We don't care about PROMOTE as we only accept similar types.
