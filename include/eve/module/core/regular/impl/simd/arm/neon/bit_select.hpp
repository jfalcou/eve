...
namespace eve::_
{
  ...
  requires arm_abi<abi_t<T, N>>
  {
    ...
    else if constexpr( cat == category::float16x4 ) return vbsl_f16(vreinterpret_u16_f16(m), v0, v1);
    ...
    else if constexpr( cat == category::float16x8 ) return vbslq_f16(vreinterpretq_u16_f16(m), v0, v1);
