...
namespace eve::_
{
  ...
  template<callable_options O, integral_scalar_value T, width_type N, integral_scalar_value I>
  ...
  template<callable_options O, integral_scalar_value T, width_type N, std::ptrdiff_t S>
