...
namespace eve::_
{
  ...
  template<callable_options O, floating_scalar_value T, width_type N,  typename F>
  ...
  template<callable_options O, floating_scalar_value T, width_type N, conditional_expr C,  typename F>
