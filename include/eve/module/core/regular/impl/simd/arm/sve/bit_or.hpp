...
namespace eve::_
{
  template<callable_options O, typename T, typename N>
   wide<T, N> bit_or_(EVE_REQUIRES(sve_), O const&, wide<T, N> a, wide<T, N> b) noexcept
  ...
  template<callable_options O, conditional_expr C, typename T, typename N>
   wide<T, N> bit_or_(EVE_REQUIRES(sve_), C& cx, O const&, wide<T, N> a, wide<T, N> b) noexcept
