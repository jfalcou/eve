...
//================================================================================================
  ...
  else if constexpr( c_i == category::float64x1                               ) return map_pt(as<wide<U, N>>{}, convert, v, tgt);
...
//================================================================================================
  ...
  if constexpr( N {} <= 2 )
  {
    ...
    else if constexpr( sizeof(U) == 8                      ) return map_pt(as<wide<U, N>>{}, convert, v, tgt);
...
//================================================================================================
  ...
  else if constexpr ( std::is_floating_point_v<U>                                        ) return map_pt(as<wide<U, N>>{}, convert, v, tgt);
...
//================================================================================================
  ...
  else if constexpr( c_i == category::int32x2  && c_o == category::int64x1   ) return map_pt(as<wide<U, N>>{}, convert, v, tgt);
  else if constexpr( c_i == category::uint32x2 && c_o == category::uint64x1  ) return map_pt(as<wide<U, N>>{}, convert, v, tgt);
...
//================================================================================================
  ...
  else if constexpr( std::same_as<double, U> && current_api < asimd        ) return map_pt(as<wide<U, N>>{}, convert, v, tgt);
