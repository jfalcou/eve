...
template<typename N, arithmetic_scalar_value U>
 wide<U, N> convert_impl(EVE_REQUIRES(vsx_), wide<double, N> v, as<U> tgt) noexcept
...
template<typename N, arithmetic_scalar_value U>
 wide<U, N> convert_impl(EVE_REQUIRES(vmx_), wide<float, N> v, as<U> tgt) noexcept
...
template<integral_scalar_value T, typename N, arithmetic_scalar_value U>
 wide<U, N> convert_impl(EVE_REQUIRES(vmx_), wide<T, N> v, as<U> tgt) noexcept
