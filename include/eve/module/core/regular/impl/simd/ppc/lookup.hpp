...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T, N> lookup_(EVE_SUPPORTS(vmx_), wide<T, N> a, wide<I, N> idx) noexcept
    requires ppc_abi<abi_t<T, N>>
  {
    ...
    else
    {
      ...
      i1 = bit_cast(bit_cast(i1, as<wide<as_integer_t<T>, N>>()) + offset<T, false>, as<t8_t>());
