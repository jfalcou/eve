...
requires rvv_abi<abi_t<T, N>>
{
  ...
  if constexpr( match(c, category::uint_) ) return __riscv_vminu_tu(a, a, b, N::value);
}
    ...
    -> wide<T, N>
{
  ...
  if constexpr( match(c, category::int_) ) return __riscv_vmin_tumu(mask, v, v, w, N::value);
  if constexpr( match(c, category::uint_) ) return __riscv_vminu_tumu(mask, v, v, w, N::value);
}
