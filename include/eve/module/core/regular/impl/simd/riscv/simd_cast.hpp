...
template<scalar_value T, width_type N, scalar_value U, width_type M>
...
template<callable_options O, scalar_value T, width_type N, scalar_value U, width_type M>
EVE_FORCEINLINE logical<wide<U, M>>
...
template<width_type N, width_type M>
