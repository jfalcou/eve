...
template<scalar_value T, width_type N, scalar_value U, std::ptrdiff_t M>
...
template<callable_options O, scalar_value T, width_type N, scalar_value U, std::ptrdiff_t M>
EVE_FORCEINLINE logical<wide<U, M>>
...
template<width_type N, std::ptrdiff_t M>
