...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto maxabs_(EVE_SUPPORTS(cpu_), T const &a, U const &b) noexcept
  ...
  EVE_FORCEINLINE auto maxabs_(EVE_SUPPORTS(cpu_), T const &a, T const &b) noexcept
  ...
  EVE_FORCEINLINE auto maxabs_(EVE_SUPPORTS(cpu_), C const &cond, D const &
  ...
  EVE_FORCEINLINE auto maxabs_(EVE_SUPPORTS(cpu_), C const &cond, U const &t, V const &f) noexcept
      requires compatible_values<U, V>
  {
  ...
  common_compatible_t<T0,T1,Ts...> maxabs_(EVE_SUPPORTS(cpu_), T0 a0, T1 a1, Ts... args)
  {
    using r_t = common_compatible_t<T0,T1,Ts...>;
  ...
  common_compatible_t<T0,T1,Ts...> maxabs_(EVE_SUPPORTS(cpu_), C const & cond,
                                           T0 a0, T1 a1, Ts... args)
  {
