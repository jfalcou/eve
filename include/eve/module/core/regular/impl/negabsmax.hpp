...
namespace eve::detail
{
  ...
  {
    return mask_op(  cond, D()(eve::negabsmax), t, args...);
  }

  template<conditional_expr C, real_value U, real_value ...Ts>
  EVE_FORCEINLINE auto negabsmax_(EVE_SUPPORTS(cpu_), C const &cond, U const &t, Ts const &...args) noexcept
  {
    return mask_op(  cond, eve::negabsmax, t, args...);
  }
