...
logical_andnot_(EVE_SUPPORTS(cpu_), logical<T> const& a, logical<U> const& b) noexcept
{
...
EVE_FORCEINLINE as_logical_t<T>
logical_andnot_(EVE_SUPPORTS(cpu_), logical<T> const& a, logical<U> const& b) noexcept requires
...
EVE_FORCEINLINE as_logical_t<T>
                logical_andnot_(EVE_SUPPORTS(cpu_),
                                logical<T> const                &a,
...
EVE_FORCEINLINE auto
logical_andnot_(EVE_SUPPORTS(cpu_), T a, bool b) noexcept
{
...
EVE_FORCEINLINE auto
logical_andnot_(EVE_SUPPORTS(cpu_), bool a, U b) noexcept
{
  return a ? U {!b} : false_(as<U>());
}

EVE_FORCEINLINE auto
logical_andnot_(EVE_SUPPORTS(cpu_), bool a, bool b) noexcept
{
  return a && !b;
}
}
