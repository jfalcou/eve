...
namespace eve::_
{
  template<callable_options O, simd_value... Ts>
   constexpr auto fam_(EVE_REQUIRES(emulated_), O const& o, Ts const&... ts) noexcept
  ...
  template<typename T, typename U, typename V, callable_options O>
   constexpr auto fam_(EVE_REQUIRES(cpu_), O const& o, T const& a, U const& b, V const& c)
  {
     // PROMOTE ---------------------
  ...
  template<typename T, callable_options O>
   constexpr auto fam_(EVE_REQUIRES(cpu_), O const& o, T const& a, T const& b, T const& c)
  {
    // PROMOTE ---------------------
