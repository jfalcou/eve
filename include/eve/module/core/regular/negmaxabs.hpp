...
namespace eve
{
  ...
  struct negmaxabs_t : elementwise_callable<negmaxabs_t, Options, numeric_option, pedantic_option, saturated_option>
  {
...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE constexpr auto negmaxabs_(EVE_REQUIRES(cpu_), O const & o, Ts tup) noexcept
  {
    return kumi::apply( [&](auto... a) { return eve::negmaxabs[o](a...); }, tup);
  }
}
