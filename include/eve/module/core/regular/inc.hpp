...
//!      5. The increment is computed  in a 'round toward \f$\infty\f$ mode. The result is guaranteed
...
//================================================================================================
  ...
  namespace _
  {
    ...
    constexpr auto inc_(EVE_REQUIRES(emulated_), O const& o, T v) noexcept
    ...
    constexpr T inc_(EVE_REQUIRES(cpu_), O const& o, T const& a) noexcept
    {
      if constexpr(O::contains(mod))
      {
    ...
    constexpr T inc_(EVE_REQUIRES(cpu_), C cond, O const& o, T const& a) noexcept
    {
