...
namespace eve
{
  ...
  struct zip_t : callable<zip_t, Options>
  {
    ...
    {
      return EVE_DISPATCH_CALL_PT((kumi::tuple<Vs...>), vs...);
    }
    ...
    {
      return EVE_DISPATCH_CALL_PT((Target), tgt, vs...);
    }
    ...
    {
      return EVE_DISPATCH_CALL_PT((as_wide_as_t<kumi::tuple<element_type_t<V0>, element_type_t<Vs>...>, V0>), v0, vs...);
    }
    ...
    {
      return EVE_DISPATCH_CALL_PT((wide<Target, cardinal_t<V0>>), tgt, v0, vs...);
    }
