...
//!     * `sz`: An eve::lanes instance indicating how many lanes to broadcast to.
//!
//!   **Return value**
//!     1. A [SIMD value](@ref eve::simd_value) equals to `eve::as_wide_t<T>{v}`.
//!     2. A [SIMD value](@ref eve::simd_value) equals to `eve::as_wide_t<T,N>{v}`.
//!     3. A [SIMD value](@ref eve::simd_value) equals to `T{v.get(I)}`.
//!     4. A [SIMD value](@ref eve::simd_value) equals to `eve::as_wide_t<T,N>{v.get(I)}`.
//!
//!   @groupheader{Example}
//!
