...
//================================================================================================
  ...
  namespace detail
  {
    template<callable_options O, typename T, integral_value N>
    EVE_FORCEINLINE constexpr T byte_swap_adjacent_(EVE_REQUIRES(cpu_), O const&, T const& x, N const & n) noexcept
    {
