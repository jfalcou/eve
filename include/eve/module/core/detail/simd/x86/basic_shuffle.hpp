...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto basic_shuffle_ ( EVE_SUPPORTS(sse2_)
  ...
  //================================================================================================
  template<typename T, typename N, shuffle_pattern Pattern>
  EVE_FORCEINLINE auto basic_shuffle_( EVE_SUPPORTS(sse2_), wide<T, N> const& v, Pattern const&)
  ...
  //================================================================================================
  template<typename T, typename N, shuffle_pattern Pattern>
  EVE_FORCEINLINE auto basic_shuffle_( EVE_SUPPORTS(avx_), wide<T,N> const& v, Pattern const&)
      requires x86_abi<abi_t<T, N>>
  {
    ...
    {
      return basic_shuffle_(EVE_RETARGET(sse2_), v, q);
    }
  }
}
