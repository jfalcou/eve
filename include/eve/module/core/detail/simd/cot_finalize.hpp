...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_DETAIL_SIMD_COMMON_COT_FINALIZE_HPP_INCLUDED
#define EVE_MODULE_CORE_DETAIL_SIMD_COMMON_COT_FINALIZE_HPP_INCLUDED
...
namespace eve::detail
{
                                                        ...
                                                        , wide<T, N, ABI> const & dxr = wide<T, N, ABI>(0)) noexcept
  {
    ...
    return if_else(abs(a0) < Eps<t_t>(), rec(a0), bitwise_xor(y, bitofsign(a0)));
  }
}
