...
**/
//==================================================================================================
#ifndef EVE_MODULE_CORE_DETAIL_GENERIC_EXP_KERNEL_HPP_INCLUDED
#define EVE_MODULE_CORE_DETAIL_GENERIC_EXP_KERNEL_HPP_INCLUDED
...
namespace eve::detail
{
  ...
  // Regular case
  template<typename T>
  EVE_FORCEINLINE constexpr auto exp_kernel(T x) noexcept
