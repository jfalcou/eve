...
namespace eve::algo
{
  namespace _
  {
    ...
    struct inclusive_scan_common
    {
      ...
      template<typename Traits, typename Rng, typename Op, typename Zero, typename U>
       void operator()(Traits tr, Rng &&rng, std::pair<Op, Zero> op_zero, U init) const
      {
  ...
  struct inclusive_scan_inplace_ : TraitsSupport
  {
    ...
    EVE_ABI void operator()(Rng&& rng, std::pair<Op, Zero> op_zero, U init) const
    {
    ...
    EVE_ABI void operator()(Rng&& rng, U init) const
    {
  ...
  struct inclusive_scan_to_ : TraitsSupport
  {
    ...
    EVE_ABI void operator()(R r, std::pair<Op, Zero> op_zero, U init) const
    {
    ...
    EVE_ABI auto operator()(R r, U init) const
    {
    ...
    EVE_ABI auto operator()(R1&& r1, R2&& r2, std::pair<Op, Zero> op_zero, U init) const
    {
    ...
    template <typename R1, typename R2, typename U>
      requires zip_to_range<R1, R2>
    EVE_ABI auto operator()(R1&& r1, R2&& r2, U init) const
    {
