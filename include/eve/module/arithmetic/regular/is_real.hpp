...
namespace eve
{
  ...
  //!  **Return value**
  //!
  //!  A Callable object so that the expression `is_real[cond](x)` is equivalent to
  //! `if_else(cond,is_real(x),false(as(is_real(x))))`
  //!
  //! ---
  //!
  ...
  //! #### Example
  //!
  //! @godbolt{doc/arithmetic/is_real.cpp}
  //!
  //!  @}
  //================================================================================================
...
#include <eve/module/arithmetic/regular/impl/is_real.hpp>
