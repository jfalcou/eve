...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE wide<T, N> negate_(EVE_SUPPORTS(ssse3_), wide<T, N> a0, wide<T, N> a1) noexcept
  ...
  template<signed_integral_scalar_value T, typename N>
  EVE_FORCEINLINE wide<T, N> negate_(EVE_SUPPORTS(avx2_), wide<T, N> a0, wide<T, N> a1) noexcept
