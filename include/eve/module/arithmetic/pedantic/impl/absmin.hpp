...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE auto absmin_(EVE_SUPPORTS(cpu_), pedantic_type const &, T const &a, U const &b) noexcept
  ...
  EVE_FORCEINLINE auto absmin_(EVE_SUPPORTS(cpu_), pedantic_type const &, T const &a, T const &b) noexcept
  {
  ...
  auto absmin_(EVE_SUPPORTS(cpu_), pedantic_type const &, T0 a0, T1 a1, Ts... args)
  {
