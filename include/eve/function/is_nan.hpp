...
namespace eve
{
  ...
  //! @var is_nan
  //!
  //! @brief Callable object performing the computation of the computation of the is_nan logical value.
  //!
  //!
  //! **Required header:**
  //!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
  ...
  //!  **Return value**
  //!
  //!  A Callable object so that the expression `is_nan[cond](x, ...)` is equivalent to `if_else(cond,is_nan(x, ...),x)`
  //!
  //! ---
  //!
