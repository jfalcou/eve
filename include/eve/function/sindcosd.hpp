...
namespace eve
{
  ...
  //!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  //!
  //! <br/>Callable object performing the computation of the simultaneous  computation of sin an cos of an argument in degrees.
  //!
  //! #### Members Functions
  //!
  //! | Member       | Effect                                                     |
  ...
  //!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  //!
  //!  Higher-order function generating a masked version of eve::sindcosd
  //!
  //!  **Parameters**
  //!
  ...
  //!  **Return value**
  //!
  //!  A Callable object so that the expression `sindcosd[cond](x, ...)` is equivalent to `if_else(cond,sindcosd(x, ...),x)`
  //!
  //! ---
  //!
