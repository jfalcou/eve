...
namespace eve
{
  ...
  //! @var is_real
  //!
  //! @brief Callable object performing the computation of the computation of the is_real logical value.
  //!
  //!
  //! **Required header:**
  //!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
  ...
  //!  **Return value**
  //!
  //!  A Callable object so that the expression `is_real[cond](x, ...)` is equivalent to `if_else(cond,is_real(x, ...),x)`
  //!
  //! ---
  //!
