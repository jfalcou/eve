...
namespace eve
{
  ...
  //!  * eve::pedantic
  //!
  //!     **Required header:** `#include <eve/function/pedantic/reverse_horner.hpp>`
  //!
  ...
  //!  * eve::numeric
  //!
  //!     **Required header:** `#include <eve/function/numeric/reverse_horner.hpp>`
  //!
...
#include <eve/module/real/polynomial/function/regular/generic/reverse_horner.hpp>
