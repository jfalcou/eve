...
namespace eve
{
  ...
  //!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  //!
  //! <br/>Callable object performing the computation of the computation of the is_not_flint logical value.
  //!
  //! #### Members Functions
  //!
  //! | Member       | Effect                                                     |
  ...
  //!  **Return value**
  //!
  //!  A Callable object so that the expression `is_not_flint[cond](x, ...)` is equivalent to `if_else(cond,is_not_flint(x, ...),x)`
  //!
  //! ---
  //!
