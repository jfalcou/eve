...
namespace eve
{
  ...
  //! **Return value**
  //!
  //!Returns the [element-wise](@ref glossary_elementwise) sinine of the input expressed in \f$\pi\f$ multiples.
  //!
  ...
  //!
  //!  As all direct trigonometric functions, `sinpi` supports the eve::restricted, eve::small, eve::medium and eve::big decorators. Click
