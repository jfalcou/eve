...
namespace eve
{
  ...
  //! **Return value**
  //!
  //!Returns the [element-wise](@ref glossary_elementwise) sine of the input.
  //!
  //!In particular:
  //!
  ...
  //!
  //!  As all direct trigonometric functions, `sin` supports the eve::restricted, eve::small, eve::medium and eve::big decorators. Click
