...
namespace eve
{
  ...
  //! @var asin
  //!
  //! @brief Callable object performing the computation of the  computation of asin.
  //!
  //!
  //! **Required header:**
  //!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
  ...
  //!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  //!
  //!  Higher-order function generating a masked version of eve::asin
  //!
  //!  **Parameters**
  //!
  ...
  //!  **Return value**
  //!
  //!  A Callable object so that the expression `asin[cond](x, ...)` is equivalent to `if_else(cond,asin(x, ...),x)`
  //!
  //! ---
  //!
  ...
  //!
  //! @include{lineno} doc/core/asin.cpp
  //!
  //!  @}
  //================================================================================================
