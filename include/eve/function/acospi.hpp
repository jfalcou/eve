...
namespace eve
{
  ...
  //!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  //!
  //! <br/>Callable object performing the computation of the  computation of acospi.
  //!
  //! #### Members Functions
  //!
  //! | Member       | Effect                                                     |
  ...
  //! **Return value**
  //!
  //!Returns the [element-wise](../../../glossary.html#elment-wise) value in $pi$ multiples of the arc cosine of the
  ...
  //!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  //!
  //!  Higher-order function generating a masked version of eve::acospi
  //!
  //!  **Parameters**
  //!
  ...
  //!  **Return value**
  //!
  //!  A Callable object so that the expression `acospi[cond](x, ...)` is equivalent to `if_else(cond,acospi(x, ...),x)`
  //!
  //! ---
  //!
