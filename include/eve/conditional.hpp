...
namespace eve
{
  ...
  EVE_FORCEINLINE ignore_last_ ignore_last(std::ptrdiff_t n) noexcept { return {n}; }
  ...
  EVE_FORCEINLINE keep_last_ keep_last(std::ptrdiff_t n) noexcept { return {n}; }
  ...
  EVE_FORCEINLINE ignore_first_ ignore_first(std::ptrdiff_t n) noexcept { return {n}; }
  ...
  EVE_FORCEINLINE keep_first_ keep_first(std::ptrdiff_t n) noexcept { return {n}; }
  ...
  EVE_FORCEINLINE keep_between_ keep_between(std::ptrdiff_t b, std::ptrdiff_t e) { return {b, e}; }
