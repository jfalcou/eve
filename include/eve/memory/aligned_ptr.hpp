...
namespace eve
{
  ...
  template< typename Type
          , width_type Lanes = expected_width_v<Type>
          >
  ...
  struct aligned_ptr
  {
    ...
    template<typename UType, width_type L>
  ...
  //================================================================================================
  template<std::size_t A, typename T, width_type Other>
  ...
  template<typename T, width_type A>  struct element_type<aligned_ptr<T,A>> { using type = T; };
  template<typename T>          struct element_type<aligned_ptr<T>>   { using type = T; };

  template<typename T1, width_type A1, typename T2, width_type A2>
  ...
  template<typename Type, width_type Lanes>
  aligned_ptr<Type, Lanes> operator-(aligned_ptr<Type, Lanes> const &p, width_type o) noexcept
  {
    auto that = p;
    return that -= o;
  }
  ...
  //! @param p      Pointer to realign
  //! @return An aligned_ptr holding the realigned pointer with the proper alignment constraint.
  //! @see previous_aligned_address(T*, Width)
  //================================================================================================
  template <typename T>
  ...
  //! @param p      Pointer to realign
  //! @return An aligned_ptr holding the realigned pointer with the proper alignment constraint.
  //! @see next_aligned_address(T*, Width)
  //================================================================================================
  template <typename T>
