...
namespace eve
{
  ...
  enum class x86        { x86_32, x86_64, none };
  ...
  struct platform
  {
    ...
    static constexpr x86 x86_flavor = x86::x86_64;
#elif defined(EVE_ARCH_IS_X86_32)
    static constexpr x86 x86_flavor = x86::x86_32;
#else
    static constexpr x86 x86_flavor = x86::none;
#endif
