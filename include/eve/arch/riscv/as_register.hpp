...
template<typename Type, typename Size, rvv_abi ABI> struct as_register<Type, Size, ABI>
{
  ...
  static consteval auto find_vint() {
    ...
    if constexpr ( lmul == 2 ) return find_vint_m2();
    if constexpr ( lmul == 4 ) return find_vint_m4();
    if constexpr ( lmul == 8 ) return find_vint_m8();
    if constexpr ( lmul == -2 ) return find_vint_mf2();
    if constexpr ( lmul == -4 ) return find_vint_mf4();
    if constexpr ( lmul == -8 ) return find_vint_mf8();
  }
  ...
  static consteval auto find_vuint() {
    ...
    if constexpr ( lmul == 2 ) return find_vuint_m2();
    if constexpr ( lmul == 4 ) return find_vuint_m4();
    if constexpr ( lmul == 8 ) return find_vuint_m8();
    if constexpr ( lmul == -2 ) return find_vuint_mf2();
    if constexpr ( lmul == -4 ) return find_vuint_mf4();
    if constexpr ( lmul == -8 ) return find_vuint_mf8();
  }
  ...
  static consteval auto find_vfloat() {
    ...
    if constexpr ( lmul == 2 ) return find_vfloat_m2();
    if constexpr ( lmul == 4 ) return find_vfloat_m4();
    if constexpr ( lmul == 8 ) return find_vfloat_m8();
    if constexpr ( lmul == -2 ) return find_vfloat_mf2();
    if constexpr ( lmul == -4 ) return find_vfloat_mf4();
