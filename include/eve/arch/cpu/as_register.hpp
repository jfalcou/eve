...
namespace eve
{
  ...
  namespace _
  {
    ...
    struct blob
    {
      static constexpr auto replication = Cardinal / expected_cardinal_v<Type>;

      using value_type                  = as_wide_t<Type, expected_cardinal_v<Type>>;
      using subvalue_type               = as_wide_t<Type, Cardinal / 2>;
...
template<std::size_t I, typename T, eve::cardinal_type N>
