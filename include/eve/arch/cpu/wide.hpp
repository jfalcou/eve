...
namespace eve
{
      ...
      , detail::wide_storage<as_register_t<Type, Size, ABI>>
  {
    ...
    EVE_FORCEINLINE
    wide(scalar_value auto v0, scalar_value auto v1, scalar_value auto... vs) noexcept
    ...
    // Bitwise operators
    //==============================================================================================
    friend EVE_FORCEINLINE auto operator~(wide const& v) noexcept { return detail::self_bitnot(v); }
