...
namespace eve::_
{
  ...
  consteval cardinal_type find_expected_cardinal()
  {
...
namespace eve
{
  ...
  constexpr inline cardinal_type expected_cardinal_v = _::find_expected_cardinal<Type, ABI>();
  ...
  //!
  //!   @ref eve::expected_cardinal_t is the exact width type of the register able to store
