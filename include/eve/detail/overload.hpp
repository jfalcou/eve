...
#define EVE_DECLARE_CALLABLE(TAG)                                                                  \
  ...
  {                                                                                                \
    ...
    {                                                                                              \
      ...
      {                                                                                            \
        return [cond = eve::if_(c)](auto const &...args)                                           \
                   EVE_LAMBDA_FORCEINLINE { return callable_object {}(cond, args...); };           \
      }                                                                                            \
                                                                                                   \
      ...
      {                                                                                            \
        ...
        {                                                                                          \
          check(delay_t {},                                                                        \
                ::eve::detail::types<std::decay_t<Arg>, tag::TAG> {},                              \
                std::forward<Args>(args)...);                                                      \
        }                                                                                          \
        else                                                                                       \
        {                                                                                          \
          check(delay_t {},                                                                        \
                ::eve::detail::types<tag::TAG> {},                                                 \
                std::forward<Arg>(d),                                                              \
                std::forward<Args>(args)...);                                                      \
        }                                                                                          \
                                                                                                   \
        return TAG(                                                                                \
            delay_t {}, EVE_CURRENT_API {}, std::forward<Arg>(d), std::forward<Args>(args)...);    \
      }                                                                                            \
    };                                                                                             \
  }                                                                                                \
  /**/
...
namespace eve
{
  ...
  template<typename Tag> struct supports_conditionnal : std::true_type
  {
  };
