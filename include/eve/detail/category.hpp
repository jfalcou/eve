...
namespace eve::detail
{
  enum class category : std::uint32_t
  {
    ...
    // All known native ?int8
     int8x8   =  int_ | size8_ | 8  ,
     int8x16  =  int_ | size8_ | 16 ,
     int8x32  =  int_ | size8_ | 32 ,
     int8x64  =  int_ | size8_ | 64 ,
    uint8x8   = uint_ | size8_ | 8  ,
    uint8x16  = uint_ | size8_ | 16 ,
    uint8x32  = uint_ | size8_ | 32 ,
    uint8x64  = uint_ | size8_ | 64 ,

    // All known native ?int16
     int16x4    =   int_ | size16_ | 4  ,
     int16x8    =   int_ | size16_ | 8  ,
     int16x16   =   int_ | size16_ | 16 ,
     int16x32   =   int_ | size16_ | 32 ,
    uint16x4    =  uint_ | size16_ | 4  ,
    uint16x8    =  uint_ | size16_ | 8  ,
    uint16x16   =  uint_ | size16_ | 16 ,
    uint16x32   =  uint_ | size16_ | 32 ,

    // All known native ?int32
     int32x2    =   int_ | size32_ | 2  ,
     int32x4    =   int_ | size32_ | 4  ,
     int32x8    =   int_ | size32_ | 8  ,
     int32x16   =   int_ | size32_ | 16 ,
    uint32x2    =  uint_ | size32_ | 2  ,
    uint32x4    =  uint_ | size32_ | 4  ,
    uint32x8    =  uint_ | size32_ | 8  ,
    uint32x16   =  uint_ | size32_ | 16 ,

    // All known native ?int64
     int64x1    =   int_ | size64_ | 1,
     int64x2    =   int_ | size64_ | 2,
     int64x4    =   int_ | size64_ | 4,
     int64x8    =   int_ | size64_ | 8,
    uint64x1    =  uint_ | size64_ | 1,
    uint64x2    =  uint_ | size64_ | 2,
    uint64x4    =  uint_ | size64_ | 4,
    uint64x8    =  uint_ | size64_ | 8
  };
