...
shuffle_l4_l5_neon_reverse(P, lanes_t<G>, wide<T, N> x)
{
...
template<typename P, arithmetic_scalar_value T, width_type N, std::ptrdiff_t G>
EVE_FORCEINLINE auto
shuffle_l4_neon_extract_dup(P, lanes_t<G>, wide<T, N> x)
{
...
template<typename P, arithmetic_scalar_value T, width_type N, std::ptrdiff_t G>
EVE_FORCEINLINE auto
shuffle_l4_l5_(EVE_SUPPORTS(neon128_), P p, lanes_t<G> g, wide<T, N> x)
