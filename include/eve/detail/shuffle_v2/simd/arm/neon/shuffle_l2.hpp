...
template<typename T, cardinal_type N, std::ptrdiff_t S>
...
template<typename T, cardinal_type N, std::ptrdiff_t To, std::ptrdiff_t From>
EVE_FORCEINLINE auto
...
template<typename P, arithmetic_scalar_value T, cardinal_type N, std::ptrdiff_t G>
EVE_FORCEINLINE auto
