...
namespace eve::_
{
  ...
  template<callable_options O, typename T, cardinal_type N, typename Slice>
  ...
  template<callable_options O, arithmetic_scalar_value T, cardinal_type N, typename Slice>
