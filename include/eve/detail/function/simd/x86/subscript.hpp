...
namespace eve::_
{
  ...
  template<callable_options O, typename T, typename N>
   logical<T> extract_(EVE_REQUIRES(sse2_), O const&, logical<wide<T,N>> p, std::size_t i) noexcept
  ...
  //================================================================================================
  template<callable_options O, typename T, typename N>
   void insert_(EVE_REQUIRES(sse2_), O const&, logical<wide<T,N>>& p, std::size_t i, auto v) noexcept
    requires x86_abi<abi_t<T, N>>
  {
    if constexpr( !abi_t<T, N>::is_wide_logical )
    {
