...
requires rvv_abi<abi_t<T, N>>
{
  ...
  if constexpr( match(c, category::int64) )
  {
    if constexpr( out_lmul == 2 ) return __riscv_vlmul_ext_i64m2(a);
    if constexpr( out_lmul == 4 ) return __riscv_vlmul_ext_i64m4(a);
    if constexpr( out_lmul == 8 ) return __riscv_vlmul_ext_i64m8(a);
  }
  if constexpr( match(c, category::uint64) )
  {
    if constexpr( out_lmul == 2 ) return __riscv_vlmul_ext_u64m2(a);
    if constexpr( out_lmul == 4 ) return __riscv_vlmul_ext_u64m4(a);
    if constexpr( out_lmul == 8 ) return __riscv_vlmul_ext_u64m8(a);
  }
  if constexpr( match(c, category::float32) )
  {
    if constexpr( out_lmul == 1 ) return __riscv_vlmul_ext_f32m1(a);
    if constexpr( out_lmul == 2 ) return __riscv_vlmul_ext_f32m2(a);
    if constexpr( out_lmul == 4 ) return __riscv_vlmul_ext_f32m4(a);
    if constexpr( out_lmul == 8 ) return __riscv_vlmul_ext_f32m8(a);
  }
  if constexpr( match(c, category::int32) )
  {
    if constexpr( out_lmul == 1 ) return __riscv_vlmul_ext_i32m1(a);
    if constexpr( out_lmul == 2 ) return __riscv_vlmul_ext_i32m2(a);
    if constexpr( out_lmul == 4 ) return __riscv_vlmul_ext_i32m4(a);
    if constexpr( out_lmul == 8 ) return __riscv_vlmul_ext_i32m8(a);
  }
  if constexpr( match(c, category::uint32) )
  {
    if constexpr( out_lmul == 1 ) return __riscv_vlmul_ext_u32m1(a);
    if constexpr( out_lmul == 2 ) return __riscv_vlmul_ext_u32m2(a);
    if constexpr( out_lmul == 4 ) return __riscv_vlmul_ext_u32m4(a);
    if constexpr( out_lmul == 8 ) return __riscv_vlmul_ext_u32m8(a);
  }
  if constexpr( match(c, category::int16) )
  {
    if constexpr( out_lmul == -2 ) return __riscv_vlmul_ext_i16mf2(a);
    if constexpr( out_lmul == 1 ) return __riscv_vlmul_ext_i16m1(a);
    if constexpr( out_lmul == 2 ) return __riscv_vlmul_ext_i16m2(a);
    if constexpr( out_lmul == 4 ) return __riscv_vlmul_ext_i16m4(a);
    if constexpr( out_lmul == 8 ) return __riscv_vlmul_ext_i16m8(a);
  }
  if constexpr( match(c, category::uint16) )
  {
    if constexpr( out_lmul == -2 ) return __riscv_vlmul_ext_u16mf2(a);
    if constexpr( out_lmul == 1 ) return __riscv_vlmul_ext_u16m1(a);
    if constexpr( out_lmul == 2 ) return __riscv_vlmul_ext_u16m2(a);
    if constexpr( out_lmul == 4 ) return __riscv_vlmul_ext_u16m4(a);
    if constexpr( out_lmul == 8 ) return __riscv_vlmul_ext_u16m8(a);
  }
  if constexpr( match(c, category::int8) )
  {
    if constexpr( out_lmul == -4 ) return __riscv_vlmul_ext_i8mf4(a);
    if constexpr( out_lmul == -2 ) return __riscv_vlmul_ext_i8mf2(a);
    if constexpr( out_lmul == 1 ) return __riscv_vlmul_ext_i8m1(a);
    if constexpr( out_lmul == 2 ) return __riscv_vlmul_ext_i8m2(a);
    if constexpr( out_lmul == 4 ) return __riscv_vlmul_ext_i8m4(a);
    if constexpr( out_lmul == 8 ) return __riscv_vlmul_ext_i8m8(a);
  }
  if constexpr( match(c, category::uint8) )
  {
    if constexpr( out_lmul == -4 ) return __riscv_vlmul_ext_u8mf4(a);
    if constexpr( out_lmul == -2 ) return __riscv_vlmul_ext_u8mf2(a);
    if constexpr( out_lmul == 1 ) return __riscv_vlmul_ext_u8m1(a);
    if constexpr( out_lmul == 2 ) return __riscv_vlmul_ext_u8m2(a);
...
EVE_FORCEINLINE wide<U, N>
                bit_cast_(EVE_SUPPORTS(rvv_), wide<T, N> const                &x, as<wide<U, N>> const&) noexcept
         ...
         && (sizeof(T) * N::value == sizeof(U) * N::value)
{
  ...
  if constexpr( match(out_c, category::float64) )
  {
    ...
    if constexpr( out_lmul == 2 ) return __riscv_vreinterpret_f64m2(x);
    if constexpr( out_lmul == 4 ) return __riscv_vreinterpret_f64m4(x);
    if constexpr( out_lmul == 8 ) return __riscv_vreinterpret_f64m8(x);
  }
  if constexpr( match(out_c, category::int64) )
  {
    if constexpr( out_lmul == 1 ) return __riscv_vreinterpret_i64m1(x);
    if constexpr( out_lmul == 2 ) return __riscv_vreinterpret_i64m2(x);
    if constexpr( out_lmul == 4 ) return __riscv_vreinterpret_i64m4(x);
    if constexpr( out_lmul == 8 ) return __riscv_vreinterpret_i64m8(x);
  }
  if constexpr( match(out_c, category::uint64) )
  {
    if constexpr( out_lmul == 1 ) return __riscv_vreinterpret_u64m1(x);
    if constexpr( out_lmul == 2 ) return __riscv_vreinterpret_u64m2(x);
    if constexpr( out_lmul == 4 ) return __riscv_vreinterpret_u64m4(x);
    if constexpr( out_lmul == 8 ) return __riscv_vreinterpret_u64m8(x);
  }
  if constexpr( match(out_c, category::float32) )
  {
    if constexpr( out_lmul == -2 ) return __riscv_vreinterpret_f32mf2(x);
    if constexpr( out_lmul == 1 ) return __riscv_vreinterpret_f32m1(x);
    if constexpr( out_lmul == 2 ) return __riscv_vreinterpret_f32m2(x);
    if constexpr( out_lmul == 4 ) return __riscv_vreinterpret_f32m4(x);
    if constexpr( out_lmul == 8 ) return __riscv_vreinterpret_f32m8(x);
  }
  if constexpr( match(out_c, category::int32) )
  {
    if constexpr( out_lmul == -2 ) return __riscv_vreinterpret_i32mf2(x);
    if constexpr( out_lmul == 1 ) return __riscv_vreinterpret_i32m1(x);
    if constexpr( out_lmul == 2 ) return __riscv_vreinterpret_i32m2(x);
    if constexpr( out_lmul == 4 ) return __riscv_vreinterpret_i32m4(x);
    if constexpr( out_lmul == 8 ) return __riscv_vreinterpret_i32m8(x);
  }
  if constexpr( match(out_c, category::uint32) )
  {
    if constexpr( out_lmul == -2 ) return __riscv_vreinterpret_u32mf2(x);
    if constexpr( out_lmul == 1 ) return __riscv_vreinterpret_u32m1(x);
    if constexpr( out_lmul == 2 ) return __riscv_vreinterpret_u32m2(x);
    if constexpr( out_lmul == 4 ) return __riscv_vreinterpret_u32m4(x);
    if constexpr( out_lmul == 8 ) return __riscv_vreinterpret_u32m8(x);
  }
  if constexpr( match(out_c, category::int16) )
  {
    if constexpr( out_lmul == -4 ) return __riscv_vreinterpret_i16mf4(x);
    if constexpr( out_lmul == -2 ) return __riscv_vreinterpret_i16mf2(x);
    if constexpr( out_lmul == 1 ) return __riscv_vreinterpret_i16m1(x);
    if constexpr( out_lmul == 2 ) return __riscv_vreinterpret_i16m2(x);
    if constexpr( out_lmul == 4 ) return __riscv_vreinterpret_i16m4(x);
    if constexpr( out_lmul == 8 ) return __riscv_vreinterpret_i16m8(x);
  }
  if constexpr( match(out_c, category::uint16) )
  {
    if constexpr( out_lmul == -4 ) return __riscv_vreinterpret_u16mf4(x);
    if constexpr( out_lmul == -2 ) return __riscv_vreinterpret_u16mf2(x);
    if constexpr( out_lmul == 1 ) return __riscv_vreinterpret_u16m1(x);
    if constexpr( out_lmul == 2 ) return __riscv_vreinterpret_u16m2(x);
    if constexpr( out_lmul == 4 ) return __riscv_vreinterpret_u16m4(x);
    if constexpr( out_lmul == 8 ) return __riscv_vreinterpret_u16m8(x);
  }
  if constexpr( match(out_c, category::int8) )
  {
    if constexpr( out_lmul == -8 ) return __riscv_vreinterpret_i8mf8(x);
    if constexpr( out_lmul == -4 ) return __riscv_vreinterpret_i8mf4(x);
    if constexpr( out_lmul == -2 ) return __riscv_vreinterpret_i8mf2(x);
    if constexpr( out_lmul == 1 ) return __riscv_vreinterpret_i8m1(x);
    if constexpr( out_lmul == 2 ) return __riscv_vreinterpret_i8m2(x);
    if constexpr( out_lmul == 4 ) return __riscv_vreinterpret_i8m4(x);
    if constexpr( out_lmul == 8 ) return __riscv_vreinterpret_i8m8(x);
  }
  if constexpr( match(out_c, category::uint8) )
  {
    if constexpr( out_lmul == -8 ) return __riscv_vreinterpret_u8mf8(x);
    if constexpr( out_lmul == -4 ) return __riscv_vreinterpret_u8mf4(x);
    if constexpr( out_lmul == -2 ) return __riscv_vreinterpret_u8mf2(x);
    if constexpr( out_lmul == 1 ) return __riscv_vreinterpret_u8m1(x);
    if constexpr( out_lmul == 2 ) return __riscv_vreinterpret_u8m2(x);
    if constexpr( out_lmul == 4 ) return __riscv_vreinterpret_u8m4(x);
    if constexpr( out_lmul == 8 ) return __riscv_vreinterpret_u8m8(x);
  }
}
...
EVE_FORCEINLINE wide<U, M>
                bit_cast_(EVE_SUPPORTS(rvv_), wide<T, N> const                &x, as<wide<U, M>> const&) noexcept
         ...
         && same_raw_wide_size<T, N, U, M>
{
  ...
  if constexpr( match(out_c, category::float32) )
  {
    ...
    if constexpr( out_lmul == 4 )
    {
      auto casted_to_32 = bit_cast(x, as<wide<std::int32_t, M>> {});
      return __riscv_vreinterpret_f32m4(casted_to_32);
    }
    if constexpr( out_lmul == 8 )
    {
      auto casted_to_32 = bit_cast(x, as<wide<std::int32_t, M>> {});
...
template<scalar_value T, typename N, scalar_value U, typename M>
EVE_FORCEINLINE wide<U, M>
                bit_cast_(EVE_SUPPORTS(rvv_),
                          kumi::tuple<eve::wide<T, N>> const                &x,
...
bit_cast_(EVE_SUPPORTS(rvv_),
          kumi::tuple<logical<eve::wide<T, N>>> const& x,
         ...
         && same_raw_wide_size<T, N, U, M>
{
  ...
  {
    // static_assert(!match(out_c, category::float_));
         ...
         && (sizeof(T) * N::value < sizeof(U) * M::value)
{
  ...
  if constexpr( is_aggregated_v<abi_t<T, typename N::combined_type>>
    ...
    static_assert(false);
  auto extended_in = riscv_lmul_ext(x);
  for( auto id = N::value; id < N::combined_type::value; ++id )
    extended_in.set(id, static_cast<T>(0));
  return bit_cast(extended_in, to_as);
}
template<scalar_value T, typename N, scalar_value U, typename M>
EVE_FORCEINLINE wide<U, M>
bit_cast_(EVE_SUPPORTS(rvv_), wide<T, N> const& x, as<wide<U, M>> const& to_as) noexcept
...
{
  if constexpr( is_aggregated_v<abi_t<T, N>> || is_aggregated_v<abi_t<U, M>> ) static_assert(false);
  if constexpr( is_aggregated_v<abi_t<T, typename N::split_type>> || is_aggregated_v<abi_t<U, M>> )
    static_assert(false);
  auto wider_res = bit_cast(x, as<wide<U, typename M::combined_type>> {});
  auto to_ret    = riscv_lmul_trunc(wider_res);
  return to_ret;
}
...
bit_cast_(EVE_SUPPORTS(rvv_), wide<T, N> const& x, as<logical<wide<U, M>>> const& tgt) noexcept
requires rvv_abi<abi_t<T, N>> && rvv_abi<abi_t<U, M>>
{
  constexpr auto in_lmul = riscv_rvv_dyn_::getLMUL<T>(N::value);
...
template<scalar_value T, typename N, scalar_value U, typename M>
EVE_FORCEINLINE wide<U, M>
bit_cast_(EVE_SUPPORTS(rvv_), logical<wide<T, N>> const& x, as<wide<U, M>> const&) noexcept
requires rvv_abi<abi_t<T, N>>
{
  constexpr auto out_lmul = riscv_rvv_dyn_::getLMUL<U>(M::value);
  ...
  if constexpr( match(c, category::uint64) ) return __riscv_vreinterpret_u64m1(x);
  if constexpr( match(c, category::int32) ) return __riscv_vreinterpret_i32m1(x);
  if constexpr( match(c, category::uint32) ) return __riscv_vreinterpret_u32m1(x);
  if constexpr( match(c, category::int16) ) return __riscv_vreinterpret_i16m1(x);
  if constexpr( match(c, category::uint16) ) return __riscv_vreinterpret_u16m1(x);
  if constexpr( match(c, category::int8) ) return __riscv_vreinterpret_i8m1(x);
  if constexpr( match(c, category::uint8) ) return __riscv_vreinterpret_u8m1(x);
  if constexpr( match(c, category::float32) )
...
requires rvv_abi<abi_t<T, N>> || rvv_abi<abi_t<U, M>>
{
  ...
  else
  {
    ...
    if( auto element = valid_elements; element < u_m1_cardinal::value )
    {
...
bit_cast_(EVE_SUPPORTS(rvv_), logical<wide<T, N>> const& x, as<logical<wide<T, N>>> const&) noexcept
requires rvv_abi<abi_t<T, N>>
{
  return x;
}
...
bit_cast_(EVE_SUPPORTS(rvv_), wide<T, N> const& x, as<wide<T, N>> const& tgt) noexcept
requires rvv_abi<abi_t<T, N>>
{
  return x;
}
