...
namespace eve::detail
{
  ...
  EVE_FORCEINLINE decltype(auto) self_bitand(wide<T, N, ppc_> &self, U const &other) requires(
      (sizeof(wide<T, N, ppc_>) == sizeof(U)) || (sizeof(T) == sizeof(U)))
  {
  ...
  //================================================================================================
  template<scalar_value T, value U, typename N>
  EVE_FORCEINLINE decltype(auto) self_bitor(wide<T, N, ppc_> &self, U const &other) requires(
      (sizeof(wide<T, N, ppc_>) == sizeof(U)) || (sizeof(T) == sizeof(U)))
  {
    using type = wide<T, N, ppc_>;
  ...
  //================================================================================================
  template<scalar_value T, value U, typename N>
  EVE_FORCEINLINE decltype(auto) self_bitxor(wide<T, N, ppc_> &self, U const &other) requires(
      (sizeof(wide<T, N, ppc_>) == sizeof(U)) || (sizeof(T) == sizeof(U)))
  {
    using type = wide<T, N, ppc_>;
