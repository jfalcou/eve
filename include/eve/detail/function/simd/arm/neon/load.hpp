...
namespace eve::_
{
  template<arithmetic_scalar_value T, width_type N, simd_compatible_ptr<wide<T, N>> Ptr>
  ...
  template<arithmetic_scalar_value T, width_type N, typename U, typename Lanes>
