...
template<callable_options O, typename T, typename N>
 T extract_(EVE_REQUIRES(sve_), O const&, wide<T, N> v, std::size_t i) noexcept
...
template<callable_options O, typename T, typename N>
 void insert_(EVE_REQUIRES(sve_), O const&, wide<T, N>& v, std::size_t i, T x) noexcept
  requires sve_abi<abi_t<T, N>>
{
  v.storage()[i] = x;
}
...
template<callable_options O, typename T, typename N>
 logical<T> extract_(EVE_REQUIRES(sve_), O const&, logical<wide<T, N>> v, std::size_t i) noexcept
  requires sve_abi<abi_t<T, N>>
{
...
template<callable_options O, typename T, typename N>
 void insert_(EVE_REQUIRES(sve_), O const&, logical<wide<T, N>>& v, std::size_t i, auto x) noexcept
  requires sve_abi<abi_t<T, N>>
{
