...
namespace eve
{
  ...
  {
    if constexpr( scalar_value<T> )
      return bit_cast(b, as<as_wide_t<T, cardinal_t<U>>>()) &= a;
    else
      return a &= b;
  }
...
namespace eve::detail
{
  ...
  // infix add
  //================================================================================================
  template<real_scalar_value T> EVE_FORCEINLINE auto add_(EVE_SUPPORTS(cpu_), T a, T b) noexcept
  {
  ...
  // infix sub
  //================================================================================================
  template<real_scalar_value T> EVE_FORCEINLINE auto sub_(EVE_SUPPORTS(cpu_), T a, T b) noexcept
  {
    return static_cast<T>(a - b);
  }
  ...
  // infix mul
  //================================================================================================
  template<real_scalar_value T> EVE_FORCEINLINE auto mul_(EVE_SUPPORTS(cpu_), T a, T b) noexcept
  {
    return static_cast<T>(a * b);
  }

  template<real_value T, real_value U>
  EVE_FORCEINLINE auto mul_(EVE_SUPPORTS(cpu_), T const &a, U const &b) noexcept
      requires compatible_values<T, U>
  {
    return a * b;
  }
  ...
  // infix div
  //================================================================================================
  template<real_scalar_value T> EVE_FORCEINLINE auto div_(EVE_SUPPORTS(cpu_), T a, T b) noexcept
  {
    return static_cast<T>(a / b);
  }

  template<real_value T, real_value U>
  EVE_FORCEINLINE auto div_(EVE_SUPPORTS(cpu_), T const &a, U const &b) noexcept
      requires compatible_values<T, U>
  {
    return a / b;
  }
  ...
  // infix rem
  //================================================================================================
  template<integral_scalar_value T> EVE_FORCEINLINE auto rem_(EVE_SUPPORTS(cpu_), T a, T b) noexcept
  {
    return static_cast<T>(a % b);
  }

  template<integral_value T, integral_value U>
  EVE_FORCEINLINE auto rem_(EVE_SUPPORTS(cpu_), T const &a, U const &b) noexcept
      requires compatible_values<T, U>
  {
    return a % b;
  }
