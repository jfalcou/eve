...
cyl_bessel_y0_(EVE_SUPPORTS(cpu_), T x) noexcept
{
  ...
  auto br_3 = [evaluate](auto x)
  {
    ...
    constexpr std::array<v_t, 6> P1 = {1.0723538782003176831e+11,
    ...
    constexpr std::array<v_t, 6> Q1 = {5.8873865738997033405e+11,
  ...
  auto br_5 = [evaluate](auto x)
  {
    ...
    constexpr std::array<v_t, 7> P2 = {-2.2213976967566192242e+13,
    ...
    constexpr std::array<v_t, 7> Q2 = {4.3386146580707264428e+14,
  ...
  auto br_8 = [evaluate](auto x)
  {
    ...
    constexpr std::array<v_t, 8> P3 = {-8.0728726905150210443e+15,
    ...
    constexpr std::array<v_t, 8> Q3 = {3.4563724628846457519e+17,
  ...
  {
    constexpr std::array<v_t, 6> PC     = {2.2779090197304684302e+04,
    ...
    constexpr std::array<v_t, 6> QC     = {2.2779090197304684318e+04,
                                           4.1370412495510416640e+04,
                                           2.1215350561880115730e+04,
                                           3.5028735138235608207e+03,
                                           1.5711159858080893649e+02,
                                           1.0};
    constexpr std::array<v_t, 6> PS     = {-8.9226600200800094098e+01,
    ...
    constexpr std::array<v_t, 6> QS     = {5.7105024128512061905e+03,
    ...
    T                            y      = T(8) / x;
    T                            y2     = sqr(y);
    T                            rc     = evaluate_rational(PC, QC, y2);
    T                            rs     = evaluate_rational(PS, QS, y2);
    T                            factor = rsqrt(Pi * x);
    auto [sx, cx]                       = sincos(x);
