...
llvm-profdata merge --sparse -o $wdir/merged.profdata $wdir/unit/profraw.d/*.profraw

object_files=$(find $wdir -type f -name "*.o")
object_files_arg=""
...
# llvm-cov show -dump --instr-profile $wdir/merged.profdata $object_files_arg
