...
* Computes the element-wise minimum of two :ref:`Values <concept-value>`.
...
*******
    ...
    * With the :ref:`pedantic_ <feature-decorator>` decorator, in which case the call is equivalent to ``if_else(x < y, x, y)``;
