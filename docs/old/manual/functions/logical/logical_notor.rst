...
.. code-block:: c++
   ...
   namespace eve
   {
      constexpr /* implementation defined */ logical_notor = {};
   }
...
* [1] Performs a logical OR between the NEGATION of **v** and **w**.
* [2] Performs a logical OR between the NEGATION of each elements of **v** and  **s**.
* [3] Performs a logical OR between the NEGATION of **s** and ach elements of **v**
* [4] Performs a logical OR between the NEGATION of **s** and **t**.
