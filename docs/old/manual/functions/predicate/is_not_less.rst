...
.. code-block:: c++
   ...
   namespace eve
   {
      constexpr /* implementation defined */ is_not_less = {};
   }

Function object performing 'is not less' comparison between two :ref:`Values <concept-value>`.
...
* [1] Performs element-wise 'is not less' comparison between both :ref:`wides <type-wide>`.
* [2,3] Performs 'is not less' comparison between the scalar and each element of the :ref:`type-wide` instance.
* [4] Performs 'is not less' comparison between both scalars.
